...
CLOCK_CSL_RETURN csl_clock_peri_set_clock_state (CCU_ID_t ccu_id, CHAL_CCU_PERIF_ID_t peri_id, CHAL_CCU_CLOCK_ID_t clock_id, PERI_CLOCK_STATE state);
PERI_CLOCK_STATE csl_clock_peri_get_clock_state (CCU_ID_t ccu_id, CHAL_CCU_PERIF_ID_t peri_id, CHAL_CCU_CLOCK_ID_t clock_id);
CLOCK_CSL_RETURN csl_clock_peri_set_clock_speed (CCU_ID_t ccu_id, CHAL_CCU_PERIF_ID_t peri_id, CHAL_CCU_CLOCK_ID_t clock_id, int freq);
CLOCK_CSL_RETURN csl_clock_peri_set_clock_divider (CCU_ID_t ccu_id, CHAL_CCU_PERIF_ID_t peri_id, CHAL_CCU_CLOCK_ID_t clock_id, int pll, int pre_divisor, int divisor, int fraction);
int              csl_clock_peri_get_clock_speed (CCU_ID_t ccu_id, CHAL_CCU_PERIF_ID_t peri_id, CHAL_CCU_CLOCK_ID_t clock_id);

// set or get current frequency ID of active CCU policy
CLOCK_CSL_RETURN csl_clock_ccu_set_freq_policy (CCU_ID_t ccu_id, CCU_FREQ_POLICY freq_policy, int synchronous);
...
int              csl_clock_ccu_get_freq_policy_speed (CCU_ID_t ccu_id, CCU_FREQ_POLICY freq_policy);
...
void             csl_clock_register_freq_policy_callback(CCU_ID_t ccu_id, void (*func)(CCU_ID_t ccu_id));
...
CLOCK_CSL_RETURN csl_clock_set_clock_monitor (CCU_ID_t ccu_id, int ctrl, int sel);
