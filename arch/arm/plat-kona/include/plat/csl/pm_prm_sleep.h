...
void			csl_pm_init(CHAL_HANDLE sysinterface_pm_handle, CHAL_HANDLE sysinterface_pm_bmdm_handle);

// configure an event
PM_CSL_RETURN	csl_pm_set_event_policy(CHAL_PM_EVENT_t event_id, PM_EVENT_POLICY_t *policy);
PM_CSL_RETURN	csl_pm_set_event_enable(CHAL_PM_EVENT_t event_id, int pos, int neg);
...
void			csl_pm_register_wakeup_event_callback(void (*func)(CHAL_PM_EVENT_t event));
...
#if defined(_RHEA_)
// configure an event
PM_CSL_RETURN	csl_pm_bmdm_set_event_policy(CHAL_BMDM_PM_EVENT_t event_id, PM_BMDM_EVENT_POLICY_t *policy);
PM_CSL_RETURN	csl_pm_bmdm_set_event_enable(CHAL_BMDM_PM_EVENT_t event_id, int pos, int neg);
...
// register callback for wakeup event notification
void			csl_pm_bmdm_register_wakeup_event_callback(void (*func)(CHAL_BMDM_PM_EVENT_t event));
