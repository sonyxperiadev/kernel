...
*****************************************************************************/
	CSL_TRACE_ERR_CODE_t
	    csl_trace_get_recent_active_count(CSL_TRACE_AXITraceID_t
					      axitrace_id,
...
*
*****************************************************************************/
	CSL_TRACE_ERR_CODE_t csl_trace_start_perfcounter(UInt32 period_ms,
							 Boolean
							 all_cycle_enable);
...
*
*****************************************************************************/
	CSL_TRACE_ERR_CODE_t csl_trace_set_axi_trace(Boolean on,
						     CSL_TRACE_AXITraceID_t
						     axi_id,
						     Boolean time_stamp);
