...
// Maximum Channels Available for HERA
#define CHAL_MAX_CHANNELS           = 1
...
*****************************************************************************/
	...
	typedef enum {
		CHAL_OP_OK = 0,	///< OK, no Error         
		CHAL_OP_FAILED = (1 << 0),	///< Operation Failed    
		CHAL_OP_INVALID = (1 << 1),	///< Operation Invalid    
		CHAL_OP_INVALID_PARAMETER = (1 << 2),	///< Invalid Input Parameter         
		CHAL_OP_DRIVER_NOT_REGISTERED = (1 << 3),	///< Driver not Registered         
		CHAL_OP_WRONG_ORDER = (1 << 4),	///< Wrong Sequence Order     
...
*****************************************************************************/
	typedef enum {
		CHAL_CAM_PORT_AFE_0 = (1 << 0),	///< Port 0 select
		CHAL_CAM_PORT_AFE_1 = (1 << 1),	///< Port 1 select
	} CHAL_CAM_PORT_AFE_t;
...
*****************************************************************************/
	typedef enum {
		...
		CHAL_CAM_RX_BUF0_RDY = (1 << 12),	///< Buffer 0 Ready
		CHAL_CAM_RX_BUF0_NO = (1 << 13),	///< Buffer 0 Frame Number
		CHAL_CAM_RX_BUF1_RDY = (1 << 14),	///< Buffer 1 Ready
		CHAL_CAM_RX_BUF1_NO = (1 << 15),	///< Buffer 1 Frame Number
...
*****************************************************************************/
	typedef enum {
		...
		CHAL_CAM_INT_BUF0 = (1 << 7),	///< DBL buffer, Buf0
		CHAL_CAM_INT_BUF1 = (1 << 8),	///< Frame ERROR

		CHAL_CAM_INT_PKT = (1 << 9),	///< Generic Packet Interrupt
		CHAL_CAM_INT_FRAME_ERROR = (1 << 10),	///< Frame ERROR
...
*****************************************************************************/
	typedef struct {
		...
		CHAL_CAM_PORT_AFE_t afe_port;	///< Camera AFE port
...
*****************************************************************************/
	...
	typedef struct {
		...
		CHAL_CAM_BUFFER_st_t *data0Buff;
		CHAL_CAM_BUFFER_st_t *image1Buff;
		CHAL_CAM_BUFFER_st_t *data1Buff;
...
*****************************************************************************/
	typedef struct {
		...
		cUInt32 write_ptr;	///< (out) write pointer
		cUInt32 bytes_per_line;	///< (out) bytes per line (CSL_CAM_IMAGE only)
		cUInt32 lines_per_frame;	///< (out) lines per frame (CSL_CAM_IMAGE only)
...
*****************************************************************************/
	typedef struct {
		...
		cUInt8 image_data_id_4;	///< image data id 4
		cUInt8 image_data_id_5;	///< image data id 5
		cUInt8 image_data_id_6;	///< image data id 6
		cUInt8 image_data_id_7;	///< image data id 7
	} CHAL_CAM_IMAGE_ID_st_t;

#define CHAL_CAM_DATA_TYPE_MASK             0x1F
...
*****************************************************************************/
	typedef struct {
		CHAL_CAM_INTF_t intf;	///< Camera Interface
		CHAL_CAM_CHAN_t chan;	///< Camera Channel (unused)
		cUInt32 *data;	///< data pointer
		cUInt32 data_count;	///< data count
		CHAL_CAM_PIXEL_SIZE_t data_size;	///< data size
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_intf(CHAL_HANDLE handle,
						CHAL_CAM_CFG_INTF_st_t * cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_cntrl(CHAL_HANDLE handle,
						 CHAL_CAM_CFG_CNTRL_st_t * cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_pipeline(CHAL_HANDLE handle,
						    CHAL_CAM_PIPELINE_CFG_st_t *
						    cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_buffer(CHAL_HANDLE handle,
						  CHAL_CAM_BUFFER_CFG_st_t *
						  cfg);
	CHAL_CAM_STATUS_CODES chal_cam_cfg_dbl_buffer(CHAL_HANDLE handle,
						      CHAL_CAM_BUFFER_CFG_st_t *
						      cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_get_buffer_cfg(CHAL_HANDLE handle,
						      CHAL_CAM_BUFFER_CFG_st_t *
						      cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_frame(CHAL_HANDLE handle,
						 CHAL_CAM_FRAME_CFG_st_t * cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_data(CHAL_HANDLE handle,
						CHAL_CAM_DATA_CFG_st_t * cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_image_id(CHAL_HANDLE handle,
						    CHAL_CAM_IMAGE_ID_st_t *
						    cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_window(CHAL_HANDLE handle,
						  CHAL_CAM_WINDOW_CFG_st_t *
						  cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_afe_cntrl(CHAL_HANDLE handle,
						     CHAL_CAM_AFE_CFG_st_t *
						     cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_set_analog_pwr(CHAL_HANDLE handle,
						      CHAL_CAM_PARAM_st_t *
						      param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_set_bandgap_pwr(CHAL_HANDLE handle,
						       CHAL_CAM_PARAM_st_t *
						       param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_lane_enable(CHAL_HANDLE handle,
						   CHAL_CAM_PARAM_st_t * param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_set_lane_cntrl(CHAL_HANDLE handle,
						      CHAL_CAM_LANE_CNTRL_st_t *
						      cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_set_intf(CHAL_HANDLE handle,
						CHAL_CAM_CFG_INTF_st_t * cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_cfg_short_pkt(CHAL_HANDLE handle,
						     CHAL_CAM_PKT_CFG_st_t *
						     cfg);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_get_short_pkt(CHAL_HANDLE handle,
						     CHAL_CAM_PKT_st_t *
						     short_pkt);
...
*  @note 
*****************************************************************************/
	cUInt32 chal_cam_get_rx_status(CHAL_HANDLE handle,
				       CHAL_CAM_PARAM_st_t * param);
	cUInt32 chalCamRawRxStatus(CHAL_HANDLE handle, cUInt32 reg);
...
*               CHAL_CAM_STATUS_CODES
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_get_lane_status(CHAL_HANDLE handle,
						       CHAL_CAM_PARAM_st_t *
						       param);
...
*  @note 
*****************************************************************************/
	cUInt32 chal_cam_get_chan_status(CHAL_HANDLE handle,
					 CHAL_CAM_PARAM_st_t * param);
	cUInt32 chalCamRawIntrStatus(CHAL_HANDLE handle, cUInt32 reg);

/**
*
*  @brief  CAM module Clear Receiver Channel status
*
*  @param  handle (in) handle of this CAM instance
*  @param  *param (in) parameter struct to rx status
*
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_clear_chan_status(CHAL_HANDLE handle,
							 CHAL_CAM_PARAM_st_t *
							 param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_reset(CHAL_HANDLE handle,
					     CHAL_CAM_PARAM_st_t * param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_rx_reset(CHAL_HANDLE handle,
						CHAL_CAM_PARAM_st_t * param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_rx_bytes_written(CHAL_HANDLE handle,
							CHAL_CAM_PARAM_st_t *
							param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_channel_trigger(CHAL_HANDLE handle,
						       CHAL_CAM_PARAM_st_t *
						       param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_rx_start(CHAL_HANDLE handle,
						CHAL_CAM_PARAM_st_t * param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_rx_stop(CHAL_HANDLE handle,
					       CHAL_CAM_PARAM_st_t * param);
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_register_display(CHAL_HANDLE handle,
							CHAL_CAM_PARAM_st_t *
							param);

/**
*
*  @brief  CAM module Clock Output
*
*  @param  handle (in) handle of this CAM instance
*  @param  *param (in) parameter struct to pass interface & channel to report register status
*
...
*  @note 
*****************************************************************************/
	CHAL_CAM_STATUS_CODES chal_cam_clock(CHAL_HANDLE handle,
					     cUInt32 clk_select,
					     cUInt32 divider, cBool enable);
