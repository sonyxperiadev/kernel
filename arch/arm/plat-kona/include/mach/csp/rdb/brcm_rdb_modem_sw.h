...
#define MODEM_SW_ARARB0_RESERVED_MASK                                     0x00000000
#define    MODEM_SW_ARARB0_AR_ARB0_SHIFT                                  0
#define    MODEM_SW_ARARB0_AR_ARB0_MASK                                   0xFFFFFFFF

#define MODEM_SW_AWARB0_OFFSET                                            0x0000040C
#define MODEM_SW_AWARB0_TYPE                                              UInt32
#define MODEM_SW_AWARB0_RESERVED_MASK                                     0x00000000
#define    MODEM_SW_AWARB0_AW_ARB0_SHIFT                                  0
#define    MODEM_SW_AWARB0_AW_ARB0_MASK                                   0xFFFFFFFF
