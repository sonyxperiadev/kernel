...
#define MM_IO_BASE_BMDM_CLK            MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_BMDM_CLK )
#define MM_IO_BASE_BMDM_PWRMGR         MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_BMDM_PWRMGR )
#define MM_IO_BASE_PMU_BSC             MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_PMU_BSC )
#define MM_IO_BASE_BINTC               MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_BINTC )
#define MM_IO_BASE_BMODEM_SYSCFG       MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_BMODEM_SYSCFG )
...
#define MM_IO_BASE_CIR                 MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_CIR )             /* CIR Block */
...
#define MM_IO_BASE_DTE                 MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_DTE )             /* DTE sub system */
...
#define MM_IO_BASE_FMON                MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_FMON )
...
#define MM_IO_BASE_LEDM                MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_LEDM )            /* LED Matrix */
#define MM_IO_BASE_MEMC_SYS_EMI_APHY          MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_SYS_EMI_APHY )      /* System Memory Controller APHY */
#define MM_IO_BASE_MEMC_SYS_EMI_DPHY          MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_SYS_EMI_DPHY )      /* System Memory Controller DPHY */
#define MM_IO_BASE_MEMC_SYS_EMI_NS            MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_SYS_EMI_NS )        /* Non-Secure System Memory Controller */
#define MM_IO_BASE_MEMC_SYS_EMI_S             MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_SYS_EMI_S )         /* Secure System Memory Controller */
#define MM_IO_BASE_MEMC_SYS_EMI_DDR3_CTL      MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_SYS_EMI_DDR3_CTL )  /* DDR3 System Memory Controller */
#define MM_IO_BASE_MEMC_SYS_EMI_DDR3_PHY      MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_SYS_EMI_DDR3_PHY )  /* DDR3 System PHY Controller */
#define MM_IO_BASE_MEMC_SYS_EMI_DDR3_PHY_WL_0 MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_SYS_EMI_DDR3_PHY_WL_0 )  /* DDR3 System PHY WordLane 0 */
#define MM_IO_BASE_MEMC_SYS_EMI_DDR3_PHY_WL_1 MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_SYS_EMI_DDR3_PHY_WL_1 )  /* DDR3 System PHY WordLane 1 */
#define MM_IO_BASE_MEMC_VC4_EMI_APHY          MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_VC4_EMI_APHY )      /* Videocore Memory Controller APHY */
#define MM_IO_BASE_MEMC_VC4_EMI_DPHY          MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_VC4_EMI_DPHY )      /* Videocore Memory Controller DPHY */
#define MM_IO_BASE_MEMC_VC4_EMI_NS            MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_VC4_EMI_NS )        /* Non-Secure Videocore Memory Controller */
#define MM_IO_BASE_MEMC_VC4_EMI_S             MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_MEMC_VC4_EMI_S )         /* Secure Videocore Memory Controller */
...
#define MM_IO_BASE_RTC                 MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_RTC )             /* RTC */
#define MM_IO_BASE_RTC_APB             MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_RTC_APB )             /* RTC APB*/
#define MM_IO_BASE_PWM                 MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_PWM )             /* PWM */
#define MM_IO_BASE_PWRMGR              MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_PWRMGR )          /* PWRMGR */
...
#define MM_IO_BASE_SSP5                MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_SSP5 )
#define MM_IO_BASE_SSP6                MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_SSP6 )
...
#define MM_IO_BASE_TL3R                MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_TL3R )
...
#define MM_IO_BASE_VINTC               MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_VINTC )           /* VPM interrupt control */
#if defined(CONFIG_BCMHANA_LI_MODE)
   /*
   ...
   * (0x80000000).
   */
#define MM_IO_BASE_VC_EMI              MM_IO_PHYS_TO_VIRT( 0x40000000 )                 /* VC4 EMI */
#else
...
#endif
#define MM_IO_BASE_WCDMAL2INT_ASYNC    MM_IO_PHYS_TO_VIRT( MM_ADDR_IO_WCDMAL2INT_ASYNC )
