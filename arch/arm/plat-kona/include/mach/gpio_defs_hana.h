...
#ifndef GPIO_DEFS_HANA_H
#define GPIO_DEFS_HANA_H
...
typedef enum
{
   ...
   GPIO_165_NORFLSH_AD_5_SWDCLKTCK_UARTB3_UTXD_IRD_OSC_7,
...
typedef enum
{
   gpiomux_group_i2c = 0,        /* BSC1, BSC2, HDMI, PMU, VC */
   gpiomux_group_clk_out,        /* WF/BT/GPS Clock */
   gpiomux_group_digital_mic,    /* Digital Mic */
   gpiomux_group_hsi,            /* HSI testing */
   gpiomux_group_keypad,         /* 7x4 Keypad, 7x8 Keypad */
   gpiomux_group_lcd_te,         /* LCD Tearing */
   gpiomux_group_mphi,           /* VC04 Host Data and Expansion */
   gpiomux_group_nand,           /* 8bit NAND */
   gpiomux_group_nor,            /* AAD NOR Flash */
   gpiomux_group_pm_debug,       /* Test header (3.3V) */
   gpiomux_group_pwm,            /* LCD Backlight, External Peripheral */
   gpiomux_group_sdio,           /* Wi-Fi, eMMC 8bit, SD Card */
   gpiomux_group_ssp,            /* (SSP0) BT - PCM, (SSP2) Serial Flash Boot, (SSP3) Ext Codec, (SSP3) Ext Codec, (SSP3) Test Header (1.8V) */               
   gpiomux_group_uart,           /* Debug UART0, BootROM UART1, UART1, BT-UART2, UART2, GPS-UART3, UART3 */
   gpiomux_group_usb_ulpi,       /* USB Host Port0, USB Host Port1 */
   gpiomux_group_vc_dpi_rgb,     /* LCD */
   gpiomux_group_vc_gpclk,       /* CAM1_MCLK/CAM2_MCLK */
   gpiomux_group_vc_i2s,         /* External CODEC */
   gpiomux_group_vc_jtag,        /* VC04 JTAG */
   gpiomux_group_MaxNum
}
gpiomux_group_e;

#endif /* GPIO_DEFS_HANA_H */
