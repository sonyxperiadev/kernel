...
#if !defined( ASM_ARM_ARCH_BCMHANA_DMA_H )
#define ASM_ARM_ARCH_BCMHANA_DMA_H
...
#define DMA_NUM_CHANNELS        4   /* per controller */
#else
...
/****************************************************************************/
/**
*   Perform immediate data transfer for properly aligned data less than 4KB
*   @return
*       0       transfered successfully
*       -ENODEV Device handed in is invalid.
*       -EINVAL Invalid parameters
*/
/****************************************************************************/
int dma_quick_transfer
(
    DMA_Handle_t handle,     /* DMA handle */
    dma_addr_t src_addr,     /* Place to get data (memory or device) */
    dma_addr_t dst_addr,     /* Place to put data (memory or device) */
    size_t len               /* Number of bytes to transfer to the device */
);
...
int dma_alloc_double_src_descriptors
(
    DMA_Handle_t            handle,         /* DMA Handle */
...
#endif  /* ASM_ARM_ARCH_BCMHANA_DMA_H */
