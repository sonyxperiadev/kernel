...
#define		BCM2165x_CLK_SSP2_APB_FLAGS			(TYPE_BUS_CLK | SW_GATE)
...
#define		BCM2165x_CLK_SSP2_AUDIO_FLAGS			(TYPE_PERI_CLK | SW_GATE)
...
#define		CLK_SSP2_AUDIO_DIV_MAX				0xFFF
#define		CLK_SSP2_AUDIO_PREDIV_MAX			0xF
#define		CLK_SSP2_AUDIO_FRACTION_MAX			1
