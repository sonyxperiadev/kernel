...
typedef struct
{
   ...
   uint32_t maxDataPerBlock;                                             /* Maximum number of bytes to be transferred per block/descrptor.
                                                                            0 = Maximum possible.
                                                                          */
   uint32_t maxAMBABurstLen;                                             /* Maximum AMBA Burst Length
                                                                            0 = Maximum possible.
                                                                          */
...
/****************************************************************************/
/**
*  @brief   Perform immediate transfer with smaller data size less than 4KB
*
*  @return  -1 : On failure
*            0 : On success
*
*  @note
*     This APi assumes src and dst data addresses are properly aligned
*/
/****************************************************************************/
int dmacHw_quickTransfer 
(
   dmacHw_HANDLE_t handle,        /*   [ IN ] DMA Channel handle */
   dmacHw_CONFIG_t *pConfig,      /*   [ IN ] Configuration settings */
   void* pSrcAddr,                /*   [ IN ] Source (Peripheral/Memory) address */
