...
//                
//*****************************************************************************
cUInt32 chal_smi_calc_smil_len(cUInt32 bytes,	// FIFO in transfer size in bytes
...
void chal_smi_fifo_acc(CHAL_HANDLE handle, pCHAL_FIFO_ACC fifoMode)
{
	...
	mask = SMI_CS_PXLDAT_MASK | SMI_CS_PVMODE_MASK | SMI_CS_TEEN_MASK | SMI_CS_WRITE_MASK | SMI_CS_START_MASK | SMI_CS_ENABLE_MASK | SMI_CS_TEEN_MASK | SMI_CS_CLEAR_MASK	// CLEAR FIFOs
