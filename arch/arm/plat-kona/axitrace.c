...
TRACE_CNTR(ATM_AWCYCLES, "Write Address Cycles", 0xffffffff, COMMANDS_COUNTING),
TRACE_CNTR(ATM_ARCYCLES, "Read Address Cycles", 0xffffffff, COMMANDS_COUNTING),
TRACE_CNTR(ATM_WCYCLES, "Write Data Cycles", 0xffffffff, COMMANDS_COUNTING),
TRACE_CNTR(ATM_RCYCLES, "Read Data Cycles", 0xffffffff, COMMANDS_COUNTING),
TRACE_CNTR(ATM_BCYCLES, "Write Response Cycles", 0xffffffff, COMMANDS_COUNTING),
...
static int __devinit axitrace_probe(struct amba_device *dev,
