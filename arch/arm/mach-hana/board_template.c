...
#ifndef HANA_BOARD_ID
#error HANA_BOARD_ID needs to be defined in board_xxx.c
#endif

/*
 * Since this board template is included by each board_xxx.c. We concatenate
 * HANA_BOARD_ID to help debugging when multiple boards are compiled into
 * a single image
 */
 ...
 */
#define PHYS_ADDR_SDIO0        MM_ADDR_IO_SDIO1
#define PHYS_ADDR_SDIO1        MM_ADDR_IO_SDIO2
#define PHYS_ADDR_SDIO2        MM_ADDR_IO_SDIO3
...
#define board_init concatenate(HANA_BOARD_ID, _init)
