/*
 *  linux/arch/arm/common/armctrl.c
 *
 ...
 */
static void __init armctrl_pm_register(void __iomem *base, unsigned int irq, u32 resume_sources)
{
...
#else
static inline void armctrl_pm_register(void __iomem *base, unsigned int irq, u32 arg1) { }
