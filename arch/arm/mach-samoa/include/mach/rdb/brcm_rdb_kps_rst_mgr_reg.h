...
#define KPS_RST_MGR_REG_HSM_SOFTRST_RESERVED_MASK                         0x7FFFFFFB
...
#define    KPS_RST_MGR_REG_HSM_SOFTRST_RNG_SOFT_RSTN_SHIFT                2
#define    KPS_RST_MGR_REG_HSM_SOFTRST_RNG_SOFT_RSTN_MASK                 0x00000004
