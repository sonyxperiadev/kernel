...
static struct map_desc samoa_io_desc[] __initdata =
{
	/**************************************************
	...
	*/
	...
	IO_DESC( KONA_SRAM_VA, SZ_64K + SZ_16K ),
...
void __init samoa_map_io(void)
{
	iotable_init(samoa_io_desc, ARRAY_SIZE(samoa_io_desc));
}
