...
#define BMODEM_AONCFG_AUXDAC_RESERVED_MASK                                0xFFF80000
#define    BMODEM_AONCFG_AUXDAC_ISOLATE_IN_SHIFT                          18
#define    BMODEM_AONCFG_AUXDAC_ISOLATE_IN_MASK                           0x00040000
