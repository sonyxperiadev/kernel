...
#define BMODEM_SYSCFG_CR_RESERVED_MASK                                    0xFFFFFCEC
#define    BMODEM_SYSCFG_CR_RFSPI_SWITCH_PROTECTION_SHIFT                 9
#define    BMODEM_SYSCFG_CR_RFSPI_SWITCH_PROTECTION_MASK                  0x00000200
#define    BMODEM_SYSCFG_CR_TWIF_SWITCH_PROTECTION_SHIFT                  8
#define    BMODEM_SYSCFG_CR_TWIF_SWITCH_PROTECTION_MASK                   0x00000100
