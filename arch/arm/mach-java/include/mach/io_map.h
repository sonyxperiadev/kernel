...
#define KONA_GICCPU_VA		HW_IO_PHYS_TO_VIRT(GIC_AXI_BASE_ADDR + 0x2000)
#define KONA_GICDIST_VA		HW_IO_PHYS_TO_VIRT(GIC_AXI_BASE_ADDR + 0x1000)
#define KONA_GICAXI_VA			HW_IO_PHYS_TO_VIRT(GIC_AXI_BASE_ADDR)
#define KONA_GICDIST_MEM0_VA		HW_IO_PHYS_TO_VIRT(GIC_MEM0_BASE_ADDR)
...
#define KONA_CORETMR_VA         HW_IO_PHYS_TO_VIRT(CORE_TIMER_BASE_ADDR)
...
#define KONA_CDC_VA			HW_IO_PHYS_TO_VIRT(CDC_BASE_ADDR)
#define KONA_PROC_TIMER_VA		HW_IO_PHYS_TO_VIRT(PROC_TIMER_BASE_ADDR)
#define KONA_MM2_FUNNEL_VA		HW_IO_PHYS_TO_VIRT(MM2_FUNNEL_BASE_ADDR)
#endif /* __ASSEMBLY__ */
