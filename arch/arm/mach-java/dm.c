...
static u32 addnl_regs[][2] = {
	ADDNL_REG_DEFINE((int)KONA_FUNNEL_VA, CSTF_FUNNEL_CONTROL_OFFSET),
	ADDNL_REG_DEFINE((int)KONA_CDC_VA, CDC_CONFIG_OFFSET),
	ADDNL_REG_DEFINE((int)KONA_CDC_VA, CDC_A7_DEBUG_BUS_SELECT_OFFSET)
...
static void config_wakeup_interrupts(void)
{
	...
	for_each_present_cpu(cpu) {
		gic_mem_base = (int)KONA_GICDIST_MEM0_VA + cpu*0x10000;
