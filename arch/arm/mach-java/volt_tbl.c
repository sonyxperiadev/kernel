...
__weak int bcmpmu_rgltr_get_volt_id(u32 val)
{
	return -1;
};

__weak int bcmpmu_rgltr_get_volt_val(u32 id)
{
	return -1;
}

__weak void bcmpmu_populate_volt_dbg_log(struct pmu_volt_dbg *dbg_log)
{
}
