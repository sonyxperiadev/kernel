...
/* Base registers */
#define dmacHw_0_MODULE_BASE_ADDR        (char*) KONA_EDMA_VA /* DMAC 0 module's base address */

/* This option allows developers to use this register map file without
*  requiring the run-time variables dmaChannelCount_0/1.  For the bcmring
*  platform, there are *always* 8 channels per module
*/
#define dmaChannelCount_0                 8
#define dmaChannelCount_1                 0

/* Define channel specific registers */
#define dmacHw_CHAN_BASE(module, chan)          ((dmacHw_CH_REG_t*) ( (char*)((module) ? NULL : dmacHw_0_MODULE_BASE_ADDR) + ((chan) * sizeof(dmacHw_CH_REG_t))))
...
#define CHANNEL_BUSY(mod, channel)              (reg32_read( &dmacHw_REG_MISC_CH_ENABLE((mod)) ) & (0x00000001 << (channel)))
...
#define dmacHw_REG_CFG_LO_MAX_AMBA_BURST_LEN_DFAULT 0            /* Maximum AMBA burst length for BCM11140 */
#define dmacHw_REG_CFG_LO_MAX_AMBA_BURST_LEN_DDR    8            /* Maximum AMBA burst length for BCM11140 */
...
#define dmacHw_SET_SAR(module, channel, addr)          (reg32_write( &dmacHw_REG_SAR((module), (channel)), (uint32_t) (addr) ))
#define dmacHw_SET_DAR(module, channel, addr)          (reg32_write( &dmacHw_REG_DAR((module), (channel)), (uint32_t) (addr) ))
#define dmacHw_SET_LLP(module, channel, ptr)           (reg32_write( &dmacHw_REG_LLP((module), (channel)), (uint32_t) (ptr) ))

#define dmacHw_GET_SSTAT(module, channel)              (reg32_read( &dmacHw_REG_SSTAT((module), (channel)) ))
#define dmacHw_GET_DSTAT(module, channel)              (reg32_read( &dmacHw_REG_DSTAT((module), (channel)) ))

#define dmacHw_SET_SSTATAR(module, channel, addr)      (reg32_write( &dmacHw_REG_SSTATAR((module), (channel)), (uint32_t) (addr) ))
#define dmacHw_SET_DSTATAR(module, channel, addr)      (reg32_write( &dmacHw_REG_DSTATAR((module), (channel)), (uint32_t) (addr) ))

#define dmacHw_SET_CONTROL_LO(module, channel, ctl)    (reg32_set_bits( &dmacHw_REG_CTL_LO((module), (channel)), (ctl) ))
#define dmacHw_RESET_CONTROL_LO(module, channel)       (reg32_write( &dmacHw_REG_CTL_LO((module), (channel)), 0 ))
#define dmacHw_GET_CONTROL_LO(module, channel)         (reg32_read( &dmacHw_REG_CTL_LO((module), (channel))))

#define dmacHw_SET_CONTROL_HI(module, channel, ctl)    (reg32_set_bits( &dmacHw_REG_CTL_HI((module), (channel)), (ctl) ))
#define dmacHw_RESET_CONTROL_HI(module, channel)       (reg32_write( &dmacHw_REG_CTL_HI((module), (channel)), 0 ))
#define dmacHw_GET_CONTROL_HI(module, channel)         (reg32_read( &dmacHw_REG_CTL_HI((module), (channel)))

#define dmacHw_GET_BLOCK_SIZE(module, channel)         (reg32_read( &dmacHw_REG_CTL_HI((module), (channel)) ) & dmacHw_REG_CTL_BLOCK_TS_MASK)
#define dmacHw_DMA_COMPLETE(module, channel)           (reg32_read( &dmacHw_REG_CTL_HI((module), (channel)) ) & dmacHw_REG_CTL_DONE)

#define dmacHw_SET_CONFIG_LO(module, channel, cfg)     (reg32_set_bits( &dmacHw_REG_CFG_LO((module), (channel)), (cfg) ))
#define dmacHw_RESET_CONFIG_LO(module, channel)        (reg32_write( &dmacHw_REG_CFG_LO((module), (channel)), 0 ))
#define dmacHw_GET_CONFIG_LO(module, channel)          (reg32_read( &dmacHw_REG_CFG_LO((module), (channel)) ))
#define dmacHw_SET_AMBA_BURST_LEN(module, channel, len)    (reg32_write_masked( &dmacHw_REG_CFG_LO((module), (channel)), (dmacHw_REG_CFG_LO_MAX_AMBA_BURST_LEN_MASK), (((len) << 20) & dmacHw_REG_CFG_LO_MAX_AMBA_BURST_LEN_MASK) ))
#define dmacHw_SET_CHANNEL_PRIORITY(module, channel, prio) (reg32_write_masked( &dmacHw_REG_CFG_LO((module), (channel)), (dmacHw_REG_CFG_LO_CH_PRIORITY_MASK), (prio) ))
#define dmacHw_SET_AHB_HPROT(module, channel, protect)  (reg32_write_masked( &dmacHw_REG_CFG_HI(module, channel), (dmacHw_REG_CFG_HI_AHB_HPROT_MASK), (protect) ))

#define dmacHw_SET_CONFIG_HI(module, channel, cfg)      (reg32_set_bits( &dmacHw_REG_CFG_HI((module), (channel)), (cfg) ))
#define dmacHw_RESET_CONFIG_HI(module, channel)         (reg32_write( &dmacHw_REG_CFG_HI((module), (channel)), 0 ))
#define dmacHw_GET_CONFIG_HI(module, channel)           (reg32_read( &dmacHw_REG_CFG_HI((module), (channel)) ))
#define dmacHw_SET_SRC_PERI_INTF(module, channel, intf) (reg32_write_masked( &dmacHw_REG_CFG_HI((module), (channel)), (dmacHw_REG_CFG_HI_SRC_PERI_INTF_MASK), (((intf) << 7) & dmacHw_REG_CFG_HI_SRC_PERI_INTF_MASK) ))
#define dmacHw_SRC_PERI_INTF(intf)                      (((intf) << 7) & dmacHw_REG_CFG_HI_SRC_PERI_INTF_MASK)
#define dmacHw_SET_DST_PERI_INTF(module, channel, intf) (reg32_write_masked( &dmacHw_REG_CFG_HI((module), (channel)), (dmacHw_REG_CFG_HI_DST_PERI_INTF_MASK), (((intf) << 11) & dmacHw_REG_CFG_HI_DST_PERI_INTF_MASK) ))
#define dmacHw_DST_PERI_INTF(intf)                      (((intf) << 11) & dmacHw_REG_CFG_HI_DST_PERI_INTF_MASK)

#define dmacHw_DMA_START(module, channel)              (reg32_write( &dmacHw_REG_MISC_CH_ENABLE((module)), (0x00000001 << ((channel) + 8)) | (0x00000001 << (channel)) ))
#define dmacHw_DMA_STOP(module, channel)               (reg32_write( &dmacHw_REG_MISC_CH_ENABLE((module)), (0x00000001 << ((channel) + 8)) ))
#define dmacHw_DMA_ENABLE(module)                      (reg32_write( &dmacHw_REG_MISC_CFG((module)), 1 ))
#define dmacHw_DMA_DISABLE(module)                     (reg32_write( &dmacHw_REG_MISC_CFG((module)), 0 ))

#define dmacHw_TRAN_INT_ENABLE(module, channel)        (reg32_write( &dmacHw_REG_INT_MASK_TRAN((module)), (0x00000001 << ((channel) + 8)) | (0x00000001 << (channel)) ))
#define dmacHw_BLOCK_INT_ENABLE(module, channel)       (reg32_write( &dmacHw_REG_INT_MASK_BLOCK((module)), (0x00000001 << ((channel) + 8)) | (0x00000001 << (channel)) ))
#define dmacHw_ERROR_INT_ENABLE(module, channel)       (reg32_write( &dmacHw_REG_INT_MASK_ERROR((module)), (0x00000001 << ((channel) + 8)) | (0x00000001 << (channel)) ))
#define dmacHw_STRAN_INT_ENABLE(module, channel)       (reg32_write( &dmacHw_REG_INT_MASK_STRAN((module)), (0x00000001 << ((channel) + 8)) | (0x00000001 << (channel)) ))
#define dmacHw_DTRAN_INT_ENABLE(module, channel)       (reg32_write( &dmacHw_REG_INT_MASK_DTRAN((module)), (0x00000001 << ((channel) + 8)) | (0x00000001 << (channel)) ))

#define dmacHw_TRAN_INT_DISABLE(module, channel)       (reg32_write( &dmacHw_REG_INT_MASK_TRAN((module)), (0x00000001 << ((channel) + 8)) ))
#define dmacHw_BLOCK_INT_DISABLE(module, channel)      (reg32_write( &dmacHw_REG_INT_MASK_BLOCK((module)), (0x00000001 << ((channel) + 8)) ))
#define dmacHw_ERROR_INT_DISABLE(module, channel)      (reg32_write( &dmacHw_REG_INT_MASK_ERROR((module)), (0x00000001 << ((channel) + 8)) ))
#define dmacHw_STRAN_INT_DISABLE(module, channel)      (reg32_write( &dmacHw_REG_INT_MASK_STRAN((module)), (0x00000001 << ((channel) + 8)) ))
#define dmacHw_DTRAN_INT_DISABLE(module, channel)      (reg32_write( &dmacHw_REG_INT_MASK_DTRAN((module)), (0x00000001 << ((channel) + 8)) ))

#define dmacHw_TRAN_INT_CLEAR(module, channel)         (reg32_write( &dmacHw_REG_INT_CLEAR_TRAN((module)), (0x00000001 << (channel)) ))
#define dmacHw_BLOCK_INT_CLEAR(module, channel)        (reg32_write( &dmacHw_REG_INT_CLEAR_BLOCK((module)), (0x00000001 << (channel)) ))
#define dmacHw_ERROR_INT_CLEAR(module, channel)        (reg32_write( &dmacHw_REG_INT_CLEAR_ERROR((module)), (0x00000001 << (channel)) ))
#define dmacHw_STRAN_INT_CLEAR(module, channel)        (reg32_write( &dmacHw_REG_INT_CLEAR_STRAN((module)), (0x00000001 << (channel)) ))
#define dmacHw_DTRAN_INT_CLEAR(module, channel)        (reg32_write( &dmacHw_REG_INT_CLEAR_DTRAN((module)), (0x00000001 << (channel)) ))


#define dmacHw_GET_NUM_CHANNEL(module)                 (((reg32_read( &dmacHw_REG_MISC_COMP_PARAM1_HI((module)) ) & dmacHw_REG_COMP_PARAM_NUM_CHANNELS) >> 8) + 1)
#define dmacHw_GET_NUM_INTERFACE(module)               (((reg32_read( &dmacHw_REG_MISC_COMP_PARAM1_HI((module)) ) & dmacHw_REG_COMP_PARAM_NUM_INTERFACE) >> 11) + 1)
#define dmacHw_GET_MAX_BLOCK_SIZE(module, channel)     ((reg32_read( &dmacHw_REG_MISC_COMP_PARAM1_LO((module)) ) >> (4 * (channel))) & dmacHw_REG_COMP_PARAM_MAX_BLK_SIZE )
#define dmacHw_GET_CHANNEL_DATA_WIDTH(module, channel) ((reg32_read( &dmacHw_REG_MISC_COMP_PARAM1_HI((module)) ) & dmacHw_REG_COMP_PARAM_DATA_WIDTH) >> 13)
