...
/**
* SSPI core frame definition structure
*****************************************************************************/
typedef struct {
    uint32_t frame_cs_active;
    uint32_t frame_cs_size;
    uint32_t frame_sclk_active_edge;
    uint32_t frame_cs_initial_value;
    uint32_t frame_txoen_idle_value;
    uint32_t frame_tx_idle_value;
    uint32_t frame_sclk_idle_value;
    uint32_t frame_cs_idle_value;
    uint32_t frame_rx_start_master;
    uint32_t frame_rx_start_slave;
    uint32_t frame_rx_word_length;
    uint32_t frame_sclk_end;
    uint32_t frame_sclk_start;
    uint32_t frame_sclk_duty;
    uint32_t frame_sclk_ratio;
    uint32_t frame_txoen_end;
    uint32_t frame_txoen_start;
    uint32_t frame_tx_start;
    uint32_t frame_tx_word_length;
    uint32_t frame_tx_extended_left;
    uint32_t frame_tx_extended_right;
} chal_sspi_frame_def_t;
...
/********** Should this be here or test code? *****************/
...
*  @param    type   (in) SSPI core type (Full or Lite)
*
*  @return SSPI status
*******************************************************************/
...
*                             3-channel TDM/PCM mode. It is ignored for all 
*                             other protocols.
*  @param TODO: add entry for frameDef
*
*  @return SSPI status
******************************************************************************/
