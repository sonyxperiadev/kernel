...
*****************************************************************************/
extern uint32_t chal_audio_read_int_status(CHAL_HANDLE handle);
...
*  @return None
*****************************************************************************/
extern void chal_audio_int_clear(CHAL_HANDLE handle, uint32_t reg_val);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_vinpath_digi_mic_enable(CHAL_HANDLE handle, uint16_t path);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_vinpath_digi_mic_disable(CHAL_HANDLE handle, uint16_t path);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_select_primary_mic( CHAL_HANDLE handle,  uint16_t enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_int_enable(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_left_int_enable(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_left_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*****************************************************************************/
extern uint32_t chal_audio_vinpath_get_dma_port_addr_offset( void );
...
*  @return offset of DMA port address from base address
*****************************************************************************/
extern uint32_t chal_audio_vinpath_left_get_dma_port_addr_offset( void );
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2);
...
*****************************************************************************/
extern uint32_t chal_audio_vinpath_read_fifo_status(CHAL_HANDLE handle);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_vinpath_left_read_fifo_status(CHAL_HANDLE handle);
...
*****************************************************************************/
extern uint32_t chal_audio_vinpath_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_vinpath_left_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf);
...
*****************************************************************************/
extern  uint32_t chal_audio_vinpath_read_int_status(CHAL_HANDLE handle);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern  uint32_t chal_audio_vinpath_left_read_int_status(CHAL_HANDLE handle);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_set_cic_scale(CHAL_HANDLE handle, uint32_t dmic1_scale, uint32_t dmic2_scale);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_set_digimic_clkdelay(CHAL_HANDLE handle, uint16_t delay);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_set_filter(CHAL_HANDLE handle, uint16_t filter);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_nvinpath_digi_mic_enable(CHAL_HANDLE handle, uint16_t path);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_nvinpath_digi_mic_disable(CHAL_HANDLE handle, uint16_t path);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_int_enable(CHAL_HANDLE handle, uint16_t fifo_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_left_int_enable(CHAL_HANDLE handle, uint16_t fifo_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_left_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*  @return offset of DMA port address from base address
*****************************************************************************/
extern uint32_t chal_audio_nvinpath_get_dma_port_addr_offset( void );
...
*  @return offset of DMA port address from base address
*****************************************************************************/
extern uint32_t chal_audio_nvinpath_left_get_dma_port_addr_offset( void );
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_select_sidetone (CHAL_HANDLE handle,uint16_t read_sidetone);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_nvinpath_read_fifo_status(CHAL_HANDLE handle);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_nvinpath_left_read_fifo_status(CHAL_HANDLE handle);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_nvinpath_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_nvinpath_left_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern  uint32_t chal_audio_nvinpath_read_int_status(CHAL_HANDLE handle);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern  uint32_t chal_audio_nvinpath_left_read_int_status(CHAL_HANDLE handle);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_set_cic_scale(CHAL_HANDLE handle, uint32_t dmic3_scale, uint32_t dmic4_scale);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_set_digimic_clkdelay(CHAL_HANDLE handle, uint16_t delay);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_set_filter(CHAL_HANDLE handle, uint16_t filter);
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_enable(CHAL_HANDLE handle, uint16_t enable_chan);
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_int_enable(CHAL_HANDLE handle, uint16_t fifo_int_enable, uint16_t err_int_enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*****************************************************************************/
extern uint32_t chal_audio_hspath_get_dma_port_addr_offset( void );
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_set_gain(CHAL_HANDLE handle, uint32_t gain);
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits);
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_hspath_read_fifo_status(CHAL_HANDLE handle);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern uint32_t chal_audio_hspath_read_int_status(CHAL_HANDLE handle);
...
*****************************************************************************/
extern uint32_t chal_audio_hspath_write_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_ovf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_hspath_sdm_set_dither_poly(CHAL_HANDLE handle, uint32_t hs_dither_poly_L, uint32_t hs_dither_poly_R);
...
*  @return None
*****************************************************************************/
extern void chal_audio_hspath_sdm_set_dither_seed(CHAL_HANDLE handle, uint32_t hs_dither_seed_L, uint32_t hs_dither_seed_R);
...
*  @return None
*****************************************************************************/
extern  void chal_audio_hspath_hs_supply_ctrl(CHAL_HANDLE handle, _Bool hs_ds_pol, uint8_t hs_ds_delay, uint8_t hs_ds_lag);
...
*  @return None
*****************************************************************************/
extern  void chal_audio_hspath_hs_supply_thres(CHAL_HANDLE handle, uint32_t hs_supply_thres);
...
*  @return None
*****************************************************************************/
extern  void chal_audio_hspath_eanc_in(CHAL_HANDLE handle, uint16_t enable );
...
*  @return None
*****************************************************************************/
extern  void chal_audio_hspath_sidetone_in(CHAL_HANDLE handle, uint16_t enable );
...
*  @return None
*****************************************************************************/
extern  void chal_audio_hspath_sdm_set_coef(CHAL_HANDLE handle, uint32_t hs_coef_L, uint32_t hs_coef_R);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_hspath_set_dac_pwr(CHAL_HANDLE handle, uint16_t enable_chan);
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_set_filter(CHAL_HANDLE handle, uint16_t filter);
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_enable(CHAL_HANDLE handle, uint16_t enable_chan);
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_int_enable(CHAL_HANDLE handle, uint16_t fifo_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*****************************************************************************/
extern uint32_t chal_audio_ihfpath_get_dma_port_addr_offset( void );
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_set_gain(CHAL_HANDLE handle, uint32_t gain);
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits);
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_ihfpath_read_fifo_status(CHAL_HANDLE handle);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern uint32_t chal_audio_ihfpath_read_int_status(CHAL_HANDLE handle);
...
*  @return Number of words written to the FIFO
*****************************************************************************/
extern uint32_t chal_audio_ihfpath_write_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_ovf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_ihfpath_sdm_set_dither_poly(CHAL_HANDLE handle, uint32_t ihf_dither_poly_L, uint32_t ihf_dither_poly_R);
...
*  @return None
*****************************************************************************/
extern void chal_audio_ihfpath_sdm_set_dither_seed(CHAL_HANDLE handle, uint32_t ihf_dither_seed_L, uint32_t ihf_dither_seed_R);
...
*  @return None
*****************************************************************************/
extern  void chal_audio_ihfpath_eanc_in(CHAL_HANDLE handle, uint16_t enable );
...
*  @return None
*****************************************************************************/
extern  void chal_audio_ihfpath_sidetone_in(CHAL_HANDLE handle, uint16_t enable );
...
*  @return None
*****************************************************************************/
extern  void chal_audio_ihfpath_sdm_set_coef(CHAL_HANDLE handle, uint32_t hs_coef_L, uint32_t hs_coef_R);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_ihfpath_set_dac_pwr(CHAL_HANDLE handle, uint16_t enable_chan);
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_set_filter(CHAL_HANDLE handle, uint16_t filter);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_enable(CHAL_HANDLE handle, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_int_enable(CHAL_HANDLE handle, uint16_t fifo_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*  @return offset from the base address of where the DMA port address will be copied
*****************************************************************************/
extern uint32_t chal_audio_earpath_get_dma_port_addr_offset( void );
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_gain(CHAL_HANDLE handle, uint32_t gain);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_earpath_read_fifo_status(CHAL_HANDLE handle);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern uint32_t chal_audio_earpath_read_int_status(CHAL_HANDLE handle);
...
*  @return Number of words written to the FIFO
*****************************************************************************/
extern uint32_t chal_audio_earpath_write_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_ovf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_earpath_sdm_set_dither_poly(CHAL_HANDLE handle, uint32_t vout_dither_poly);
...
*  @return None
*****************************************************************************/
extern void chal_audio_earpath_sdm_set_dither_seed(CHAL_HANDLE handle, uint32_t vout_dither_seed);
...
*  @return None
*****************************************************************************/
extern  void chal_audio_earpath_sidetone_in(CHAL_HANDLE handle, uint16_t enable );
...
*  @return None
*****************************************************************************/
extern  void chal_audio_earpath_eanc_in(CHAL_HANDLE handle, uint16_t enable );
...
*  @return None
*****************************************************************************/
extern  void chal_audio_earpath_sdm_set_coef(CHAL_HANDLE handle, uint32_t *SDM_coef );
...
*  @return none
*****************************************************************************/
extern  void chal_audio_earpath_set_dac_pwr(CHAL_HANDLE handle, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_drv_pwr(CHAL_HANDLE handle, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_slowramp_ctrl(CHAL_HANDLE handle, uint16_t sr_ctrl);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_clear_slowramp_ctrl(CHAL_HANDLE handle, uint16_t sr_ctrl);
/**
*
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_isolation_ctrl(CHAL_HANDLE handle, uint16_t iso_ctrl);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_clear_isolation_ctrl(CHAL_HANDLE handle, uint16_t iso_ctrl);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_filter(CHAL_HANDLE handle, uint16_t filter);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_enable(CHAL_HANDLE handle, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_int_enable(CHAL_HANDLE handle, uint16_t fifo_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*  @return offset from the base address of where the DMA port address will be copied
*****************************************************************************/
extern uint32_t chal_audio_vibra_get_dma_port_addr_offset( void );
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_set_gain(CHAL_HANDLE handle, uint32_t gain);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_vibra_read_fifo_status(CHAL_HANDLE handle);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern uint32_t chal_audio_vibra_read_int_status(CHAL_HANDLE handle);
...
*  @return Number of words written to the FIFO
*****************************************************************************/
extern uint32_t chal_audio_vibra_write_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_ovf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_vibra_sdm_set_dither_poly(CHAL_HANDLE handle, uint32_t vout_dither_poly);
...
*  @return None
*****************************************************************************/
extern void chal_audio_vibra_sdm_set_dither_seed(CHAL_HANDLE handle, uint32_t vout_dither_seed);
...
*  @return None
*****************************************************************************/
extern  void chal_audio_vibra_sdm_set_coef(CHAL_HANDLE handle, uint32_t *SDM_coef );
...
*  @return none
*****************************************************************************/
extern  void chal_audio_vibra_set_dac_pwr(CHAL_HANDLE handle, uint16_t enable_chan);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_set_filter(CHAL_HANDLE handle, uint16_t filter);
...
*  @return none
*****************************************************************************/
extern void chal_audio_eancpath_enable(CHAL_HANDLE handle, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_eancpath_int_enable(CHAL_HANDLE handle, uint16_t fifo_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_eancpath_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*  @return offset from the base address of where the DMA port address will be copied
*****************************************************************************/
extern uint32_t chal_audio_eancpath_get_dma_port_addr_offset( void );
...
*  @return none
*****************************************************************************/
extern void chal_audio_eancpath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits);
...
*  @return none
*****************************************************************************/
extern void chal_audio_eancpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_eancpath_read_fifo_status(CHAL_HANDLE handle);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_eancpath_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_eancpath_set_AIIR_coef(CHAL_HANDLE handle, uint32_t *AIIR_coef );
...
*  @return none
*****************************************************************************/
extern  void chal_audio_eancpath_set_AFIR_coef(CHAL_HANDLE handle, uint32_t *AFIR_coef );
...
*  @return none
*****************************************************************************/
extern  void chal_audio_eancpath_set_DIIR_coef(CHAL_HANDLE handle, uint32_t *DIIR_coef );
...
*  @return none
*****************************************************************************/
extern  void chal_audio_eancpath_set_UIIR_coef(CHAL_HANDLE handle, uint32_t *UIIR_coef );
...
*  @return none
*****************************************************************************/
extern  void chal_audio_eancpath_ctrl_tap(CHAL_HANDLE handle, uint32_t taps);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_eancpath_set_cic_gain(CHAL_HANDLE handle, uint16_t ucic_gain, uint16_t dcic_gain);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_eancpath_set_input_mic(CHAL_HANDLE handle, uint16_t dmic);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern  uint32_t chal_audio_eancpath_read_int_status(CHAL_HANDLE handle);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_stpath_enable(CHAL_HANDLE handle, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_stpath_load_filter(CHAL_HANDLE handle, uint32_t *coeff, uint32_t length );
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_set_gain(CHAL_HANDLE handle, uint32_t gain);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_set_sofslope(CHAL_HANDLE handle, uint16_t sof_slope, uint16_t linear, uint32_t slope);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_config_misc(CHAL_HANDLE handle, uint16_t clipping, uint16_t dis_filter, uint16_t gain_bypass);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_set_filter_taps(CHAL_HANDLE handle, uint16_t lower_taps, uint16_t upper_taps);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2);
...
*  @return current status of the FIFO defined in CHAL_AUDIO_FIFO_STATUS_XXXX bitmask values
*****************************************************************************/
extern uint32_t chal_audio_stpath_read_fifo_status(CHAL_HANDLE handle);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_stpath_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf);
...
*  @return Current FIFO interrupt status (combination of CHAL_AUDIO_FIFO_STATUS_THR|ERR_INT)
*****************************************************************************/
extern  uint32_t chal_audio_stpath_read_int_status(CHAL_HANDLE handle);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_int_enable(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable );
...
*  @return none
*****************************************************************************/
extern void chal_audio_api_enable_dac(CHAL_HANDLE handle, uint32_t dac_mask, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_api_set_dac_attenuation(CHAL_HANDLE handle, uint32_t dac_mask, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_api_enable_adc(CHAL_HANDLE handle, uint32_t adc_mask, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_loopback_enable(CHAL_HANDLE handle, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_loopback_set_out_paths(CHAL_HANDLE handle, uint32_t dac_mask, uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_audiotx_set_dac_ctrl(CHAL_HANDLE handle, uint32_t ctrl);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_mic_pga_set_gain(CHAL_HANDLE handle, uint32_t gain);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_mic_pga_get_gain(CHAL_HANDLE handle, uint32_t *gain);
...
*  @return none
*****************************************************************************/
extern  void chal_audio_mic_input_select(CHAL_HANDLE handle, uint16_t mic_input);
...
*  @return 
*****************************************************************************/
extern  void chal_audio_eancpath_set_gain(CHAL_HANDLE handle, uint32_t gain);
...
*  @return 
*****************************************************************************/
extern  void chal_audio_eancpath_ctrl_shift(CHAL_HANDLE handle, uint32_t shift);
...
*  @return 
*****************************************************************************/
extern  void chal_audio_eancpath_DIIR_shift(CHAL_HANDLE handle, uint32_t shift_H, uint32_t shift_L);
...
*  @return 
*****************************************************************************/
extern  void chal_audio_eancpath_AIIR_shift(CHAL_HANDLE handle, uint32_t shift_H, uint32_t shift_L);
...
*  @return 
*****************************************************************************/
extern  void chal_audio_eancpath_UIIR_shift(CHAL_HANDLE handle, uint32_t shift_H, uint32_t shift_L);
...
*  @return 
*****************************************************************************/
extern void chal_audio_hspath_sdm_enable_dither(CHAL_HANDLE handle,  uint16_t enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_hspath_sdm_enable_dither_gain(CHAL_HANDLE handle,  uint16_t gain_enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_hspath_sdm_set_dither_strength(CHAL_HANDLE handle, uint16_t dither_streng_L, uint16_t dither_streng_R);
...
*  @return 
*****************************************************************************/
extern void chal_audio_ihfpath_sdm_enable_dither(CHAL_HANDLE handle, uint16_t enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_ihfpath_sdm_enable_dither_gain(CHAL_HANDLE handle,  uint16_t gain_enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_ihfpath_sdm_set_dither_strength(CHAL_HANDLE handle, uint16_t dither_streng_L, uint16_t dither_streng_R);
...
*  @return 
*****************************************************************************/
extern void chal_audio_mic_sync( CHAL_HANDLE handle, _Bool on_off );
