...
static struct __init pin_config board_pin_config[] = {
   ...
   /* SSP0 */
   PIN_CFG( SSP0_FS,  UARTB3_URXD,  0, OFF, OFF, 0, 0, 8MA ),
   PIN_CFG( SSP0_CLK, UARTB3_UTXD,  0, OFF, OFF, 0, 0, 8MA ),
   PIN_CFG( SSP0_RXD, UARTB3_URTSN, 0, OFF, OFF, 0, 0, 8MA ),
   PIN_CFG( SSP0_TXD, UARTB3_UCTSN, 0, OFF, OFF, 0, 0, 8MA ),
