...
static struct __init pin_config board_pin_config[] = {
	...
	/* WiFi SDIO */
	PIN_CFG(NORFLSH_AD_03, SDIO1_DATA_3, 0, OFF, ON, 0, 0, 4MA),
	PIN_CFG(NORFLSH_AD_02, SDIO1_CLK,    0, OFF, ON, 0, 0, 4MA),
        PIN_CFG(NORFLSH_AD_01, SDIO1_DATA_0, 0, OFF, ON, 0, 0, 4MA),
        PIN_CFG(NORFLSH_AD_00, SDIO1_CMD,    0, OFF, ON, 0, 0, 4MA),
        PIN_CFG(NORFLSH_RDY,   SDIO1_DATA_1, 0, OFF, ON, 0, 0, 4MA),
        PIN_CFG(NORFLSH_CLK_N, SDIO1_DATA_2, 0, OFF, ON, 0, 0, 4MA),
