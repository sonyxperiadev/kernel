...
static struct __init pin_config board_pin_config[] = {
	...
	/* eMMC */
	PIN_CFG(SDIO2_DATA_3, SDIO2_DATA_3, 0, OFF, OFF, 0, 0, 12MA),
	PIN_CFG(SDIO2_DATA_2, SDIO2_DATA_2, 0, OFF, OFF, 0, 0, 12MA),
	PIN_CFG(SDIO2_DATA_1, SDIO2_DATA_1, 0, OFF, OFF, 0, 0, 12MA),
	PIN_CFG(SDIO2_DATA_0, SDIO2_DATA_0, 0, OFF, OFF, 0, 0, 12MA),
	PIN_CFG(SDIO2_CMD,    SDIO2_CMD,    0, OFF, OFF, 0, 0, 12MA),
        PIN_CFG(SDIO2_CLK,    SDIO2_CLK,    0, OFF, OFF, 0, 0, 12MA),
	PIN_CFG(SDIO3_DATA_3, SDIO2_DATA_7, 0, OFF, OFF, 0, 0, 12MA),
        PIN_CFG(SDIO3_DATA_2, SDIO2_DATA_6, 0, OFF, OFF, 0, 0, 12MA),
        PIN_CFG(SDIO3_DATA_1, SDIO2_DATA_5, 0, OFF, OFF, 0, 0, 12MA),
        PIN_CFG(SDIO3_DATA_0, SDIO2_DATA_4, 0, OFF, OFF, 0, 0, 12MA),
