...
#define CHAL_CAPH_SWITCH_CH_REG_SIZE       ((CPH_SSASW_CH02_SRC_OFFSET - CPH_SSASW_CH01_SRC_OFFSET)/sizeof(uint32_t))

#define CHAL_CAPH_SWITCH_DST_REG_SIZE       ((CPH_SSASW_CH02_DST2_OFFSET - CPH_SSASW_CH02_DST1_OFFSET)/sizeof(uint32_t))
...
typedef struct
{
    ...
    _Bool   alloc_status[CHAL_CAPH_SWITCH_MAX_CHANNELS];   /* allocation status for each channel */
} chal_caph_switch_cb_t;
...
static  chal_caph_switch_cb_t   chal_caph_switchc_cb;
...
/****************************************************************************
*
*  Function Name: CHAL_HANDLE chal_caph_switch_init(uint32_t baseAddress)
*
*  Description: Initialize CAPH ASW
*
****************************************************************************/
CHAL_HANDLE chal_caph_switch_init(uint32_t baseAddress)
{
    uint8_t  ch;
...
void chal_caph_switch_select_src(CHAL_HANDLE handle,
            ...
            uint16_t address)
{
  uint32_t     base = ((chal_caph_switch_cb_t*)handle)->base;
    uint8_t      index;
    uint32_t     reg_val;
...
/****************************************************************************
*
*  Function Name: void chal_caph_switch_enable(CHAL_HANDLE handle,
*            uint16_t channel)
*
...
/****************************************************************************
*
*  Function Name: CAPH_SWITCH_CHNL_e chal_caph_switch_alloc_channel(CHAL_HANDLE handle)
*
...
/****************************************************************************
*
*  Function Name: CAPH_SWITCH_CHNL_e chal_caph_switch_alloc_given_channel(CHAL_HANDLE handle, CAPH_SWITCH_CHNL_e channel)
*
...
/****************************************************************************
*
*  Function Name: void chal_caph_switch_enable_clock(CHAL_HANDLE handle)
*
...
/****************************************************************************
*
*  Function Name: void chal_caph_switch_enable_clock_bypass(CHAL_HANDLE handle)
*
...
/****************************************************************************
*
*  Function Name: void chal_caph_switch_disable_clock_bypass(CHAL_HANDLE handle)
*
...
/****************************************************************************
*
*  Function Name: void chal_caph_switch_set_clock0(CHAL_HANDLE handle,
*            uint8_t m_ratio,
*            uint16_t n_ratio)
*
...
/****************************************************************************
*
*  Function Name: void chal_caph_switch_set_clock1(CHAL_HANDLE handle,
*
...
/****************************************************************************
*
*  Function Name: uint32_t chal_caph_switch_read_err_status(CHAL_HANDLE handle)
*
*  Description: CAPH ASW read data tx err status
*
****************************************************************************/
uint32_t chal_caph_switch_read_err_status(CHAL_HANDLE handle)
{
    uint32_t     base = ((chal_caph_switch_cb_t*)handle)->base;
    uint32_t     reg_val;
...
/****************************************************************************
*
*  Function Name: uint8_t chal_caph_switch_read_time(CHAL_HANDLE handle)
*
*  Description: CAPH ASW read time (PREADY_MAX_TIME)
*
****************************************************************************/
uint8_t chal_caph_switch_read_time(CHAL_HANDLE handle)
{
    uint32_t     base = ((chal_caph_switch_cb_t*)handle)->base;
    uint32_t     reg_val;
...
/****************************************************************************
*
*  Function Name: void chal_caph_switch_write_time(CHAL_HANDLE handle,
*            uint8_t time)
*
...
EXPORT_SYMBOL(chal_caph_switch_init);
EXPORT_SYMBOL(chal_caph_switch_deinit);
EXPORT_SYMBOL(chal_caph_switch_select_src);
EXPORT_SYMBOL(chal_caph_switch_add_dst);
EXPORT_SYMBOL(chal_caph_switch_remove_dst);
EXPORT_SYMBOL(chal_caph_switch_clear_all_dst);
EXPORT_SYMBOL(chal_caph_switch_enable);
EXPORT_SYMBOL(chal_caph_switch_disable);
EXPORT_SYMBOL(chal_caph_switch_alloc_channel);
EXPORT_SYMBOL(chal_caph_switch_alloc_given_channel);
EXPORT_SYMBOL(chal_caph_switch_free_channel);
EXPORT_SYMBOL(chal_caph_switch_set_datafmt);
EXPORT_SYMBOL(chal_caph_switch_select_trigger);
EXPORT_SYMBOL(chal_caph_switch_enable_clock);
EXPORT_SYMBOL(chal_caph_switch_disable_clock);
EXPORT_SYMBOL(chal_caph_switch_enable_clock_bypass);
EXPORT_SYMBOL(chal_caph_switch_disable_clock_bypass);
EXPORT_SYMBOL(chal_caph_switch_set_clock0);
EXPORT_SYMBOL(chal_caph_switch_set_clock1);
EXPORT_SYMBOL(chal_caph_switch_read_err_status);
EXPORT_SYMBOL(chal_caph_switch_read_time);
EXPORT_SYMBOL(chal_caph_switch_write_time);
