...
#define ESUB_CCU_FREQ_ID_ECO		2
#define ESUB_CCU_FREQ_ID_NRML		2
#define ESUB_CCU_FREQ_ID_TURBO		2
...
#define ESUB_CCU_FREQ_VOLT_TBL		VLT_ID_ECO,VLT_ID_ECO,VLT_ID_ECO,VLT_ID_ECO,\
						VLT_ID_NORMAL,VLT_ID_TURBO
#define ESUB_CCU_FREQ_VOLT_TBL_SZ 	6
...
#define ESUB_CCU_FREQ_POLICY_TBL		ESUB_CCU_FREQ_ID_ECO,ESUB_CCU_FREQ_ID_ECO, \
						ESUB_CCU_FREQ_ID_ECO, ESUB_CCU_FREQ_ID_TURBO
