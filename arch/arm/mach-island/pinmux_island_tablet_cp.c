...
static struct __init pin_config board_pin_config[] = {
	...
	/* SD/MMC */
	PIN_CFG(NAND_AD_5,    SDIO3_DATA_2, 0, OFF, ON, 0, 0, 12MA),
	PIN_CFG(NAND_AD_4,    SDIO3_DATA_1, 0, OFF, ON, 0, 0, 12MA),
	PIN_CFG(NAND_AD_3,    SDIO3_CMD,    0, OFF, ON, 0, 0, 12MA),
	PIN_CFG(NAND_AD_2,    SDIO3_DATA_3, 0, OFF, ON, 0, 0, 12MA),
	PIN_CFG(NAND_AD_1,    SDIO3_CLK,    0, OFF, ON, 0, 0, 12MA),
	PIN_CFG(NAND_AD_0,    SDIO3_DATA_0, 0, OFF, ON, 0, 0, 12MA),
