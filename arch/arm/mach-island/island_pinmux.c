...
static const struct pin_desc pin_desc_tbl[PN_MAX] = {
   ...
   /* GPIO 76 */ PIN_DESC(SSP2_FS_0,  SSP2_FS_0,  RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
   /* GPIO 75 */ PIN_DESC(SSP2_CLK,   SSP2_CLK,   RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
   /* GPIO 74 */ PIN_DESC(SSP2_RXD_0, SSP2_RXD_0, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
   /* GPIO 73 */ PIN_DESC(SSP2_TXD_0, SSP2_TXD_0, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
