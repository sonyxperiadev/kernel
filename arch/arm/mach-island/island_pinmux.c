...
static const struct pin_desc pin_desc_tbl[PN_MAX] = {
	...
	PIN_DESC(LCD_R_7, LCD_R_7, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
	PIN_DESC(LCD_R_6, LCD_R_6, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
	PIN_DESC(LCD_R_5, LCD_R_5, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
	PIN_DESC(LCD_R_4, LCD_R_4, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
	PIN_DESC(LCD_R_3, LCD_R_3, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
	PIN_DESC(LCD_R_2, LCD_R_2, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
	PIN_DESC(LCD_R_1, LCD_R_1, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
	PIN_DESC(LCD_R_0, LCD_R_0, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),

	PIN_DESC(LCD_G_7, LCD_G_7, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_G_6, LCD_G_6, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_G_5, LCD_G_5, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_G_4, LCD_G_4, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_G_3, LCD_G_3, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_G_2, LCD_G_2, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_G_1, LCD_G_1, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_G_0, LCD_G_0, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),

	PIN_DESC(LCD_B_7, LCD_B_7, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_B_6, LCD_B_6, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_B_5, LCD_B_5, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_B_4, LCD_B_4, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_B_3, LCD_B_3, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_B_2, LCD_B_2, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_B_1, LCD_B_1, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_B_0, LCD_B_0, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),

	PIN_DESC(LCD_HSYNC, LCD_HSYNC, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_VSYNC, LCD_VSYNC, RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_OE,    LCD_OE,    RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
        PIN_DESC(LCD_PCLK,  LCD_PCLK,  RESERVED, RESERVED, GPIO, RESERVED, RESERVED),
};
