...
#endif /*CONFIG_MACH_HAWAII_SS_LOGAN_REV00*/
};
...
static struct batt_esr_temp_lut ss_eb425161_esr_temp_lut[] = {
	{
		...
		.esr_vm_slope = -748, .esr_vm_offset = 5225,
		.esr_vh_slope = 1667, .esr_vh_offset = -4411,
	...
	},
	{
		...
		.esr_vm_slope = -4262, .esr_vm_offset = 17814,
		.esr_vh_slope = 825, .esr_vh_offset = -1763,
	...
	},
	{
		...
		.esr_vm_slope = -8240, .esr_vm_offset = 32190,
		.esr_vh_slope = -642, .esr_vh_offset = 3386,
		.esr_vf_slope = -3925, .esr_vf_offset = 17553,
	},
	{
		.temp = 0,
		.reset = 0, .fct = 894, .guardband = 30,
		.esr_vl_lvl = 3690, .esr_vm_lvl = 3791, .esr_vh_lvl = 4315,
		.esr_vl_slope = -12051, .esr_vl_offset = 46252,
		.esr_vm_slope = -8240, .esr_vm_offset = 32190,
		.esr_vh_slope = -642, .esr_vh_offset = 3386,
	...
	},
	{
		...
		.esr_vm_slope = -60334, .esr_vm_offset = 223794,
		.esr_vh_slope = -3421, .esr_vh_offset = 13478,
	...
	},
	{
		...
		.esr_vm_slope = -16139, .esr_vm_offset = 59944,
		.esr_vh_slope = -174, .esr_vh_offset = 947,
