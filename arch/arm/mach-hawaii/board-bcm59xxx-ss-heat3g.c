...
/* TODO regulator */
...
#if defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV01) || defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV00) || defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV01)
	...
	/* OTG: BOOST control by OFFVBUSb only */
...
#ifdef CONFIG_MACH_HAWAII_SS_COMMON
	/* Enable SMPL 750ms */
	{.addr = PMU_REG_SMPLCTRL, .val = 0x03, .mask = 0x0F},
#endif
