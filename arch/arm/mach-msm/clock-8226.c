...
#include <dt-bindings/clock/msm-clocks-8226.h>
...
static struct measure_clk wcnss_m_clk = {
	.c = {
		.ops = &clk_ops_empty,
		.dbg_name = "wcnss_m_clk",
		CLK_INIT(wcnss_m_clk.c),
	},
};
...
static struct clk_lookup msm_clocks_8226[] = {
	...
	CLK_LOOKUP_OF("apc0_m_clk", apc0_m_clk, ""),
	CLK_LOOKUP_OF("apc1_m_clk", apc1_m_clk, ""),
	CLK_LOOKUP_OF("apc2_m_clk", apc2_m_clk, ""),
	CLK_LOOKUP_OF("apc3_m_clk", apc3_m_clk, ""),
	CLK_LOOKUP_OF("l2_m_clk", l2_m_clk, ""),

	/* Measure clocks for WCNSS */
	CLK_LOOKUP_OF("measure",   measure_clk, "fb000000.qcom,wcnss-wlan"),
	...
	/* NFC */
	CLK_LOOKUP_OF("ref_clk",            cxo_d1_pin, "2-000e"),
	CLK_LOOKUP_OF("bb_clk2",            cxo_d1, ""),
	...
	CLK_LOOKUP_OF("mem_clk",      venus0_ahb_clk, "fdce0000.qcom,venus"),

	/* ACPUCLOCK */
	CLK_LOOKUP_OF("xo",     xo_a_clk, "f9011050.qcom,acpuclk"),
	CLK_LOOKUP_OF("gpll0",  gpll0_ao, "f9011050.qcom,acpuclk"),
	CLK_LOOKUP_OF("a7sspll", a7sspll, "f9011050.qcom,acpuclk"),
	CLK_LOOKUP_OF("clk-4",  gpll0_ao, "f9011050.qcom,clock-a7"),
	CLK_LOOKUP_OF("clk-5", a7sspll, "f9011050.qcom,clock-a7"),
	CLK_LOOKUP_OF("kpss_ahb", kpss_ahb_clk_src, ""),

	/* WCNSS CLOCKS */
	CLK_LOOKUP_OF("xo", cxo_wlan_clk, "fb000000.qcom,wcnss-wlan"),
	CLK_LOOKUP_OF("rf_clk",   cxo_a1, "fb000000.qcom,wcnss-wlan"),
	...
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc33c000.jtagmm"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc33d000.jtagmm"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc33e000.jtagmm"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc33f000.jtagmm"),
	...
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc33c000.jtagmm"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc33d000.jtagmm"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc33e000.jtagmm"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc33f000.jtagmm"),
	...
	/* SPS CLOCKS */
	CLK_LOOKUP_OF("dfab_clk",            pnoc_sps_clk, "f9984000.qcom,sps"),
	CLK_LOOKUP_OF("dma_bam_pclk", gcc_bam_dma_ahb_clk, "f9884000.qcom,sps"),
	...
	CLK_LOOKUP_OF("core_clk", gcc_blsp1_qup3_i2c_apps_clk, "f9925000.i2c"),
	/* lsuart-v14 Clocks */
	CLK_LOOKUP_OF("iface_clk",       gcc_blsp1_ahb_clk, "f991f000.serial"),
	CLK_LOOKUP_OF("core_clk", gcc_blsp1_uart3_apps_clk, "f991f000.serial"),

	CLK_LOOKUP_OF("iface_clk",       gcc_blsp1_ahb_clk, "f995e000.serial"),
	CLK_LOOKUP_OF("core_clk", gcc_blsp1_uart2_apps_clk, "f995e000.serial"),
	...
	CLK_LOOKUP_OF("core_clk_src", gud_ce1_clk_src,     "mcd"),
	...
	CLK_LOOKUP_OF("scm_iface_clk", gcc_ce1_ahb_clk, "fb21b000.qcom,pronto"),
	...
	/* SDCC */
	CLK_LOOKUP_OF("iface_clk", gcc_sdcc1_ahb_clk, "f9824000.qcom,sdcc"),
	CLK_LOOKUP_OF("core_clk", gcc_sdcc1_apps_clk, "f9824000.qcom,sdcc"),
	CLK_LOOKUP_OF("iface_clk", gcc_sdcc1_ahb_clk, "msm_sdcc.1"),
	CLK_LOOKUP_OF("core_clk", gcc_sdcc1_apps_clk, "msm_sdcc.1"),

	CLK_LOOKUP_OF("iface_clk", gcc_sdcc2_ahb_clk, "f98a4000.qcom,sdcc"),
	CLK_LOOKUP_OF("core_clk", gcc_sdcc2_apps_clk, "f98a4000.qcom,sdcc"),
	...
	CLK_LOOKUP_OF("bus_clk", mmssnoc_ahb_a_clk, ""),
	CLK_LOOKUP_OF("bus_clk", bimc_clk, ""),
	CLK_LOOKUP_OF("bus_clk", bimc_a_clk, ""),
	CLK_LOOKUP_OF("bus_clk_src", axi_clk_src, ""),

	CLK_LOOKUP_OF("gpll0", gpll0, ""),
	CLK_LOOKUP_OF("gpll1", gpll1, ""),
	CLK_LOOKUP_OF("mmpll0", mmpll0_pll, ""),
	CLK_LOOKUP_OF("mmpll1", mmpll1_pll, ""),

	CLK_LOOKUP_OF("core_clk", gcc_blsp1_qup1_i2c_apps_clk, ""),
	CLK_LOOKUP_OF("core_clk", gcc_blsp1_qup2_i2c_apps_clk, ""),
	...
	CLK_LOOKUP_OF("core_clk", camss_jpeg_jpeg0_clk, "fd8c35a4.qcom,gdsc"),
	CLK_LOOKUP_OF("core_clk", camss_vfe_vfe0_clk,	"fd8c36a4.qcom,gdsc"),
	CLK_LOOKUP_OF("csi_clk", camss_csi_vfe0_clk,	"fd8c36a4.qcom,gdsc"),
	CLK_LOOKUP_OF("cpp_clk", camss_vfe_cpp_clk,	"fd8c36a4.qcom,gdsc"),
	CLK_LOOKUP_OF("core_clk", oxili_gfx3d_clk, "fd8c4034.qcom,gdsc"),

	/* MM sensor clocks */
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "6f.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk1_clk_src, "90.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "6a.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "6c.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "20.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "6f.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk1_clk, "90.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "6a.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "6c.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "20.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "0.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "1.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "0.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "1.qcom,camera"),

#if !defined(CONFIG_MACH_SONY_EAGLE) && !defined(CONFIG_MACH_SONY_SEAGULL)
	...
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "6d.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "6d.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "6e.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "6e.qcom,camera"),

	/* eeprom clocks */
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "6c.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "6c.qcom,eeprom"),
#endif

	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "18.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "18.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "6b.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "6b.qcom,eeprom"),
	...
	CLK_LOOKUP_OF("camss_top_ahb_clk", camss_top_ahb_clk,
					"fda0a000.qcom,ispif"),
	CLK_LOOKUP_OF("csi0_ahb_clk", camss_csi0_ahb_clk,
					"fda0a000.qcom,ispif"),
	CLK_LOOKUP_OF("csi0_src_clk", csi0_clk_src,
					"fda0a000.qcom,ispif"),
	CLK_LOOKUP_OF("csi0_phy_clk", camss_csi0phy_clk,
					"fda0a000.qcom,ispif"),
	...
	CLK_LOOKUP_OF("csi1_ahb_clk", camss_csi1_ahb_clk,
					"fda0a000.qcom,ispif"),
	CLK_LOOKUP_OF("csi1_src_clk", csi1_clk_src,
					"fda0a000.qcom,ispif"),
	CLK_LOOKUP_OF("csi1_phy_clk", camss_csi1phy_clk,
					"fda0a000.qcom,ispif"),
	...
	CLK_LOOKUP_OF("camss_top_ahb_clk", camss_top_ahb_clk,
					"fda14000.qcom,vfe"),
	CLK_LOOKUP_OF("vfe_clk_src", vfe0_clk_src,	 "fda14000.qcom,vfe"),
	CLK_LOOKUP_OF("camss_vfe_vfe_clk", camss_vfe_vfe0_clk,
					"fda14000.qcom,vfe"),
	CLK_LOOKUP_OF("camss_csi_vfe_clk", camss_csi_vfe0_clk,
					"fda14000.qcom,vfe"),
	...
	CLK_LOOKUP_OF("cpp_bus_clk", camss_vfe_vfe_axi_clk, "fda04000.qcom,cpp"),
	...
	CLK_LOOKUP_OF("mem_iface_clk", oxilicx_axi_clk,
	...
	CLK_LOOKUP_OF("cam_gp0_clk", camss_gp0_clk, ""),
	CLK_LOOKUP_OF("cam_gp1_clk", camss_gp1_clk, ""),
	...
	/* Audio clocks */
	CLK_LOOKUP_OF("osr_clk", div_clk1, "msm-dai-q6-dev.224"),
	CLK_LOOKUP_OF("osr_clk", div_clk1, "msm-dai-q6-dev.4106"),
	CLK_LOOKUP_OF("osr_clk", div_clk1, "msm-dai-q6-dev.16384"),
	CLK_LOOKUP_OF("osr_clk", div_clk1, "msm-dai-q6-dev.16386"),
	CLK_LOOKUP_OF("osr_clk", div_clk1, "msm-dai-q6-dev.16390"),
	CLK_LOOKUP_OF("osr_clk", div_clk1, "msm-dai-q6-dev.16391"),

	/* Add QCEDEV clocks */
	CLK_LOOKUP_OF("core_clk",     gcc_ce1_clk,      "fd400000.qcom,qcedev"),
	CLK_LOOKUP_OF("iface_clk",    gcc_ce1_ahb_clk,  "fd400000.qcom,qcedev"),
	CLK_LOOKUP_OF("bus_clk",      gcc_ce1_axi_clk,  "fd400000.qcom,qcedev"),
	CLK_LOOKUP_OF("core_clk_src", ce1_clk_src,      "fd400000.qcom,qcedev"),

	/* Add QCRYPTO clocks */
	CLK_LOOKUP_OF("core_clk",     gcc_ce1_clk,     "fd404000.qcom,qcrypto"),
	CLK_LOOKUP_OF("iface_clk",    gcc_ce1_ahb_clk, "fd404000.qcom,qcrypto"),
	CLK_LOOKUP_OF("bus_clk",      gcc_ce1_axi_clk, "fd404000.qcom,qcrypto"),
	CLK_LOOKUP_OF("core_clk_src", ce1_clk_src,     "fd404000.qcom,qcrypto"),

	CLK_LOOKUP_OF("core_clk",     gcc_ce1_clk,     "fd400000.qcom,qcrypto"),
	CLK_LOOKUP_OF("iface_clk",    gcc_ce1_ahb_clk, "fd400000.qcom,qcrypto"),
	CLK_LOOKUP_OF("bus_clk",      gcc_ce1_axi_clk, "fd400000.qcom,qcrypto"),
	CLK_LOOKUP_OF("core_clk_src", ce1_clk_src,     "fd400000.qcom,qcrypto"),

	/* DSI PLL clocks */
	CLK_LOOKUP_OF("",		dsi_vco_clk_8226,                  ""),
	CLK_LOOKUP_OF("",		analog_postdiv_clk_8226,         ""),
	CLK_LOOKUP_OF("",		indirect_path_div2_clk_8226,     ""),
	CLK_LOOKUP_OF("",		pixel_clk_src_8226,              ""),
	CLK_LOOKUP_OF("",		byte_mux_8226,                   ""),
	CLK_LOOKUP_OF("",		byte_clk_src_8226,               ""),
	...
	CLK_LOOKUP_OF("iface_clk", gcc_blsp1_ahb_clk, "f9924000.i2c"),/* sensor */
	CLK_LOOKUP_OF("core_clk", gcc_blsp1_qup2_i2c_apps_clk, "f9924000.i2c"),/* sensor */

	CLK_LOOKUP_OF("cam_src_clk", mclk1_clk_src, "42.qcom,camera"), /* gc0339 */
	CLK_LOOKUP_OF("cam_clk", camss_mclk1_clk, "42.qcom,camera"), /* gc0339 */

	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "6d.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "6d.qcom,camera"),

	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "a1.qcom,eeprom"), /* EEPROM*/
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "a1.qcom,eeprom"), /* EEPROM*/
	...
	CLK_LOOKUP_OF("cam_src_clk", mclk1_clk_src, "6e.qcom,camera"),

	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "34.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk1_clk, "6e.qcom,camera"),
#elif defined(CONFIG_MACH_SONY_TIANCHI)
	CLK_LOOKUP_OF("nfc_clk", cxo_d1_pin, "2-0028"),
#endif
};
