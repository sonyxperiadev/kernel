...
#define msm_gpiomux_install		gpiomux_set_qct_configs
#define msm_gpiomux_install_nowrite	gpiomux_set_qct_configs
...
#endif
#undef msm_gpiomux_install_nowrite
#undef msm_gpiomux_install
