...
static struct gpiomux_setting fih_sensors_active = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_UP,
};
...
static struct msm_gpiomux_config fih_sensor_configs[] __initdata = {
	{
		.gpio = 63,
		.settings = {
			[GPIOMUX_ACTIVE]    = &fih_sensors_active,
		},
	},
	{
		.gpio = 64,
...
void __init msm8226_init_gpiomux(void)
{
	...
	msm_gpiomux_install(fih_sensor_configs, ARRAY_SIZE(fih_sensor_configs));
