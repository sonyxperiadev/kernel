/* arch/arm/mach-msm/gpiomux-semc_fuji_nozomi.c
 *
...
static struct gpiomux_setting pa_on_u900 = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config semc_fuji_all_cfgs[] __initdata = {
	...
	{ /* PA_ON_U900/BOOT_CONFIG_0 */
		.gpio = 81,
		.settings = {
			[GPIOMUX_ACTIVE] = &pa_on_u900,
			[GPIOMUX_SUSPENDED] = &gpio_2ma_no_pull_low,
		},
	},
	{ /* BOOT_CONFIG_2 */
...
static int pm8058_unused_gpio[] = {
	6, 7, 8, 14, 15, 16, 18, 19, 22, 23, 24, 25, 33, 34, 35, 36, 37
};
