...
#if (defined(CONFIG_MACH_SONY_TOGARI_ROW) || defined(CONFIG_MACH_SONY_HONAMI_ROW) || defined(CONFIG_MACH_SONY_AMAMI_ROW) && \
...
#if defined(CONFIG_MACH_SONY_SIRIUS) || defined(CONFIG_MACH_SONY_CASTOR) || defined(CONFIG_MACH_SONY_CASTOR_WINDY) || \
    defined(CONFIG_MACH_SONY_TOGARI_ROW) || defined(CONFIG_MACH_SONY_HONAMI_ROW) || defined(CONFIG_MACH_SONY_AMAMI_ROW)
