...
#if (defined(CONFIG_MACH_SONY_RHINE) && defined(CONFIG_SONY_CAM_V4L2))
...
#if !(defined(CONFIG_MACH_SONY_SHINANO) && defined(CONFIG_SONY_CAM_V4L2))
...
#if defined(CONFIG_MACH_SONY_RHINE) || defined(CONFIG_MACH_SONY_SHINANO)
