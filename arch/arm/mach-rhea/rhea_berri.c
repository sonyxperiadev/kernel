...
/*     independent module is a module which is not derived from this software.*/
...
#include <mach/rheaberri/bmp18x_i2c_settings.h>
#endif

#if defined(CONFIG_AL3006) || defined(CONFIG_AL3006_MODULE)
#include <mach/rheaberri/al3006_i2c_settings.h>
#endif
...
static const char *const pmu_clients[] = {
...
#endif
	platform_add_devices(rhea_berri_plat_devices,
			     ARRAY_SIZE(rhea_berri_plat_devices));

	rhea_berri_add_i2c_devices();
#ifdef CONFIG_REGULATOR_USERSPACE_CONSUMER
	platform_add_devices(rhea_berri_userspace_consumer_devices,
			     ARRAY_SIZE(rhea_berri_userspace_consumer_devices));
#endif
#ifdef CONFIG_REGULATOR_VIRTUAL_CONSUMER
	platform_add_devices(rhea_berri_virtual_consumer_devices,
			     ARRAY_SIZE(rhea_berri_virtual_consumer_devices));
#endif
