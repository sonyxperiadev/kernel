...
//	PIN_CFG(GPIO21, UB2CTSN, 0, OFF, ON, 0, 0, 8MA),			// UB2_BT_UART_CTS_N
	...
	PIN_CFG(GPIO21, LCDD7,  0, OFF, ON,  0, 0, 8MA),			//	LCD_D7
	PIN_CFG(GPIO22, LCDD6,  0, OFF, ON,  0, 0, 8MA),			//	LCD_D6
	PIN_CFG(GPIO23, LCDD5,  0, OFF, ON,  0, 0, 8MA),			//	LCD_D5
	PIN_CFG(GPIO24, LCDD4,  0, OFF, ON,  0, 0, 8MA),			//	LCD_D4
