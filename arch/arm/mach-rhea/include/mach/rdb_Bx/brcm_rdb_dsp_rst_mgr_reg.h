...
#define DSP_RST_MGR_REG_WR_ACCESS_RESERVED_MASK                           0x7F0000FE
...
#define    DSP_RST_MGR_REG_WR_ACCESS_PASSWORD_SHIFT                       8
#define    DSP_RST_MGR_REG_WR_ACCESS_PASSWORD_MASK                        0x00FFFF00
