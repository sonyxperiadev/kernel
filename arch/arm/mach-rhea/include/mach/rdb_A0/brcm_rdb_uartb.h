...
#define    UARTB_RBR_THR_DLL_UNION_SHIFT                                  0
#define    UARTB_RBR_THR_DLL_UNION_MASK                                   0x000000FF

#define UARTB_DLH_IER_OFFSET                                              0x00000004
#define UARTB_DLH_IER_TYPE                                                UInt32
#define UARTB_DLH_IER_RESERVED_MASK                                       0xFFFFFF00
#define    UARTB_DLH_IER_UNION_SHIFT                                      0
#define    UARTB_DLH_IER_UNION_MASK                                       0x000000FF

#define UARTB_IIR_FCR_OFFSET                                              0x00000008
#define UARTB_IIR_FCR_TYPE                                                UInt32
#define UARTB_IIR_FCR_RESERVED_MASK                                       0xFFFFFF00
#define    UARTB_IIR_FCR_UNION_SHIFT                                      0
#define    UARTB_IIR_FCR_UNION_MASK                                       0x000000FF
