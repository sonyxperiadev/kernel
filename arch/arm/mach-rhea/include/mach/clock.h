...
#define	AXI_TRACE11_APB_BUS_CLK_NAME_STR	"axi_trace19_apb"
#define	AXI_TRACE12_APB_BUS_CLK_NAME_STR	"axi_trace19_apb"
#define	AXI_TRACE13_APB_BUS_CLK_NAME_STR	"axi_trace19_apb"
...
#define ARM_SWITCH_CLK_FLAGS				AUTO_GATE
...
#define ACI_APB_BUS_CLK_FLAGS				AUTO_GATE
#define PWRMGR_AXI_BUS_CLK_FLAGS			AUTO_GATE
#define APB6_BUS_CLK_FLAGS 				AUTO_GATE
#define GPIOKP_APB_BUS_CLK_FLAGS			AUTO_GATE
#define CHIPREG_APB_BUS_CLK_FLAGS			AUTO_GATE
#define FMON_APB_BUS_CLK_FLAGS				AUTO_GATE
#define HUB_TZCFG_APB_BUS_CLK_FLAGS			AUTO_GATE
#define SEC_WD_APB_BUS_CLK_FLAGS			AUTO_GATE
#define SYSEMI_SEC_APB_BUS_CLK_FLAGS			AUTO_GATE
#define SYSEMI_OPEN_APB_BUS_CLK_FLAGS			AUTO_GATE
#define SPM_APB_BUS_CLK_FLAGS				AUTO_GATE
#define BSC2_APB_BUS_CLK_FLAGS				AUTO_GATE
#define SWITCH_AXI_BUS_CLK_FLAGS			AUTO_GATE
#define APB1_BUS_CLK_FLAGS 				AUTO_GATE
#define MPHI_AHB_BUS_CLK_FLAGS				AUTO_GATE
#endif /* CONFIG_ARCH_RHEA_B0 */
...
#define PWRMGR_AXI_BUS_CLK_FLAGS			0
#define APB6_BUS_CLK_FLAGS 				0
#define GPIOKP_APB_BUS_CLK_FLAGS			0
#define CHIPREG_APB_BUS_CLK_FLAGS			0
#define FMON_APB_BUS_CLK_FLAGS				0
#define HUB_TZCFG_APB_BUS_CLK_FLAGS			0
#define SEC_WD_APB_BUS_CLK_FLAGS			0
#define SYSEMI_SEC_APB_BUS_CLK_FLAGS			0
#define SYSEMI_OPEN_APB_BUS_CLK_FLAGS			0
#define SPM_APB_BUS_CLK_FLAGS				0
#define BSC2_APB_BUS_CLK_FLAGS				0
#define SWITCH_AXI_BUS_CLK_FLAGS			0
#define APB1_BUS_CLK_FLAGS 				0
#define MPHI_AHB_BUS_CLK_FLAGS				DISABLE_ON_INIT
#endif /* CONFIG_ARCH_RHEA_A0 */


#define ARM_CORE_CLK_FLAGS			UPDATE_LPJ
#define APB0_CLK_FLAGS				AUTO_GATE
...
#define REF_96M_REF_CLK_FLAGS 			AUTO_GATE|ENABLE_ON_INIT
#define VAR_96M_REF_CLK_FLAGS 			AUTO_GATE|ENABLE_ON_INIT
#define VAR_500M_VARVDD_REF_CLK_FLAGS 			0
#define REF_312M_REF_CLK_FLAGS 			AUTO_GATE|ENABLE_ON_INIT
...
#define VAR_312M_REF_CLK_FLAGS 			AUTO_GATE|ENABLE_ON_INIT
...
#define REF_CX40_VARVDD_REF_CLK_FLAGS 	0
...
#define NOR_APB_BUS_CLK_FLAGS 		DISABLE_ON_INIT
#define TMON_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define APB5_BUS_CLK_FLAGS 			AUTO_GATE
#define CTI_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define FUNNEL_APB_BUS_CLK_FLAGS 		AUTO_GATE
#define TPIU_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define VC_ITM_APB_BUS_CLK_FLAGS 		AUTO_GATE
#define SEC_VIOL_TRAP4_APB_BUS_CLK_FLAGS	AUTO_GATE
#define SEC_VIOL_TRAP5_APB_BUS_CLK_FLAGS	AUTO_GATE
#define SEC_VIOL_TRAP7_APB_BUS_CLK_FLAGS	AUTO_GATE
#define AXI_TRACE19_APB_BUS_CLK_FLAGS	0
#define AXI_TRACE11_APB_BUS_CLK_FLAGS	AUTO_GATE
#define AXI_TRACE12_APB_BUS_CLK_FLAGS	AUTO_GATE
#define AXI_TRACE13_APB_BUS_CLK_FLAGS	AUTO_GATE
#define HSI_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define HSI_TX_PERI_CLK_FLAGS			ENABLE_HVT
#define HSI_RX_PERI_CLK_FLAGS			ENABLE_HVT
#define ETB_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define FINAL_FUNNEL_APB_BUS_CLK_FLAGS 	AUTO_GATE
/*JIRA HWRHEA-1477 : Enable Auto gating for ATB_FILTER APB clock */
#define ATB_FILTER_APB_BUS_CLK_FLAGS 	AUTO_GATE
#define AUDIOH_26M_PERI_CLK_FLAGS		DONOT_NOTIFY_STATUS_TO_CCU
/*JIRA HWRHEA-1166: Do not enable Auto gating for Hub clock, not fixed in B0 */
#define HUB_PERI_CLK_FLAGS				DONOT_NOTIFY_STATUS_TO_CCU
#define BT_SLIM_AHB_APB_BUS_CLK_FLAGS 	DISABLE_ON_INIT
#define ETB2AXI_APB_BUS_CLK_FLAGS 		AUTO_GATE
#define AUDIOH_APB_BUS_CLK_FLAGS 		0
#define SSP3_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define SSP4_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define VAR_SPM_APB_BUS_CLK_FLAGS 		0
#define NOR_BUS_CLK_FLAGS 				DISABLE_ON_INIT
#define AUDIOH_2P4M_PERI_CLK_FLAGS 		RATE_FIXED
#define AUDIOH_156M_PERI_CLK_FLAGS		RATE_FIXED
#define SSP3_AUDIO_PERI_CLK_FLAGS 		0
#define SSP3_PERI_CLK_FLAGS 			0
#define SSP4_AUDIO_PERI_CLK_FLAGS 		0
#define SSP4_PERI_CLK_FLAGS 			0
#define TMON_1M_PERI_CLK_FLAGS 			DISABLE_ON_INIT
#define CAPH_SRCMIXER_PERI_CLK_FLAGS	DISABLE_ON_INIT|ENABLE_HVT
#define DAP_SWITCH_PERI_CLK_FLAGS 		RATE_FIXED
#define BROM_PERI_CLK_FLAGS 			AUTO_GATE
...
#define SIM2_APB_BUS_CLK_FLAGS				0
#define HUB_TIMER_APB_BUS_CLK_FLAGS 		AUTO_GATE|ENABLE_ON_INIT
#define PMU_BSC_APB_BUS_CLK_FLAGS 		AUTO_GATE
#define VCEMI_SEC_APB_BUS_CLK_FLAGS 	0
#define VCEMI_OPEN_APB_BUS_CLK_FLAGS 	0
#define DAP_BUS_CLK_FLAGS 			AUTO_GATE
#define SIM_PERI_CLK_FLAGS 				0
#define SIM2_PERI_CLK_FLAGS 			0
#define HUB_TIMER_PERI_CLK_FLAGS		ENABLE_ON_INIT|DONOT_NOTIFY_STATUS_TO_CCU
/*JIRA HWRHEA-1183 : PMU BSC clock should be autogated, else AON cannot wakeup from sleep*/
#define PMU_BSC_PERI_CLK_FLAGS			AUTO_GATE|DONOT_NOTIFY_STATUS_TO_CCU
...
#define SYS_SWITCH_AXI_BUS_CLK_FLAGS 		AUTO_GATE
#define MASTER_SWITCH_AHB_BUS_CLK_FLAGS 	AUTO_GATE
#define MASTER_SWITCH_AXI_BUS_CLK_FLAGS 	0
#define ARMCORE_AXI_BUS_CLK_FLAGS		AUTO_GATE
#define APB4_BUS_CLK_FLAGS			AUTO_GATE
#define APB8_BUS_CLK_FLAGS			AUTO_GATE
#define DMA_AXI_BUS_CLK_FLAGS			0
...
#define USBH_48M_PERI_CLK_FLAGS 		0
#define USBH_12M_PERI_CLK_FLAGS 		0
#define KPS_CCU_CLK_FLAGS 				CCU_TARGET_AC
#define EXT_AXI_BUS_CLK_FLAGS			AUTO_GATE
...
#define BSC1_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define PWM_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define SSP0_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define HSM_AHB_BUS_CLK_FLAGS 			AUTO_GATE
#define HSM_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define SPUM_OPEN_APB_BUS_CLK_FLAGS 		AUTO_GATE
#define SPUM_SEC_APB_BUS_CLK_FLAGS 		AUTO_GATE
#define TIMERS_APB_BUS_CLK_FLAGS 		AUTO_GATE
#define APB2_BUS_CLK_FLAGS 			AUTO_GATE
...
#define SSP0_AUDIO_PERI_CLK_FLAGS 		0
...
#define SPUM_OPEN_PERI_CLK_FLAGS 		DISABLE_ON_INIT|ENABLE_HVT
...
#define CSI0_AXI_BUS_CLK_FLAGS 			NOTIFY_STATUS_TO_CCU
#define CSI1_AXI_BUS_CLK_FLAGS 			NOTIFY_STATUS_TO_CCU
#define ISP_AXI_BUS_CLK_FLAGS 			NOTIFY_STATUS_TO_CCU
#define SMI_AXI_BUS_CLK_FLAGS 			NOTIFY_STATUS_TO_CCU
#define VCE_AXI_BUS_CLK_FLAGS 			NOTIFY_STATUS_TO_CCU
#define DSI0_AXI_BUS_CLK_FLAGS 			0
#define DSI1_AXI_BUS_CLK_FLAGS 			0
#define MM_APB_BUS_CLK_FLAGS 			AUTO_GATE
#define SPI_APB_BUS_CLK_FLAGS 			0
#define MM_DMA_AXI_BUS_CLK_FLAGS 		NOTIFY_STATUS_TO_CCU
#define V3D_AXI_BUS_CLK_FLAGS 			NOTIFY_STATUS_TO_CCU
#define CSI0_LP_PERI_CLK_FLAGS 			0
#define CSI1_LP_PERI_CLK_FLAGS 			0
#define SMI_PERI_CLK_FLAGS 				0
#define DSI0_ESC_PERI_CLK_FLAGS 		ENABLE_HVT
#define DSI1_ESC_PERI_CLK_FLAGS 		ENABLE_HVT
#define DSI_PLL_O_DSI_PLL_PERI_CLK_FLAGS 			0
//#define	DIG_CH0_PERI_CLK_FLAGS			AUTO_GATE
#define	DIG_CH0_PERI_CLK_FLAGS		 0
#define	DIG_CH1_PERI_CLK_FLAGS			AUTO_GATE
#define	DIG_CH2_PERI_CLK_FLAGS			AUTO_GATE
#define	DIG_CH3_PERI_CLK_FLAGS			AUTO_GATE
