...
#define ARM_PERI_CLK_FLAGS			HYST_ENABLE | HYST_HIGH
...
#define DMAC_MUX_APB_BUS_CLK_FLAGS 		DISABLE_ON_INIT
...
#define UARTB_PERI_CLK_FLAGS 			0 //DONOT_NOTIFY_STATUS_TO_CCU
...
#define VCE_AXI_BUS_CLK_FLAGS 			HYST_ENABLE | HYST_HIGH | REQUEST_OPP|NOTIFY_STATUS_TO_CCU
...
#define V3D_AXI_BUS_CLK_FLAGS 			NOTIFY_STATUS_TO_CCU|HYST_ENABLE | HYST_HIGH | REQUEST_OPP
#define CSI0_LP_PERI_CLK_FLAGS 			HYST_ENABLE|HYST_HIGH
#define CSI1_LP_PERI_CLK_FLAGS 			HYST_ENABLE|HYST_HIGH
#define SMI_PERI_CLK_FLAGS 			HYST_ENABLE|HYST_HIGH| REQUEST_OPP
