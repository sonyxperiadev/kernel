...
//	PIN_CFG(GPIO11, LCDD8, 0, OFF, ON, 0, 0, 8MA),
	...
	PIN_CFG(MMC1DAT4, MMC1DAT4, 0, OFF, ON, 0, 0, 16MA),
	PIN_CFG(MMC1DAT5, MMC1DAT5, 0, OFF, ON, 0, 0, 16MA),
	PIN_CFG(MMC1DAT6, MMC1DAT6, 0, OFF, ON, 0, 0, 16MA),
	PIN_CFG(MMC1DAT7, MMC1DAT7, 0, OFF, ON, 0, 0, 16MA),
