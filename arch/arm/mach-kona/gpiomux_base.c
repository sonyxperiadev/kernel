...
#include <mach/csp/gpiomux_groups.h>
#include <csp/gpio_defs_hana.h>
...
const gpiomux_group_t gpiomux_GroupList_BCMHANA_BASE[] =
{
...
const unsigned int gpiomux_GroupListEntries_BCMHANA_BASE = ARRAY_LEN(gpiomux_GroupList_BCMHANA_BASE);
