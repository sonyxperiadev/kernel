...
/* Map 1 reg */
/* Fuel Gauge */
#define PMU_REG_FGCTRL1			ENC_PMU_REG(FIFO_MODE, MAP1, 0x40)
#define FGCTRL1_FGHOSTEN_MASK		0x1
#define FGCTRL1_FGHOSTEN_SHIFT		0x0
#define FGCTRL1_FGCHP_MASK		0x2
#define FGCTRL1_FGCHP_SHIFT		0x1
#define FGCTRL1_FGOVLP_MASK		0x4
#define FGCTRL1_FGOVLP_SHIFT		0x2
#define FGCTRL1_FGCHPDIV_MASK		0x38
#define FGCTRL1_FGCHPDIV_SHIFT		0x3
#define FGCTRL1_RESERVED_MASK		0xC0
#define FGCTRL1_RESERVED_SHIFT		0x6

#define PMU_REG_FGCTRL2			ENC_PMU_REG(FIFO_MODE, MAP1, 0x41)
#define FGCTRL2_FGTRIM_MASK		0x1
#define FGCTRL2_FGTRIM_SHIFT		0x0
#define FGCTRL2_FGCAL_MASK		0x2
#define FGCTRL2_FGCAL_SHIFT		0x1
#define FGCTRL2_LONGCAL_MASK		0x4
#define FGCTRL2_LONGCAL_SHIFT		0x2
#define FGCTRL2_FG1PTCAL_MASK		0x8
#define FGCTRL2_FG1PTCAL_SHIFT		0x3
#define FGCTRL2_FGRESET_MASK		0x10
#define FGCTRL2_FGRESET_SHIFT		0x4
#define FGCTRL2_FGFRZREAD_MASK		0x20
#define FGCTRL2_FGFRZREAD_SHIFT		0x5
#define FGCTRL2_FGFRZSMPL_MASK		0x40
#define FGCTRL2_FGRFZSMPL_SHIFT		0x6
#define FGCTRL2_FGFORCECAL_MASK		0x80
#define FGCTRL2_FGFORCECAL_SHIFT	0x7

#define PMU_REG_FGOPMODCTRL	ENC_PMU_REG(FIFO_MODE, MAP1, 0x42)
#define FGOPMODCTRL_OPMODCTRL0_MASK	0x1
#define FGOPMODCTRL_OPMODCTRL0_SHIFT	0x0
#define FGOPMODCTRL_OPMODCTRL1_MASK	0x2
#define FGOPMODCTRL_OPMODCTRL1_SHIFT	0x1
#define FGOPMODCTRL_OPMODCTRL2_MASK	0x4
#define FGOPMODCTRL_OPMODCTRL2_SHIFT	0x2
#define FGOPMODCTRL_OPMODCTRL3_MASK	0x8
#define FGOPMODCTRL_OPMODCTRL3_SHIFT	0x3
#define FGOPMODCTRL_FGSYNCMODE_MASK	0x10
#define FGOPMODCTRL_FGSYNCMODE_SHIFT	0x4
#define FGOPMODCTRL_FGMODEON_MASK	0x20
#define FGOPMODCTRL_FGMODEON_SHIFT	0x5
#define FGOPMODCTRL_RESERVED_MASK	0xC0
#define FGOPMODCTRL_RESERVED_SHIFT	0x6

#define PMU_REG_FGOCICCTRL1		ENC_PMU_REG(FIFO_MODE, MAP1, 0x43)
#define FGOCICCTRL1_FGCOMBRATE_MASK	0x3
#define FGOCICCTRL1_FGCOMBRATE_SHIFT	0x0

#define PMU_REG_FGOFFSET_TRIM		ENC_PMU_REG(FIFO_MODE, MAP1, 0x44)
#define PMU_REG_FGGAIN_TRIM		ENC_PMU_REG(FIFO_MODE, MAP1, 0x45)

#define PMU_REG_FGACCM1			ENC_PMU_REG(FIFO_MODE, MAP1, 0x46)
#define FGACCM1_FGACCM_25_24_MASK	0x3
#define FGACCM1_FGACCM_25_24_SHIFT	0x0
#define FGACCM1_RESERVED_MASK		0x7C
#define FGACCM1_RESERVED_SHIFT		0x2
#define FGACCM1_FGRDVALID_MASK		0x80
#define FGACCM1_FGRDVALID_SHIFT		0x7

#define PMU_REG_FGACCM2			ENC_PMU_REG(FIFO_MODE, MAP1, 0x47)
#define FGACCM2_FGACCM_23_16_MASK	0xFF
#define FGACCM2_FGACCM_23_16_SHIFT	0x0

#define PMU_REG_FGACCM3			ENC_PMU_REG(FIFO_MODE, MAP1, 0x48)
#define FGACCM3_FGACCM_15_8_MASK	0xFF
#define FGACCM3_FGACCM_15_8_SHIFT	0x0

#define PMU_REG_FGACC4			ENC_PMU_REG(FIFO_MODE, MAP1, 0x49)
#define FGACCM4_FGACCM_7_0_MASK		0xFF
#define FGACCM4_FGACCM_7_0_SHIFT	0x0

#define PMU_REG_FGCNT1			ENC_PMU_REG(FIFO_MODE, MAP1, 0x4A)
#define FGCNT1_FGCNT_11_8_MASK		0xF
#define FGCNT1_FGCNT_11_8_SHIFT		0x0
#define FGCNT1_RESERVED_MASK		0xF
#define FGCNT1_RESERVED_SHIFT		0x4

#define PMU_REG_FGCNT2			ENC_PMU_REG(FIFO_MODE, MAP1, 0x4B)
#define FGCNT2_FGCNT_7_0_MASK		0xFF
#define FGCNT2_FGCNT_7_0_SHIFT		0x0

#define PMU_REG_FGSLEEPCNT1		ENC_PMU_REG(FIFO_MODE, MAP1, 0x4C)
#define FGSLEEPCNT1_FGSLEEPCNT_15_8_MASK	0xFF
#define FGSLEEPCNT1_FGSLEEPCNT_15_8_SHIFT	0x0

#define PMU_REG_FGSLEEPCNT2		ENC_PMU_REG(FIFO_MODE, MAP1, 0x4D)
#define FGSLEEPCNT2_FGSLEEPCNT_7_0_MASK		0xFF
#define FGSLEEPCNT2_FGSLEEPCNT_7_0_SHIFT	0x0


#define PMU_REG_FGSMPL1			ENC_PMU_REG(FIFO_MODE, MAP1, 0x4E)
#define FGSMPL1_FGSMPL_15_8_MASK	0xFF
#define FGSMPL1_FGSMPL_15_8_SHIFT	0x0

#define PMU_REG_FGSMPL2			ENC_PMU_REG(FIFO_MODE, MAP1, 0x4F)
#define FGSMPL2_FGSMPL_7_0_MASK		0xFF
#define FGSMPL2_FGSMPL_7_0_SHIFT	0x0

#define PMU_REG_FGSMPL3			ENC_PMU_REG(FIFO_MODE, MAP1, 0x50)
#define FGSMPL3_FGSMPL_CAL_15_8_MASK	0xFF
#define FGSMPL3_FGSMPL_CAL_15_8_SHIFT	0x0

#define PMU_REG_FGSMPL4			ENC_PMU_REG(FIFO_MODE, MAP1, 0x51)
#define FGSMPL4_FGSMPL_CAL_7_0_MASK	0xFF
#define FGSMPL4_FGSMPL_CAL_7_0_SHIFT	0x0

#define PMU_REG_FGSMPL5			ENC_PMU_REG(FIFO_MODE, MAP1, 0x52)
#define FGSMPL5_FGSMPLB_15_8_MASK	0xFF
#define FGSMPL5_FGSMPLB_15_8_SHIFT	0x0

#define PMU_REG_FGSMPL6			ENC_PMU_REG(FIFO_MODE, MAP1, 0x53)
#define FGSMPL6_FGSMPLB_7_0_MASK	0xFF
#define FGSMPL6_FGSMPLB_7_0SHIFT	0x0

#define PMU_REG_FGOFFSET1		ENC_PMU_REG(FIFO_MODE, MAP1, 0x54)
#define FGOFFSET1_FGOFFSET_15_8_MASK	0xFF
#define FGOFFSET1_FGOFFSET_15_8_SHIFT	0x0

#define PMU_REG_FGOFFSET2		ENC_PMU_REG(FIFO_MODE, MAP1, 0x55)
#define FGOFFSET2_FGOFFSET_7_0_MASK	0xFF
#define FGOFFSET2_FGOFFSET_7_0_SHIFT	0x0

#define PMU_REG_FGBATCAL1		ENC_PMU_REG(FIFO_MODE, MAP1, 0x56)
#define FGBATCAL1_FGVMBAT_9_8_MASK	0x3
#define FGBATCAL1_FGVMBAT_9_8_SHIFT	0x0

#define PMU_REG_FGBATCAL2		ENC_PMU_REG(FIFO_MODE, MAP1, 0x57)
#define FGBATCAL2_FGVMBAT_7_0_MASK	0x3
#define FGBATCAL2_FGVMBAT_7_0_SHIFT	0x0

#define PMU_REG_FGGNRL1			ENC_PMU_REG(FIFO_MODE, MAP1, 0x58)
#define FGGNRL1_7_0_MASK		0xFF
#define FGGNRL1_7_0_SHIFT		0x0

#define PMU_REG_FGGNRL2			ENC_PMU_REG(FIFO_MODE, MAP1, 0x59)
#define FGGNRL2_7_0_MASK		0xFF
#define FGGNRL2_7_0_SHIFT		0x0

#define PMU_REG_FGGNRL3			ENC_PMU_REG(FIFO_MODE, MAP1, 0x5A)
#define FGGNRL3_7_0_MASK		0xFF
#define FGGNRL3_7_0_SHIFT		0x0

#define PMU_REG_FGTRIMGN1_1		ENC_PMU_REG(FIFO_MODE, MAP1, 0x5B)
#define FGTRIMGN1_1_FGPOINT1_13_8_MASK		0x3F
#define FGTRIMGN1_1_FGPOINT1_13_8_SHIFT		0x0

#define PMU_REG_FGTRIMGN1_2		ENC_PMU_REG(FIFO_MODE, MAP1, 0x5C)
#define FGTRIMGN1_2_FGPOINT1_7_0_MASK		0xFF
#define FGTRIMGN1_2_FGPOINT1_7_0_SHIFT		0x0

#define PMU_REG_FGTRIMGN2_1		ENC_PMU_REG(FIFO_MODE, MAP1, 0x5D)
#define FGTRIMGN2_1_FGPOINT2_13_8_MASK		0x3F
#define FGTRIMGN2_1_FGPOINT2_13_8_SHIFT		0x0

#define PMU_REG_FGTRIMGN2_2		ENC_PMU_REG(FIFO_MODE, MAP1, 0x5E)
#define FGTRIMGN2_1_FGPOINT2_7_0_MASK		0xFF
#define FGTRIMGN2_1_FGPOINT2_7_0_SHIFT		0x0
