...
#define BRVSENS_EVENT_NUM   64     // max number of events that can be returned from single read
...
// Sensor Handle Enumeration; Each handle has different bit set, which allows us
// to send board configuration as bitmask. Bit mapping matches Android Sensor Type
...
int brvsens_register(u32 handle, const char* name, void* context, PFNACTIVATE actCbk, PFNREAD readCbk);
