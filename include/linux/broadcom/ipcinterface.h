...
#define AP_CP_SEMAPHORE_BUS_PROFILING         1
#define AP_CP_SEMAPHORE_INTERACTIVE_PROFILING 2
#define AP_CP_SEMAPHORE_HTM_PROFILING         3
/* overall number of AP/CP semaphotes */
#define AP_CP_SEMAPHORES_NUM                  4
