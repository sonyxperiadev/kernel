...
enum v4l2_subdev_sensor_orient {
	V4L2_SUBDEV_SENSOR_PORTRAIT = 0,
	V4L2_SUBDEV_SENSOR_LANDSCAPE = 1,
	V4L2_SUBDEV_SENSOR_ORIENT_0 = V4L2_SUBDEV_SENSOR_PORTRAIT,
	V4L2_SUBDEV_SENSOR_ORIENT_90 = V4L2_SUBDEV_SENSOR_LANDSCAPE,
	V4L2_SUBDEV_SENSOR_ORIENT_180 = 2,
	V4L2_SUBDEV_SENSOR_ORIENT_270 = 3,
};
