...
void ath10k_debug_print_hwfw_info(struct ath10k *ar)
{
	...
	ath10k_info(ar, "kconfig debug %d debugfs %d tracing %d dfs %d testmode %d\n",
		    IS_ENABLED(CONFIG_BACKPORT_ATH10K_DEBUG),
		    IS_ENABLED(CONFIG_BACKPORT_ATH10K_DEBUGFS),
		    IS_ENABLED(CONFIG_BACKPORT_ATH10K_TRACING),
		    IS_ENABLED(CONFIG_BACKPORT_ATH10K_DFS_CERTIFIED),
		    IS_ENABLED(CONFIG_BACKPORT_NL80211_TESTMODE));
...
int ath10k_debug_register(struct ath10k *ar)
{
	...
	if (IS_ENABLED(CONFIG_BACKPORT_ATH10K_DFS_CERTIFIED)) {
	...
	if (IS_ENABLED(CONFIG_BACKPORT_MAC80211_DEBUGFS))
