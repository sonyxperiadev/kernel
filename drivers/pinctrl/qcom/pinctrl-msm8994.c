...
static const char * const blsp_i2c5_groups[] = { "gpio83", "gpio84" };
...
static const char * const blsp_i2c6_groups[] = { "gpio27", "gpio28" };
...
static const char * const mdp_vsync_groups[] = { "gpio10", "gpio11", "gpio12" };
...
static const char * const fm_groups[] = { "gpio9", "gpio11" };
...
static const char * const pci_e0_groups[] = { "gpio53", "gpio54" };
static const char * const pci_e1_groups[] = { "gpio35", "gpio36", "gpio37"};

static const char * const tsif1_sync_groups[] = { "gpio110" };
static const char * const tsif1_clk_groups[] = { "gpio89" };
static const char * const tsif1_en_groups[] = { "gpio90" };
static const char * const tsif1_data_groups[] = { "gpio91" };
static const char * const tsif1_error_groups[] = { "gpio92" };

static const char * const tsif2_clk_groups[] = { "gpio93" };
static const char * const tsif2_en_groups[] = { "gpio94" };
static const char * const tsif2_data_groups[] = { "gpio95" };
static const char * const tsif2_sync_groups[] = { "gpio96" };

/* QDSS */
static const char * const qdss_cti_trig_out_a_groups[] = { "gpio56" };
static const char * const qdss_cti_trig_out_c_groups[] = { "gpio41" };
static const char * const qdss_tracectl_a_groups[] = { "gpio27" };
static const char * const qdss_tracectl_b_groups[] = { "gpio94" };
...
static const char * const qdss_tracedata_b_groups[] = {
	...
	"gpio21", "gpio22", "gpio23", "gpio25", "gpio26", "gpio57", "gpio58",
	"gpio91", "gpio92", "gpio93",
};
...
static const struct msm_pingroup msm8994_groups[] = {
	...
	PINGROUP(9,   blsp_spi3, blsp_uart3, blsp_uim3, blsp_spi1_cs2, fm, NA, NA),
	PINGROUP(10,  blsp_spi3, blsp_uart3, blsp_i2c3, blsp_spi1_cs3, mdp_vsync, NA, NA),
	PINGROUP(11,  blsp_spi3, blsp_uart3, blsp_i2c3, blsp_spi1_cs2, mdp_vsync, fm, NA),
	PINGROUP(12,  NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(13,  cam_mclk, qdss_tracedata_b, NA, NA, NA, NA, NA),
	PINGROUP(14,  cam_mclk, qdss_tracedata_b, NA, NA, NA, NA, NA),
	PINGROUP(15,  cam_mclk, qdss_tracedata_b, NA, NA, NA, NA, NA),
	PINGROUP(16,  cam_mclk, qdss_tracedata_b, NA, NA, NA, NA, NA),
	PINGROUP(17,  cci_i2c, qdss_tracedata_b, NA, NA, NA, NA, NA),
	PINGROUP(18,  cci_i2c, qdss_tracedata_b, NA, NA, NA, NA, NA),
	PINGROUP(19,  cci_i2c, blsp_spi4, blsp_uart4, blsp_uim4, qdss_tracedata_b, NA, NA),
	PINGROUP(20,  cci_i2c, blsp_spi4, blsp_uart4, blsp_uim4, NA, NA, NA),
	PINGROUP(21,  blsp_spi4, blsp_uart4, blsp_i2c4, qdss_tracedata_b, NA, NA, NA),
	PINGROUP(22,  blsp_spi4, blsp_uart4, blsp_i2c4, qdss_tracedata_b, NA, NA, NA),
	PINGROUP(23,  cci_timer0, blsp_spi5, blsp_uart5, blsp_uim5, qdss_tracedata_b, NA, NA),
	PINGROUP(24,  cci_timer1, blsp_spi5, blsp_uart5, blsp_uim5, NA, NA, NA),
	PINGROUP(25,  cci_timer2, blsp_spi5, blsp_uart5, qdss_tracedata_b, NA, NA, NA),
	PINGROUP(26,  cci_timer3, cci_async_in1, blsp_spi5, blsp_uart5, gp0_clk, qdss_tracedata_b, NA),
	PINGROUP(27,  cci_timer4, cci_async_in2, blsp_spi6, blsp_uart6, blsp_i2c6, gp1_clk, qdss_tracectl_a),
	PINGROUP(28,  cci_async_in0, blsp_spi6, blsp_uart6, blsp_uim6, blsp_i2c6, NA, NA),
	PINGROUP(29,  blsp_spi6, blsp_uart6, NA, gp_mn, NA, NA, NA),
	PINGROUP(30,  blsp_spi6, blsp_uart6, NA, NA, NA, NA, NA),
	...
	PINGROUP(35,  bt, sdc3, pci_e1, NA, NA, NA, NA),
	PINGROUP(36,  wlan, sdc3, pci_e1, NA, NA, NA, NA),
	PINGROUP(37,  wlan, sdc3, pci_e1, NA, NA, NA, NA),
	PINGROUP(38,  wlan, sdc3, NA, NA, NA, NA, NA),
	PINGROUP(39,  wlan, sdc3, NA, NA, NA, NA, NA),
	PINGROUP(40,  wlan, sdc3, NA, NA, NA, NA, NA),
	PINGROUP(41,  blsp_spi7, blsp_uart7, blsp_uim7, qdss_cti_trig_out_c, NA, NA, NA),
	PINGROUP(42,  blsp_spi7, blsp_uart7, blsp_uim7, NA, NA, NA, NA),
	...
	PINGROUP(53,  blsp_spi10, blsp_uart10, blsp_uim10, blsp_spi2_cs1, pci_e0, qdss_tracedata_a, NA),
	PINGROUP(54,  blsp_spi10, blsp_uart10, blsp_uim10, blsp_spi2_cs2, gp_pdm0, pci_e0, qdss_tracedata_a),
	PINGROUP(55,  blsp_spi10, blsp_uart10, blsp_i2c10, NA, NA, NA, NA),
	PINGROUP(56,  blsp_spi10, blsp_uart10, blsp_i2c10, qdss_cti_trig_out_a, NA, NA, NA),
	PINGROUP(57,  qua_mi2s, gcc_gp_clk1, qdss_tracedata_b, NA, NA, NA, NA),
	PINGROUP(58,  qua_mi2s, gcc_gp_clk2, qdss_tracedata_b, NA, NA, NA, NA),
	...
	PINGROUP(63,  qua_mi2s, blsp_spi2_cs2, gp_pdm2, qdss_tracedata_a, NA, NA, NA),
	PINGROUP(64,  pri_mi2s, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(65,  pri_mi2s, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(66,  pri_mi2s, blsp_spi2_cs3, qdss_tracedata_a, NA, NA, NA, NA),
	PINGROUP(67,  pri_mi2s, blsp_spi10_cs1, qdss_tracedata_a, NA, NA, NA, NA),
	...
	PINGROUP(74,  ter_mi2s, gp_pdm1, qdss_tracedata_a, NA, NA, NA, NA),
	PINGROUP(75,  ter_mi2s, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(76,  ter_mi2s, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(77,  ter_mi2s, qdss_tracedata_a, NA, NA, NA, NA, NA),
	...
	PINGROUP(83,  blsp_spi11, blsp_uart11, blsp_i2c11, blsp_i2c5, NA, NA, NA),
	PINGROUP(84,  blsp_spi11, blsp_uart11, blsp_i2c11, blsp_i2c5, NA, NA, NA),
	PINGROUP(85,  blsp_spi12, blsp_uart12, blsp_uim12, qdss_tracedata_a, NA, NA, NA),
	PINGROUP(86,  blsp_spi12, blsp_uart12, blsp_uim12, gp_pdm1, qdss_tracedata_a, NA, NA),
	PINGROUP(87,  blsp_spi12, blsp_uart12, blsp_i2c12, qdss_tracedata_a, NA, NA, NA),
	PINGROUP(88,  blsp_spi12, blsp_uart12, blsp_i2c12, NA, NA, NA, NA),
	PINGROUP(89,  tsif1_clk, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(90,  tsif1_en, blsp_spi10_cs3, qdss_tracedata_a, NA, NA, NA, NA),
	PINGROUP(91,  tsif1_data, sdc4, qdss_tracedata_b, NA, NA, NA, NA),
	PINGROUP(92,  tsif1_error, sdc4, qdss_tracedata_b, NA, NA, NA, NA),
	PINGROUP(93,  tsif2_clk, sdc4, qdss_tracedata_b, NA, NA, NA, NA),
	PINGROUP(94,  tsif2_en, sdc4, qdss_tracectl_b, NA, NA, NA, NA),
	PINGROUP(95,  tsif2_data, sdc4, NA, NA, NA, NA, NA),
	PINGROUP(96,  tsif2_sync, sdc4, NA, NA, NA, NA, NA),
