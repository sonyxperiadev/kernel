...
static const struct pinctrl_pin_desc waipio_pins[] = {
...
static const struct pinfunction waipio_functions[] = {
	...
	MSM_PIN_FUNCTION(nav_0),
	MSM_PIN_FUNCTION(nav_1),
	MSM_PIN_FUNCTION(nav_2),
 ...
 */
static const struct msm_pingroup waipio_groups[] = {
	[0] = PINGROUP(0, qup0, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[1] = PINGROUP(1, qup0, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[2] = PINGROUP(2, qup0, qdss_cti, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 0),
	[3] = PINGROUP(3, qup0, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 1),
	[4] = PINGROUP(4, qup1, phase_flag31, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[5] = PINGROUP(5, qup1, phase_flag30, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[6] = PINGROUP(6, qup1, phase_flag29, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[7] = PINGROUP(7, qup1, phase_flag28, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 2),
	[8] = PINGROUP(8, qup2, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 3),
	[9] = PINGROUP(9, qup2, dbg_out, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[10] = PINGROUP(10, qup2, phase_flag25, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 4),
	[11] = PINGROUP(11, qup2, phase_flag24, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 5),
	[12] = PINGROUP(12, qup3, phase_flag23, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 6),
	[13] = PINGROUP(13, qup3, phase_flag22, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 7),
	[14] = PINGROUP(14, qup3, phase_flag21, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 8),
	[15] = PINGROUP(15, qup3, phase_flag20, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 9),
	[16] = PINGROUP(16, qup4, phase_flag19, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[17] = PINGROUP(17, qup4, phase_flag18, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[18] = PINGROUP(18, qup4, phase_flag27, NA, vsense_trigger, NA, NA, NA,
			NA, NA, 0, -1),
	[19] = PINGROUP(19, qup4, phase_flag26, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 10),
	...
	[24] = PINGROUP(24, qup7, qup_l4, jitter_bist, NA, NA, NA, NA, NA, NA, 0, -1),
	[25] = PINGROUP(25, qup7, qup_l5, phase_flag17, NA, NA, NA, NA, NA, NA, 0, -1),
	[26] = PINGROUP(26, qup7, qup_l6, phase_flag16, NA, NA, NA, NA, NA, NA, 0xD2000, 13),
	[27] = PINGROUP(27, qup7, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 14),
	[28] = PINGROUP(28, qup8, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 0),
	...
	[32] = PINGROUP(32, qup9, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 2),
	...
	[36] = PINGROUP(36, qup10, ddr_bist, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 5),
	[37] = PINGROUP(37, qup10, ddr_bist, atest_usb0, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[38] = PINGROUP(38, qup10, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 6),
	[39] = PINGROUP(39, qup10, atest_usb02, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 7),
	...
	[43] = PINGROUP(43, qup11, ddr_pxi3, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 10),
	[44] = PINGROUP(44, qup12, ddr_pxi3, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 11),
	[45] = PINGROUP(45, qup12, ddr_pxi2, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 12),
	[46] = PINGROUP(46, qup12, mdp_vsync, NA, NA, NA, NA, NA, NA, NA, 0xD2014, 13),
	...
	[50] = PINGROUP(50, qup13, qspi_clk, sdc4_clk, NA, NA, NA, NA, NA, NA, 0xD2014, 15),
	[51] = PINGROUP(51, qup13, qspi_cs, sdc4_cmd, ddr_pxi0, NA, NA, NA, NA,
			NA, 0xD2018, 0),
	[52] = PINGROUP(52, qup14, qspi0, sdc40, ddr_pxi0, NA, NA, NA, NA, NA, 0, -1),
	[53] = PINGROUP(53, qup14, qspi1, sdc41, NA, NA, NA, NA, NA, NA, 0, -1),
	[54] = PINGROUP(54, qup14, qspi_cs, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[55] = PINGROUP(55, qup14, atest_usb03, NA, NA, NA, NA, NA, NA, NA, 0xD2018, 1),
	[56] = PINGROUP(56, qup15, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, 0xD200C, 3),
	[57] = PINGROUP(57, qup15, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[58] = PINGROUP(58, qup15, qup_l4, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[59] = PINGROUP(59, qup15, qup_l5, NA, NA, NA, NA, NA, NA, NA, 0xD200C, 4),
	[60] = PINGROUP(60, qup16, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, 0xD200C, 5),
	[61] = PINGROUP(61, qup16, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[62] = PINGROUP(62, qup16, qup_l6, NA, NA, NA, NA, NA, NA, NA, 0xD200C, 6),
	[63] = PINGROUP(63, qup16, qup_l4, NA, NA, NA, NA, NA, NA, NA, 0xD200C, 7),
	[64] = PINGROUP(64, qup17, tb_trig, tgu_ch0, NA, NA, NA, NA, NA, NA, 0, -1),
	[65] = PINGROUP(65, qup17, tgu_ch1, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[66] = PINGROUP(66, qup17, qup_l5, tgu_ch2, NA, NA, NA, NA, NA, NA, 0xD200C, 8),
	[67] = PINGROUP(67, qup17, qup_l6, tgu_ch3, NA, NA, NA, NA, NA, NA, 0xD200C, 9),
	...
	[71] = PINGROUP(71, qup18, cri_trng0, NA, NA, NA, NA, NA, NA, NA, 0xD200C, 11),
	[72] = PINGROUP(72, qup19, cri_trng1, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[73] = PINGROUP(73, qup19, prng_rosc0, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[74] = PINGROUP(74, qup19, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[75] = PINGROUP(75, qup19, prng_rosc1, NA, NA, NA, NA, NA, NA, NA, 0xD200C, 12),
	[76] = PINGROUP(76, qup20, phase_flag15, tmess_prng3, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[77] = PINGROUP(77, qup20, phase_flag14, tmess_prng2, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[78] = PINGROUP(78, qup20, phase_flag5, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[83] = PINGROUP(83, qup21, qdss_cti, phase_flag0, prng_rosc2, NA, NA,
			NA, NA, NA, 0xD2010, 1),
	[84] = PINGROUP(84, qup5, qdss_cti, NA, NA, NA, NA, NA, NA, NA, 0xD2004, 0),
	[85] = PINGROUP(85, qup5, qdss_cti, NA, NA, NA, NA, NA, NA, NA, 0xD2004, 1),
	...
	[88] = PINGROUP(88, mdp_vsync, gcc_gp3, atest_char2, NA, NA, NA, NA,
			NA, NA, 0xD2018, 4),
	[89] = PINGROUP(89, vfr_0, atest_char1, NA, NA, NA, NA, NA, NA, NA, 0xD2018, 5),
	[90] = PINGROUP(90, usb2phy_ac, atest_char0, NA, NA, NA, NA, NA, NA,
			NA, 0xD2018, 6),
	[91] = PINGROUP(91, usb_phy, tsense_pwm1, tsense_pwm2, NA, NA, NA, NA,
			NA, NA, 0xD2018, 7),
	[92] = PINGROUP(92, phase_flag11, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2010, 2),
	[93] = PINGROUP(93, sd_write, qdss_cti, phase_flag10, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[94] = PINGROUP(94, cmu_rng3, phase_flag9, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[95] = PINGROUP(95, pcie0_clkreqn, cmu_rng2, phase_flag8, NA, NA, NA,
			NA, NA, NA, 0xD2010, 3),
	[96] = PINGROUP(96, cmu_rng1, phase_flag7, NA, NA, NA, NA, NA, NA, NA, 0xD2010, 4),
	[97] = PINGROUP(97, cmu_rng0, phase_flag6, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[98] = PINGROUP(98, pcie1_clkreqn, phase_flag13, NA, NA, NA, NA, NA,
			NA, NA, 0xD2010, 5),
	[99] = PINGROUP(99, phase_flag12, cri_trng, NA, NA, NA, NA, NA, NA, NA, 0xD2010, 6),
	[100] = PINGROUP(100, cam_mclk, qdss_gpio0, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[101] = PINGROUP(101, cam_mclk, qdss_gpio1, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[102] = PINGROUP(102, cam_mclk, qdss_gpio2, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[103] = PINGROUP(103, cam_mclk, qdss_gpio3, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[104] = PINGROUP(104, cam_mclk, qdss_gpio4, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[105] = PINGROUP(105, cam_mclk, qdss_gpio5, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[110] = PINGROUP(110, cci_i2c, qdss_gpio7, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[111] = PINGROUP(111, cci_i2c, qdss_gpio8, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[112] = PINGROUP(112, cci_i2c, qdss_gpio, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[113] = PINGROUP(113, cci_i2c, qdss_gpio, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[114] = PINGROUP(114, cci_i2c, qdss_gpio9, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[115] = PINGROUP(115, cci_i2c, qdss_gpio10, NA, NA, NA, NA, NA, NA, NA, 0xD2010, 7),
	[116] = PINGROUP(116, cci_timer0, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2010, 8),
	...
	[122] = PINGROUP(122, mi2s2_data0, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[127] = PINGROUP(127, mi2s0_data0, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[128] = PINGROUP(128, mi2s0_data1, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[132] = PINGROUP(132, uim0_reset, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[133] = PINGROUP(133, uim0_present, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2010, 12),
	[134] = PINGROUP(134, uim1_data, gcc_gp1, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[135] = PINGROUP(135, uim1_clk, gcc_gp2, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[136] = PINGROUP(136, uim1_reset, gcc_gp3, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[151] = PINGROUP(151, coex_uart2, mss_grfc11, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[152] = PINGROUP(152, mss_grfc12, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[153] = PINGROUP(153, mss_grfc0, nav_2, NA, NA, NA, NA, NA, NA, NA, 0xD2018, 10),
	[154] = PINGROUP(154, nav_0, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2018, 11),
	[155] = PINGROUP(155, nav_1, vfr_1, NA, NA, NA, NA, NA, NA, NA, 0xD2018, 12),
	[156] = PINGROUP(156, qlink0_request, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2018, 13),
	[157] = PINGROUP(157, qlink0_enable, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[158] = PINGROUP(158, qlink0_wmss, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[159] = PINGROUP(159, qlink1_request, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2018, 14),
	[160] = PINGROUP(160, qlink1_enable, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[161] = PINGROUP(161, qlink1_wmss, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[162] = PINGROUP(162, qlink2_request, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2018, 15),
	[163] = PINGROUP(163, qlink2_enable, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[164] = PINGROUP(164, qlink2_wmss, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[165] = PINGROUP(165, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[166] = PINGROUP(166, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 2),
	[167] = PINGROUP(167, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[168] = PINGROUP(168, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[169] = PINGROUP(169, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 3),
	[170] = PINGROUP(170, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[171] = PINGROUP(171, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 4),
	[172] = PINGROUP(172, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 5),
	[173] = PINGROUP(173, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[174] = PINGROUP(174, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 6),
	[175] = PINGROUP(175, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[176] = PINGROUP(176, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 7),
	[177] = PINGROUP(177, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 8),
	[178] = PINGROUP(178, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[179] = PINGROUP(179, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[180] = PINGROUP(180, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[181] = PINGROUP(181, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 9),
	[182] = PINGROUP(182, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 10),
	[183] = PINGROUP(183, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[184] = PINGROUP(184, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[185] = PINGROUP(185, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 11),
	[186] = PINGROUP(186, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[187] = PINGROUP(187, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 12),
	[188] = PINGROUP(188, NA, qdss_gpio0, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 13),
	[189] = PINGROUP(189, NA, qdss_gpio1, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[190] = PINGROUP(190, qdss_gpio2, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 14),
	[191] = PINGROUP(191, qdss_gpio3, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[192] = PINGROUP(192, NA, qdss_gpio4, NA, NA, NA, NA, NA, NA, egpio, 0xD2004, 15),
	[193] = PINGROUP(193, NA, qdss_gpio5, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[194] = PINGROUP(194, NA, qdss_gpio6, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[195] = PINGROUP(195, NA, qdss_gpio7, NA, NA, NA, NA, NA, NA, egpio, 0xD2008, 0),
	[196] = PINGROUP(196, NA, qdss_gpio, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[197] = PINGROUP(197, NA, qdss_gpio, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[198] = PINGROUP(198, NA, qdss_gpio8, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[199] = PINGROUP(199, NA, qdss_gpio9, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[200] = PINGROUP(200, NA, qdss_gpio10, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[201] = PINGROUP(201, NA, qdss_gpio11, NA, NA, NA, NA, NA, NA, egpio, 0xD2008, 1),
	[202] = PINGROUP(202, qdss_gpio12, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[203] = PINGROUP(203, qdss_gpio13, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2008, 2),
	[204] = PINGROUP(204, qdss_gpio14, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[205] = PINGROUP(205, qdss_gpio15, NA, NA, NA, NA, NA, NA, NA, egpio, 0xD2008, 3),
	[206] = PINGROUP(206, qup5, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[207] = PINGROUP(207, qup5, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[208] = PINGROUP(208, cci_i2c, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[209] = PINGROUP(209, cci_i2c, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
