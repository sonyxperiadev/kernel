...
static struct qcom_icc_node qsm_cfg = {
	...
	.links = { SLAVE_AHB2PHY_SOUTH, SLAVE_AHB2PHY_NORTH,
		   ...
		   SLAVE_RBCPR_CX_CFG, SLAVE_CPR_HMX,
		   ...
		   SLAVE_PCIE_1_CFG, SLAVE_PCIE_RSCC,
		   SLAVE_PDM, SLAVE_PRNG,
		   SLAVE_QDSS_CFG, SLAVE_QSPI_0,
		   SLAVE_QUP_3, SLAVE_QUP_1,
		   ...
		   SLAVE_CNOC_MNOC_CFG, SLAVE_NSP_QTB_CFG,
		   SLAVE_PCIE_ANOC_CFG, SLAVE_SERVICE_CNOC_CFG,
...
static struct qcom_icc_node qnm_gemnoc_cnoc = {
	...
	.links = { SLAVE_AOSS, SLAVE_IPA_CFG,
		   SLAVE_IPC_ROUTER_CFG, SLAVE_TME_CFG,
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	if (ret)
		...
		dev_info(&pdev->dev, "Registered Pineapple ICC provider\n");
...
MODULE_DESCRIPTION("Pineapple NoC driver");
MODULE_LICENSE("GPL");
