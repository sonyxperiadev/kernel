...
static struct qcom_icc_node qnm_cnoc2_cnoc3 = {
	...
	.links = { SLAVE_AOSS, SLAVE_APPSS,
		   SLAVE_CDSP_CFG, SLAVE_QDSS_CFG,
		   SLAVE_TME_CFG, SLAVE_WLAN,
		   SLAVE_CNOC_A2NOC, SLAVE_BOOT_IMEM,
...
static struct qcom_icc_node qnm_gemnoc_cnoc = {
	...
	.links = { SLAVE_AOSS, SLAVE_APPSS,
		   SLAVE_CDSP_CFG, SLAVE_QDSS_CFG,
		   SLAVE_TME_CFG, SLAVE_WLAN,
		   SLAVE_CNOC3_CNOC2, SLAVE_BOOT_IMEM,
		   SLAVE_IMEM, SLAVE_PIMEM,
		   SLAVE_QDSS_STM, SLAVE_TCU },
};
...
static struct qcom_icc_desc parrot_aggre1_noc = {
...
static struct qcom_icc_desc parrot_aggre2_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc parrot_clk_virt = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc parrot_cnoc2 = {
	.config = &icc_regmap_config,
	.nodes = cnoc2_nodes,
...
static struct qcom_icc_desc parrot_cnoc3 = {
	.config = &icc_regmap_config,
	.nodes = cnoc3_nodes,
...
static struct qcom_icc_desc parrot_gem_noc = {
	.config = &icc_regmap_config,
	.nodes = gem_noc_nodes,
...
static struct qcom_icc_desc parrot_lpass_ag_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc parrot_mc_virt = {
	.config = &icc_regmap_config,
	.nodes = mc_virt_nodes,
...
static struct qcom_icc_desc parrot_mmss_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc parrot_nsp_noc = {
	.config = &icc_regmap_config,
	.nodes = nsp_noc_nodes,
...
static struct qcom_icc_desc parrot_pcie_anoc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc parrot_system_noc = {
	.config = &icc_regmap_config,
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	if (ret)
		...
		dev_info(&pdev->dev, "Registered PARROT ICC\n");
...
static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,parrot-aggre1_noc",
	  .data = &parrot_aggre1_noc},
	{ .compatible = "qcom,parrot-aggre2_noc",
	  .data = &parrot_aggre2_noc},
	{ .compatible = "qcom,parrot-clk_virt",
	  .data = &parrot_clk_virt},
