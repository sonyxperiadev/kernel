...
static void csl_caph_cfifo_fifo_init(void)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_fifo_init:: \n");
	...
	xassert(total_fifo_size <= 0x2000, total_fifo_size);
...
{
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_init:: \n");
...
{
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_deinit:: \n");
                                                ...
                                                CSL_CAPH_CFIFO_SAMPLERATE_e sampleRate)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_obtain_fifo:: \n");
...
{
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_get_fifo_thres:: \n");
...
void csl_caph_cfifo_release_fifo(CSL_CAPH_CFIFO_FIFO_e fifo)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_release_fifo:: \n");
                                ...
                                UInt16 threshold)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_config_fifo:: \n");
...
UInt32 csl_caph_cfifo_get_fifo_addr(CSL_CAPH_CFIFO_FIFO_e csl_fifo)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_get_fifo_addr:: \n");
...
void csl_caph_cfifo_start_fifo(CSL_CAPH_CFIFO_FIFO_e csl_fifo)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_start_fifo:: \n");
...
void csl_caph_cfifo_stop_fifo(CSL_CAPH_CFIFO_FIFO_e csl_fifo)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_stop_fifo:: \n");
