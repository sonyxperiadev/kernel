...
#define OUTCHNL_MAX_NUM_CHNL 0x4
...
static CAPH_SRCMixer_OUTPUT_e csl_caph_srcmixer_get_chaloutchnl(
...
/****************************************************************************
*
*  Function Name: CAPH_SRCMixer_CHNL_e csl_caph_srcmixer_get_chal_inchnl(
*                                                  CSL_CAPH_SRCM_INCHNL_e inChnl)
*
*  Description: Get the cHAL Mixer Input Channel
*
****************************************************************************/
...
static CAPH_SRCMixer_OUTPUT_e csl_caph_srcmixer_get_chaloutchnl(
                                                   CSL_CAPH_SRCM_MIX_OUTCHNL_e outChnl)
{
    CAPH_SRCMixer_OUTPUT_e chalOutChnl = CAPH_M_NONE; 
    switch (outChnl)
    {
        case CSL_CAPH_SRCM_STEREO_CH1_L:
...
{
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_srcmixer_init:: \n");
...
{
    UInt8 ch;
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_srcmixer_deinit:: \n");
                              ...
                              CSL_CAPH_SRCM_INSAMPLERATE_e sampleRate)    
{
    ...
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_srcmixer_obtain_inchnl:: \n");
    Log_DebugPrintf(LOGID_SOC_AUDIO, 
...
void csl_caph_srcmixer_config_mix_route(CSL_CAPH_SRCM_ROUTE_t routeConfig)
{
    ...
    CAPH_SRCMixer_OUTPUT_e chalOutChnl = CAPH_M_NONE;
    UInt8 ch = 0;
    CSL_CAPH_SRCM_INCHNL_e chnl = CSL_CAPH_SRCM_INCHNL_NONE;
    ...
    chalInChnl = csl_caph_srcmixer_get_chal_inchnl(routeConfig.inChnl);
    ...
    {
        chnl = (CSL_CAPH_SRCM_INCHNL_e)(inChnls>>(MAX_SINGLE_INCHNLS-1));
        if (chnl)
        {
            chalInChnl = csl_caph_srcmixer_get_chal_inchnl((CSL_CAPH_SRCM_INCHNL_e)chnl);
            chal_caph_srcmixer_set_mixingain(handle, chalInChnl, chalOutChnl, 0x0000);
        }
	else
	{}
    }

    // these are for fpga test only.
#if 0    
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_CH4,CAPH_M0_Left,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_CH4,CAPH_M0_Right,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_CH4,CAPH_M1_Left,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_CH4,CAPH_M1_Right,0x3fff);

	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_CH4,CAPH_M0_Left,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_CH4,CAPH_M0_Right,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_CH4,CAPH_M1_Left,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_CH4,CAPH_M1_Right,0x7fff);

	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_PASSCH1,CAPH_M0_Left,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_PASSCH1,CAPH_M0_Right,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_PASSCH1,CAPH_M1_Left,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_PASSCH1,CAPH_M1_Right,0x3fff);

	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_PASSCH1,CAPH_M0_Left,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_PASSCH1,CAPH_M0_Right,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_PASSCH1,CAPH_M1_Left,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_PASSCH1,CAPH_M1_Right,0x7fff);

	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_PASSCH2,CAPH_M0_Left,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_PASSCH2,CAPH_M0_Right,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_PASSCH2,CAPH_M1_Left,0x3fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_PASSCH2,CAPH_M1_Right,0x3fff);

	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_PASSCH2,CAPH_M0_Left,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_PASSCH2,CAPH_M0_Right,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_PASSCH2,CAPH_M1_Left,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_PASSCH2,CAPH_M1_Right,0x7fff);

	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_CH5,CAPH_M0_Left,0x1fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_CH5,CAPH_M0_Right,0x1fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_CH5,CAPH_M1_Left,0x1fff);
	chal_caph_srcmixer_set_mixingain(handle,CAPH_SRCM_CH5,CAPH_M1_Right,0x1fff);

	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_CH5,CAPH_M0_Left,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_CH5,CAPH_M0_Right,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_CH5,CAPH_M1_Left,0x7fff);
	chal_caph_srcmixer_set_mixingainstep(handle,CAPH_SRCM_CH5,CAPH_M1_Right,0x7fff);
#endif	
...
#if 0
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_CH4,CAPH_M0_Left );
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_CH4,CAPH_M0_Right);
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_CH4,CAPH_M1_Left );
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_CH4,CAPH_M1_Right);

	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_PASSCH1,CAPH_M0_Left );
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_PASSCH1,CAPH_M0_Right);
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_PASSCH1,CAPH_M1_Left );
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_PASSCH1,CAPH_M1_Right);

	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_PASSCH2,CAPH_M0_Left );
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_PASSCH2,CAPH_M0_Right);
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_PASSCH2,CAPH_M1_Left );
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_PASSCH2,CAPH_M1_Right);
	
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_CH5,CAPH_M0_Left );
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_CH5,CAPH_M0_Right);
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_CH5,CAPH_M1_Left );
	chal_caph_srcmixer_enable_mixing(handle,CAPH_SRCM_CH5,CAPH_M1_Right);
#endif	
	return;
}
...
void csl_caph_srcmixer_config_src_route(CSL_CAPH_SRCM_ROUTE_t routeConfig)
{
    ...
    {
        xassert(0, ((routeConfig.inSampleRate)||((routeConfig.outSampleRate)<<16)));
    }
                                    ...
                                    UInt16 gainL, UInt16 gainR)    
{
    ...
    /* Map CSL SRCM input channel to cHAL SRC Input channel */
    chalInChnl = csl_caph_srcmixer_get_chal_inchnl(inChnl);
    /* get the cHAL output channel from CSL output channel */
    ...
    switch (chalInChnl)
    {
        ...
        case CAPH_SRCM_PASSCH2_R:
            chal_caph_srcmixer_set_mixingain(handle, chalInChnl, chalOutChnl, gainL);
            break;
                                     ...
                                     UInt16 gain)
{
    ...
    chal_caph_srcmixer_set_spkrgain(handle, chalOutChnl, gain);
