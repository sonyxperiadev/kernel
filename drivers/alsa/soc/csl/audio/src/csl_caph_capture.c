...
UInt32 csl_audio_capture_init(CSL_AUDIO_DEVICE_e source, CSL_AUDIO_DEVICE_e sink)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_audio_capture_init::source=0x%x sink=0x%x.\n", source, sink);
...
Result_t csl_audio_capture_deinit(UInt32 streamID)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_audio_capture_deinit::dmaCH=0x%x, dmaCH2-0x%x\n", 
						...
						UInt32 streamID )
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_audio_capture_configure::\n");
...
Result_t csl_audio_capture_start (UInt32 streamID)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_audio_capture_start::streamID=0x%x\n", streamID);
...
Result_t csl_audio_capture_stop (UInt32 streamID)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_audio_capture_stop::streamID=0x%x\n", streamID);
...
Result_t csl_audio_capture_pause (UInt32 streamID)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_audio_capture_pause::streamID=0x%x\n", streamID);
...
Result_t csl_audio_capture_resume (UInt32 streamID)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_audio_capture_resume::streamID=0x%x\n", streamID);
