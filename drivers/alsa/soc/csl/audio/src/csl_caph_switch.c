...
{
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_init:: \n");
...
{
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_deinit:: \n");
...
CSL_CAPH_SWITCH_CHNL_e csl_caph_switch_obtain_channel(void)    
{
    ...
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_obtain_channel:: \n");
...
/****************************************************************************
*
*  Function Name: void csl_caph_switch_release_channel(CSL_CAPH_SWITCH_CHNL_e chnl)
*
...
void csl_caph_switch_release_channel(CSL_CAPH_SWITCH_CHNL_e chnl)    
{
    ...
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_release_channel:: \n");
...
void csl_caph_switch_config_channel(CSL_CAPH_SWITCH_CONFIG_t chnl_config)    
{
    ...
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_config_channel:: \n");
	Log_DebugPrintf(LOGID_SOC_AUDIO, 
...
Result_t csl_caph_switch_add_dst(CSL_CAPH_SWITCH_CHNL_e chnl, UInt32 FIFO_dstAddr)
{
    ...
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_add_dst:: \n");
	Log_DebugPrintf(LOGID_SOC_AUDIO, 
    ...
    {
    	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_add_dst:: FAIL\n");
        return RESULT_ERROR;
    }
...
void csl_caph_switch_remove_dst(CSL_CAPH_SWITCH_CHNL_e chnl, UInt32 FIFO_dstAddr)
{
    ...
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_remove_dst:: \n");
	Log_DebugPrintf(LOGID_SOC_AUDIO, 
...
void csl_caph_switch_start_transfer(CSL_CAPH_SWITCH_CHNL_e chnl)
{
    ...
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_start_transfer:: \n");
	Log_DebugPrintf(LOGID_SOC_AUDIO, 
...
/****************************************************************************
*
*  Function Name: void csl_caph_switch_stop_transfer(CSL_CAPH_SWITCH_CHNL_e chnl)
*
...
void csl_caph_switch_stop_transfer(CSL_CAPH_SWITCH_CHNL_e chnl)
{
    ...
    Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_switch_stop_transfer:: \n");
	Log_DebugPrintf(LOGID_SOC_AUDIO, 
                    "csl_caph_switch_stop_transfer:: chnl = 0x%x\n", chnl);
    /* Get cHAL Channel */
    chal_chnl = csl_caph_switch_get_chalchnl(chnl);
    /* Stop this channel */
