...
typedef struct
{
	Dsp_SharedMem_t			CP_shared_memory;						
	NOT_USE_AP_SharedMem_t	NOT_USE_AP_shared_memory;
} Common_Shared_memory_t;	

#pragma arm section zidata = "shared_rip_mem_sect"
static Common_Shared_memory_t shared_mem_region;	// Define global structure variable and put them at the dsp-arm shared memory
	  
#pragma arm section

static Dsp_SharedMem_t 				*dsp_shared_mem = 	    &shared_mem_region.CP_shared_memory;		// Define pointers to global strcuture of the shared memory


static Dsp_SharedMem_t			*unpaged_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t			*shared_mem = &shared_mem_region.CP_shared_memory; 
static Dsp_SharedMem_t 			*pg1_shared_mem = &shared_mem_region.CP_shared_memory;							
static Dsp_SharedMem_t 					*event_page = &shared_mem_region.CP_shared_memory;								
#ifdef DSP_FEATURE_RFAPI
static Dsp_SharedMem_t 					*rftest_page = &shared_mem_region.CP_shared_memory;
#endif
static Dsp_SharedMem_t					*pg4_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg5_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg6_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg7_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg10_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg11_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg14_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg15_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg18_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg21_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg24_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg27_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg28_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg29_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t					*pg30_shared_mem = &shared_mem_region.CP_shared_memory;
#ifdef DSP_FEATURE_HIGH_QUALITY_ADC			 											
static Dsp_SharedMem_t					*pg31_shared_mem = &shared_mem_region.CP_shared_memory;					
static Dsp_SharedMem_t 					*pg32_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg33_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg34_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg35_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg36_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg37_shared_mem = &shared_mem_region.CP_shared_memory;
static Dsp_SharedMem_t 					*pg38_shared_mem = &shared_mem_region.CP_shared_memory;
...
void SHAREDMEM_Init()
{
	...
	struct_size = sizeof( Dsp_SharedMem_t );
	// Clear out shared memory
	memset(&shared_mem_region, 0, sizeof(Common_Shared_memory_t));
...
{
//	TRACE_Printf_Sio("SHAREDMEM_PostCmdQ=%02x, arg0=%02x\r\n", cmd_msg->cmd, cmd_msg->arg0);
