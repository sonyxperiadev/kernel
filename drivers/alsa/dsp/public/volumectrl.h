...
*   @file   volumectrl.h
*
*   @brief  This file contains the Baseband Volume control interface
*
****************************************************************************/
...
// Converts an absolute volume level request from the MMI to a baseband PGA and DSP Digital gain step
...
// Converts an absolute volume level request from the MMI to a baseband DSP Digital gain step
void VOLUMECTRL_Set_WB_AMR_output_gain(
   	UInt8 level_in_dB,  //in the range of 0 .. SYSPARM_GetVoiceVolumeMax( ).
   	UInt8 no_use1,
	UInt16 no_use2,
	UInt8 no_use3
	);

UInt16 VOLUMECTRL_GetDigitalVolumeStep( void );

void VOLUMECTRL_SetSpeechRecGainUL(Int16 gain);

void VOLUMECTRL_SetDigitalRxGain( Int16 gain );
void VOLUMECTRL_MuteRx( void );
void VOLUMECTRL_UnMuteRx( void );
void VOLUMECTRL_SetDigitalTxGain( Int16 gain );
void VOLUMECTRL_MuteTx( void );
void VOLUMECTRL_UnMuteTx( void );
