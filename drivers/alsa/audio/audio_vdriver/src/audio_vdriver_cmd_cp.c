...
/////////////////////////////////////////////////////////////////////////////
//
//! Function Name:	DSPCMD_Set_Tone_ScaleFactor
//
//! Description:		Send DSP command to set tone scale factor
//
//! Notes:
//
/////////////////////////////////////////////////////////////////////////////

void DSPCMD_Set_Tone_ScaleFactor(UInt16 uScaleFactor)  
//need to mvoe this to DSP file. Also can uyse a arg in tone DSP cmd and remove this function.
//this does not work on Athena?
{
#if (defined(_BCM2153_) && CHIP_REVISION >= 51)
	DSPCMD_RIPWrite(0x8f, uScaleFactor);
#else
	DSPCMD_RIPWrite(0x8f, uScaleFactor); //could not find E0 address becuase list file is not in sdb for E0 chip
#endif
}
