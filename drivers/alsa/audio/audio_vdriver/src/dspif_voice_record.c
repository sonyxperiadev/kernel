...
UInt32 dspif_VPU_record_read_AMRNB ( UInt8 *inBuf, UInt32 inSize, UInt16 bufIndex, UInt32 speechMode, UInt32 numFramesPerInterrupt )
{
	...
	Log_DebugPrintf(LOGID_AUDIO, "dspif_VPU_record_read_AMRNB :: copy data from shared memory to inBuf = 0x%x, inSize = %d, framecnt=%d\n", inBuf, inSize, frameCount);
	...
	Log_DebugPrintf(LOGID_AUDIO, "dspif_VPU_record_read_AMRNB ::  totalCopied = %d\n", totalCopied);
...
UInt32 dspif_VPU_record_read_PCM ( UInt8 *inBuf, UInt32 inSize, UInt16 bufIndex, UInt32 speechMode, UInt32 numFramesPerInterrupt )
{
	...
	Log_DebugPrintf(LOGID_AUDIO, "dspif_VPU_record_read_PCM :: copy data to shared memory inBuf = 0x%x, inSize = %d, vp_speech_mode = %d\n", inBuf, inSize, sh_mem->shared_voice_buf.vr_buf[bufIndex].vp_speech_mode);
