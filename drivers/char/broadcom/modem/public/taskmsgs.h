...
//*****************************************************************************
	...
	**/ 
	    ...
	    MSG_SATKCC_USSD_CC_NOT_ALLOWED =
	    MSG_GRP_STK + 0x50, MSG_SATKCC_USSD_CC_INIT_IND =
	    MSG_GRP_STK + 0x51, MSG_SATKCC_USSD_CC_ALLOWED =
	    MSG_GRP_STK + 0x52, MSG_SATKCC_USSD_CC_MODIFIED =
	    MSG_GRP_STK + 0x53, MSG_SATKCC_SMS_CC =
	    MSG_GRP_STK + 0x54, MSG_SATKCC_SS_CC_NOT_ALLOWED =
	    MSG_GRP_STK + 0x55, MSG_SATKCC_SS_CC_INIT_IND =
	    MSG_GRP_STK + 0x56, MSG_SATKCC_SS_CC_ALLOWED =
	    MSG_GRP_STK + 0x57, MSG_SATKCC_SS_CC_MODIFIED =
	    MSG_GRP_STK + 0x58, 
	...
	MSG_STK_REPORT_CALL_AOC_STATUS =
	    MSG_GRP_STK + 0x68, MSG_STK_REPORT_CALL_CCM =
	    MSG_GRP_STK + 0x69, MSG_STK_SEND_USER_CONFIRMATION_REQ =
	    MSG_GRP_STK + 0x70, 
	...
	**/ 
	...
	MSG_SECMODEM_CONFIG_MODEM_RSP = MSG_GRP_SECMODEM + 0x02,	///<Payload type {::UInt8}
	    ...
	    MSG_GRP_INT_ATC + 0x01, MSG_RESET_REQ =
	    MSG_GRP_INT_ATC + 0x03, MSG_STATISTIC_INFO =
	    MSG_GRP_INT_ATC + 0x04, 
...
//*****************************************************************************
	...
	**/ 
	...
	// End of MSG_GRP_INT_DC, (0x2600)
	    ...
	    MSG_VMC_CAPI_ADMISSION_CNF =
	    MSG_GRP_INT_VCC + 0x00, MSG_VMC_CAPI_ADMISSION_REJ =
	    MSG_GRP_INT_VCC + 0x01, MSG_VMC_STATUS_IND =
	    MSG_GRP_INT_VCC + 0x02, MSG_VCC_CAPI_IDLE_IND =
	    MSG_GRP_INT_VCC + 0x03, MSG_VCC_CAPI_SERV_REQ =
	    MSG_GRP_INT_VCC + 0x04, MSG_VCC_RETRY_TIMER_EXPIRE =
	    MSG_GRP_INT_VCC + 0x05, MSG_VCC_CHECK_VM_REQ =
	    MSG_GRP_INT_VCC + 0x06, MSG_VCC_CAPI_CANCEL_SERV_REQ =
	    MSG_GRP_INT_VCC + 0x07, 
	    // VCC outgoing messages
	    MSG_VMC_CAPI_ADMISSION_REQ =
	    MSG_GRP_INT_VCC + 0x10, MSG_VMC_CAPI_IDLE_IND =
	    MSG_GRP_INT_VCC + 0x11, MSG_CAPI_VCC_TIMEOUT =
	    MSG_GRP_INT_VCC + 0x12, 
	    // Redefinitions
	    MSG_MS_SEARCH_PLMN_RSP =
	    MSG_PLMNLIST_IND, MSG_SIM_WHOLE_EFILE_DATA_RSP =
	    MSG_SIM_EFILE_DATA_RSP, MSG_SIM_RECORD_EFILE_DATA_RSP =
	    MSG_SIM_EFILE_DATA_RSP, MSG_SIM_LINEAR_EFILE_UPDATE_RSP =
	    MSG_SIM_EFILE_UPDATE_RSP, MSG_SIM_SEEK_RECORD_RSP =
	    MSG_SIM_SEEK_REC_RSP, MSG_SIM_CYCLIC_EFILE_UPDATE_RSP =
	    MSG_SIM_EFILE_UPDATE_RSP, MSG_MS_PLMN_SELECT_RSP =
	    MSG_PLMN_SELECT_CNF, MSG_READ_USIM_PBK_HDK_RSP =
	    MSG_READ_USIM_PBK_HDK_ENTRY_RSP, MSG_WRITE_USIM_PBK_HDK_RSP =
	    MSG_WRITE_USIM_PBK_HDK_ENTRY_RSP,
	    MSG_WRITE_USIM_PBK_ALPHA_AAS_RSP =
	    MSG_WRITE_USIM_PBK_ALPHA_ENTRY_RSP,
	    MSG_WRITE_USIM_PBK_ALPHA_GAS_RSP =
	    MSG_WRITE_USIM_PBK_ALPHA_ENTRY_RSP,
	    MSG_READ_USIM_PBK_ALPHA_AAS_RSP =
	    MSG_READ_USIM_PBK_ALPHA_ENTRY_RSP,
	    MSG_READ_USIM_PBK_ALPHA_GAS_RSP =
	    MSG_READ_USIM_PBK_ALPHA_ENTRY_RSP,
	    MSG_GET_USIM_PBK_ALPHA_INFO_AAS_RSP =
	    MSG_GET_USIM_PBK_ALPHA_INFO_RSP,
	    MSG_GET_USIM_PBK_ALPHA_INFO_GAS_RSP =
	    MSG_GET_USIM_PBK_ALPHA_INFO_RSP, 
...
//TASKMSGS_INCLUDE taskmsgs_usb.i
	...
	**/ 
	    ...
	    MSG_USB_ADAPTER_IND = MSG_GRP_DEV + 0x22, MSG_INTERTASK_MSG_REQ =
	    MSG_GRP_DEV + 0x23, MSG_INTERTASK_MSG_RSP =
	    MSG_GRP_DEV + 0x24, MSG_USB_AP_INTERTASK_RSP =
	    MSG_GRP_DEV + 0x25, MSG_ADC_DRX_SYNC_IND =
	    MSG_GRP_DEV + 0x26, MSG_AUDIO_CTRL_GENERIC_REQ =
	    MSG_GRP_DEV + 0x27, MSG_AUDIO_CTRL_GENERIC_RSP =
	    MSG_GRP_DEV + 0x28, MSG_AUDIO_CTRL_DSP_REQ =
	    MSG_GRP_DEV + 0x29, MSG_AUDIO_CTRL_DSP_RSP =
	    MSG_GRP_DEV + 0x2A, MSG_DEV_BCD_SUCCESSFUL =
	    MSG_GRP_DEV + 0x2B, MSG_DEV_BCD_FAILED =
	    MSG_GRP_DEV + 0x2C, MSG_AUDIO_COMP_FILTER_REQ =
	    MSG_GRP_DEV + 0x2D, MSG_AUDIO_COMP_FILTER_RSP =
	    MSG_GRP_DEV + 0x2E, MSG_AUDIO_CALL_STATUS_IND =
	    MSG_GRP_DEV + 0x2F, 
#ifdef CNEON_COMMON
...
//TASKMSGS_INCLUDE taskmsgs_dataservices.i
	...
	MSG_PCHEX_TEST_SHUTDOWN =
	    MSG_GRP_TEST_PCH + 0xa7, MSG_PCHEX_TEST_PINGTIMER =
	    MSG_GRP_TEST_PCH + 0xa8, MSG_PCHEX_TEST_LAST =
	    MSG_GRP_TEST_PCH + 0xa9, 
	    // for DC broadcasting
	    MSG_DC_REPORT_CALL_STATUS = MSG_GRP_DC + 0x10,	///<Payload type {::DC_ReportCallStatus_t}
	MSG_DC_IR_SHUTDOWN_CONNECTION_REQ = MSG_GRP_DC + 0x11,	///<Payload type {::DC_IR_ShutdownDataConnection_t}
	MSG_DC_IR_STARTUP_CONNECTION_REQ = MSG_GRP_DC + 0x12,	///<Payload type {::DC_IR_StartupDataConnection_t}
...
//TASKMSGS_INCLUDE taskmsgs_mmi.i
...
#ifndef UNDER_CE
	    MSG_SIMULATOR_ACCEPT =
	    MSG_GRP_SIMULATOR_0 + 0x00,
	    MSG_SIMULATOR_ALLOCINTERTASKMSGFROMHEAP =
	    MSG_GRP_SIMULATOR_0 + 0x02, MSG_SIMULATOR_AT_CMDCLOSETRANSACTION =
	    MSG_GRP_SIMULATOR_0 + 0x04, MSG_SIMULATOR_AT_CMDRSP =
	    MSG_GRP_SIMULATOR_0 + 0x06, MSG_SIMULATOR_AT_CMDRSPCMSERROR =
	    MSG_GRP_SIMULATOR_0 + 0x08, MSG_SIMULATOR_AT_CMDRSPERROR =
	    MSG_GRP_SIMULATOR_0 + 0x0a, MSG_SIMULATOR_AT_CMDRSPOK =
	    MSG_GRP_SIMULATOR_0 + 0x0c, MSG_SIMULATOR_AT_CMDRSPSYNTAXERROR =
	    MSG_GRP_SIMULATOR_0 + 0x0e, MSG_SIMULATOR_AT_GETCMDNAME =
	    MSG_GRP_SIMULATOR_0 + 0x10, MSG_SIMULATOR_AT_GETPARM =
	    MSG_GRP_SIMULATOR_0 + 0x12, MSG_SIMULATOR_AT_GETVALIDPARMSTR =
	    MSG_GRP_SIMULATOR_0 + 0x14, MSG_SIMULATOR_AT_OUTPUTRSP =
	    MSG_GRP_SIMULATOR_0 + 0x16, MSG_SIMULATOR_AT_OUTPUTSTR =
	    MSG_GRP_SIMULATOR_0 + 0x18, MSG_SIMULATOR_AT_OUTPUTSTRBUFFERED =
	    MSG_GRP_SIMULATOR_0 + 0x1a, MSG_SIMULATOR_AT_OUTPUTUNSOLICITEDSTR =
	    MSG_GRP_SIMULATOR_0 + 0x1c, MSG_SIMULATOR_AT_PROCESSCMD =
	    MSG_GRP_SIMULATOR_0 + 0x1e, MSG_SIMULATOR_AT_RESUMECMD =
	    MSG_GRP_SIMULATOR_0 + 0x20,
	    MSG_SIMULATOR_ATC_CONFIGSERIALDEVFORATC =
	    MSG_GRP_SIMULATOR_0 + 0x22, MSG_SIMULATOR_AUDIO_CLOSESESSION =
	    MSG_GRP_SIMULATOR_0 + 0x24,
	    MSG_SIMULATOR_AUDIO_CREATEPLAYBACKSESSION =
	    MSG_GRP_SIMULATOR_0 + 0x26,
	    MSG_SIMULATOR_AUDIO_CREATERECORDINGSESSION =
	    MSG_GRP_SIMULATOR_0 + 0x28, MSG_SIMULATOR_AUDIO_GETMICROPHONEGAIN =
	    MSG_GRP_SIMULATOR_0 + 0x2a, MSG_SIMULATOR_AUDIO_GETSIDETONEGAIN =
	    MSG_GRP_SIMULATOR_0 + 0x2c, MSG_SIMULATOR_AUDIO_GETSPEAKERVOL =
	    MSG_GRP_SIMULATOR_0 + 0x2e, MSG_SIMULATOR_AUDIO_PAUSESESSION =
	    MSG_GRP_SIMULATOR_0 + 0x30, MSG_SIMULATOR_AUDIO_PLAYTONE =
	    MSG_GRP_SIMULATOR_0 + 0x32, MSG_SIMULATOR_AUDIO_RESUMESESSION =
	    MSG_GRP_SIMULATOR_0 + 0x34, MSG_SIMULATOR_AUDIO_RUN =
	    MSG_GRP_SIMULATOR_0 + 0x36,
	    MSG_SIMULATOR_AUDIO_SELECTAUDIOCHANNEL =
	    MSG_GRP_SIMULATOR_0 + 0x38, MSG_SIMULATOR_AUDIO_SETMICROPHONEGAIN =
	    MSG_GRP_SIMULATOR_0 + 0x3a, MSG_SIMULATOR_AUDIO_SETSIDETONEGAIN =
	    MSG_GRP_SIMULATOR_0 + 0x3c, MSG_SIMULATOR_AUDIO_SETSPEAKERVOL =
	    MSG_GRP_SIMULATOR_0 + 0x3e, MSG_SIMULATOR_AUDIO_SHUTDOWN =
	    MSG_GRP_SIMULATOR_0 + 0x40, MSG_SIMULATOR_AUDIO_STARTSESSION =
	    MSG_GRP_SIMULATOR_0 + 0x42, MSG_SIMULATOR_AUDIO_STOPSESSION =
	    MSG_GRP_SIMULATOR_0 + 0x44, MSG_SIMULATOR_BIND =
	    MSG_GRP_SIMULATOR_0 + 0x46, MSG_SIMULATOR_CALLPARSER_PARSEDIALSTR =
	    MSG_GRP_SIMULATOR_0 + 0x48, MSG_SIMULATOR_CC_ACCEPTDATACALL =
	    MSG_GRP_SIMULATOR_0 + 0x4a, MSG_SIMULATOR_CC_ACCEPTVOICECALL =
	    MSG_GRP_SIMULATOR_0 + 0x4c, MSG_SIMULATOR_CC_ACCEPTWAITINGCALL =
	    MSG_GRP_SIMULATOR_0 + 0x4e, MSG_SIMULATOR_CC_ENDALLCALLS =
	    MSG_GRP_SIMULATOR_0 + 0x50, MSG_SIMULATOR_CC_END_CALL =
	    MSG_GRP_SIMULATOR_0 + 0x52, MSG_SIMULATOR_CC_ENDHELDCALL =
	    MSG_GRP_SIMULATOR_0 + 0x54, MSG_SIMULATOR_CC_ENDMPTYCALLS =
	    MSG_GRP_SIMULATOR_0 + 0x56,
	    MSG_SIMULATOR_CC_GETALLACTIVECALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x58, MSG_SIMULATOR_CC_GETALLCALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x5a, MSG_SIMULATOR_CC_GETALLCALLSTATES =
	    MSG_GRP_SIMULATOR_0 + 0x5c, MSG_SIMULATOR_CC_GETALLHELDCALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x5e, MSG_SIMULATOR_CC_GETALLMPTYCALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x60, MSG_SIMULATOR_CC_GETCALLCLIENTID =
	    MSG_GRP_SIMULATOR_0 + 0x62, MSG_SIMULATOR_CC_GETCALLNUMBER =
	    MSG_GRP_SIMULATOR_0 + 0x64, MSG_SIMULATOR_CC_GETCALLSTATE =
	    MSG_GRP_SIMULATOR_0 + 0x66, MSG_SIMULATOR_CC_GETCALLTYPE =
	    MSG_GRP_SIMULATOR_0 + 0x68, MSG_SIMULATOR_CC_GETCONNECTEDLINEID =
	    MSG_GRP_SIMULATOR_0 + 0x6a, MSG_SIMULATOR_CC_GETCURRENTCALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x6c, MSG_SIMULATOR_CC_GETLASTCALLCCM =
	    MSG_GRP_SIMULATOR_0 + 0x6e, MSG_SIMULATOR_CC_GETLASTCALLDURATION =
	    MSG_GRP_SIMULATOR_0 + 0x70, MSG_SIMULATOR_CC_GETLASTCALLEXITCAUSE =
	    MSG_GRP_SIMULATOR_0 + 0x72,
	    MSG_SIMULATOR_CC_GETLASTDATACALLRXBYTES =
	    MSG_GRP_SIMULATOR_0 + 0x74,
	    MSG_SIMULATOR_CC_GETLASTDATACALLTXBYTES =
	    MSG_GRP_SIMULATOR_0 + 0x76, MSG_SIMULATOR_CC_GETMPTYCALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x78,
	    MSG_SIMULATOR_CC_GETNEXTACTIVECALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x7a, MSG_SIMULATOR_CC_GETNEXTHELDCALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x7c, MSG_SIMULATOR_CC_GETNEXTWAITCALLINDEX =
	    MSG_GRP_SIMULATOR_0 + 0x7e, MSG_SIMULATOR_CC_GETNUMOFACTIVECALLS =
	    MSG_GRP_SIMULATOR_0 + 0x80, MSG_SIMULATOR_CC_GETNUMOFHELDCALLS =
	    MSG_GRP_SIMULATOR_0 + 0x82, MSG_SIMULATOR_CC_GETNUMOFMPTYCALLS =
	    MSG_GRP_SIMULATOR_0 + 0x84, MSG_SIMULATOR_CC_HOLDCALL =
	    MSG_GRP_SIMULATOR_0 + 0x86, MSG_SIMULATOR_CC_HOLDCURRENTCALL =
	    MSG_GRP_SIMULATOR_0 + 0x88, MSG_SIMULATOR_CC_INITCALLCONTROL =
	    MSG_GRP_SIMULATOR_0 + 0x8a,
	    MSG_SIMULATOR_CC_ISCONNECTEDLINEIDPRESENTALLOWED =
	    MSG_GRP_SIMULATOR_0 + 0x8c, MSG_SIMULATOR_CC_ISMULTIPARTYCALL =
	    MSG_GRP_SIMULATOR_0 + 0x8e, MSG_SIMULATOR_CC_ISTHEREALERTINGCALL =
	    MSG_GRP_SIMULATOR_0 + 0x90, MSG_SIMULATOR_CC_ISTHEREVOICECALL =
	    MSG_GRP_SIMULATOR_0 + 0x92, MSG_SIMULATOR_CC_ISTHEREWAITINGCALL =
	    MSG_GRP_SIMULATOR_0 + 0x94, MSG_SIMULATOR_CC_ISVALIDDTMF =
	    MSG_GRP_SIMULATOR_0 + 0x96, MSG_SIMULATOR_CC_JOINCALL =
	    MSG_GRP_SIMULATOR_0 + 0x98, MSG_SIMULATOR_CC_MAKEDATACALL =
	    MSG_GRP_SIMULATOR_0 + 0x9a, MSG_SIMULATOR_CC_MAKEFAXCALL =
	    MSG_GRP_SIMULATOR_0 + 0x9c, MSG_SIMULATOR_CC_MAKE_VOICE_CALL =
	    MSG_GRP_SIMULATOR_0 + 0x9e, MSG_SIMULATOR_CC_MUTEDTMFTONE =
	    MSG_GRP_SIMULATOR_0 + 0xa0, MSG_SIMULATOR_CC_RETRIEVECALL =
	    MSG_GRP_SIMULATOR_0 + 0xa2, MSG_SIMULATOR_CC_RETRIEVNEXTHELDCALL =
	    MSG_GRP_SIMULATOR_0 + 0xa4, MSG_SIMULATOR_CC_SENDDTMF =
	    MSG_GRP_SIMULATOR_0 + 0xa6, MSG_SIMULATOR_CC_SPLITCALL =
	    MSG_GRP_SIMULATOR_0 + 0xa8, MSG_SIMULATOR_CC_STOPDTMF =
	    MSG_GRP_SIMULATOR_0 + 0xaa, MSG_SIMULATOR_CC_SWAPCALL =
	    MSG_GRP_SIMULATOR_0 + 0xac, MSG_SIMULATOR_CONNECT =
	    MSG_GRP_SIMULATOR_0 + 0xae, MSG_SIMULATOR_CSD_BUFFERFREESPACE =
	    MSG_GRP_SIMULATOR_0 + 0xb0, MSG_SIMULATOR_CSD_GETDATA =
	    MSG_GRP_SIMULATOR_0 + 0xb2, MSG_SIMULATOR_CSD_REGISTERDATAIND =
	    MSG_GRP_SIMULATOR_0 + 0xb4, MSG_SIMULATOR_CSD_SENDDATA =
	    MSG_GRP_SIMULATOR_0 + 0xb6, MSG_SIMULATOR_DATA_CREATECSDDATAACCT =
	    MSG_GRP_SIMULATOR_0 + 0xb8, MSG_SIMULATOR_DATA_CREATEGPRSDATAACCT =
	    MSG_GRP_SIMULATOR_0 + 0xba, MSG_SIMULATOR_DATA_DELETEDATAACCT =
	    MSG_GRP_SIMULATOR_0 + 0xbc, MSG_SIMULATOR_DATA_GETACCTTYPE =
	    MSG_GRP_SIMULATOR_0 + 0xbe, MSG_SIMULATOR_DATA_GETAUTHENMETHOD =
	    MSG_GRP_SIMULATOR_0 + 0xc0,
	    MSG_SIMULATOR_DATA_GETCIDFROMDATAACCTID =
	    MSG_GRP_SIMULATOR_0 + 0xc2, MSG_SIMULATOR_DATA_GETCSDBAUDRATE =
	    MSG_GRP_SIMULATOR_0 + 0xc4, MSG_SIMULATOR_DATA_GETCSDCONNELEMENT =
	    MSG_GRP_SIMULATOR_0 + 0xc6, MSG_SIMULATOR_DATA_GETCSDCONTEXT =
	    MSG_GRP_SIMULATOR_0 + 0xc8, MSG_SIMULATOR_DATA_GETCSDDATACOMPTYPE =
	    MSG_GRP_SIMULATOR_0 + 0xca, MSG_SIMULATOR_DATA_GETCSDDIALNUMBER =
	    MSG_GRP_SIMULATOR_0 + 0xcc, MSG_SIMULATOR_DATA_GETCSDDIALTYPE =
	    MSG_GRP_SIMULATOR_0 + 0xce,
	    MSG_SIMULATOR_DATA_GETCSDERRCORRECTIONTYPE =
	    MSG_GRP_SIMULATOR_0 + 0xd0,
	    MSG_SIMULATOR_DATA_GETDATAACCTIDFROMCID =
	    MSG_GRP_SIMULATOR_0 + 0xd2, MSG_SIMULATOR_DATA_GETDATACOMPRESSION =
	    MSG_GRP_SIMULATOR_0 + 0xd4, MSG_SIMULATOR_DATA_GETEMPTYACCTSLOT =
	    MSG_GRP_SIMULATOR_0 + 0xd6, MSG_SIMULATOR_DATA_GETGPRSAPN =
	    MSG_GRP_SIMULATOR_0 + 0xd8, MSG_SIMULATOR_DATA_GETGPRSCONTEXT =
	    MSG_GRP_SIMULATOR_0 + 0xda,
	    MSG_SIMULATOR_DATA_GETGPRSHEADERCOMPRESSION =
	    MSG_GRP_SIMULATOR_0 + 0xdc, MSG_SIMULATOR_DATA_GETGPRSPDPTYPE =
	    MSG_GRP_SIMULATOR_0 + 0xde, MSG_SIMULATOR_DATA_GETGPRSQOS =
	    MSG_GRP_SIMULATOR_0 + 0xe0, MSG_SIMULATOR_DATA_GETPASSWORD =
	    MSG_GRP_SIMULATOR_0 + 0xe2, MSG_SIMULATOR_DATA_GETPRIMARYDNSADDR =
	    MSG_GRP_SIMULATOR_0 + 0xe4, MSG_SIMULATOR_DATA_GETSECONDDNSADDR =
	    MSG_GRP_SIMULATOR_0 + 0xe6, MSG_SIMULATOR_DATA_GETSTATICIPADDR =
	    MSG_GRP_SIMULATOR_0 + 0xe8, MSG_SIMULATOR_DATA_GETUSERNAME =
	    MSG_GRP_SIMULATOR_0 + 0xea, MSG_SIMULATOR_DATA_SETAUTHENMETHOD =
	    MSG_GRP_SIMULATOR_0 + 0xec, MSG_SIMULATOR_DATA_SETCSDBAUDRATE =
	    MSG_GRP_SIMULATOR_0 + 0xee, MSG_SIMULATOR_DATA_SETCSDCONNELEMENT =
	    MSG_GRP_SIMULATOR_0 + 0xf0, MSG_SIMULATOR_DATA_SETCSDDATACOMPTYPE =
	    MSG_GRP_SIMULATOR_0 + 0xf2, MSG_SIMULATOR_DATA_SETCSDDIALNUMBER =
	    MSG_GRP_SIMULATOR_0 + 0xf4, MSG_SIMULATOR_DATA_SETCSDDIALTYPE =
	    MSG_GRP_SIMULATOR_0 + 0xf6,
	    MSG_SIMULATOR_DATA_SETCSDERRCORRECTIONTYPE =
	    MSG_GRP_SIMULATOR_0 + 0xf8, MSG_SIMULATOR_DATA_SETDATACOMPRESSION =
	    MSG_GRP_SIMULATOR_0 + 0xfa, MSG_SIMULATOR_DATA_SETGPRSAPN =
	    MSG_GRP_SIMULATOR_0 + 0xfc,
	    MSG_SIMULATOR_DATA_SETGPRSHEADERCOMPRESSION =
	    MSG_GRP_SIMULATOR_0 + 0xfe, MSG_SIMULATOR_DATA_SETGPRSPDPTYPE =
	    MSG_GRP_SIMULATOR_1 + 0x00, MSG_SIMULATOR_DATA_SETGPRSQOS =
	    MSG_GRP_SIMULATOR_1 + 0x02, MSG_SIMULATOR_DATA_SETPASSWORD =
	    MSG_GRP_SIMULATOR_1 + 0x04, MSG_SIMULATOR_DATA_SETPRIMARYDNSADDR =
	    MSG_GRP_SIMULATOR_1 + 0x06, MSG_SIMULATOR_DATA_SETSECONDDNSADDR =
	    MSG_GRP_SIMULATOR_1 + 0x08, MSG_SIMULATOR_DATA_SETSTATICIPADDR =
	    MSG_GRP_SIMULATOR_1 + 0x0a, MSG_SIMULATOR_DATA_SETUSERNAME =
	    MSG_GRP_SIMULATOR_1 + 0x0c, MSG_SIMULATOR_ERRNO =
	    MSG_GRP_SIMULATOR_1 + 0x0e, MSG_SIMULATOR_FREEINTERTASKMSG =
	    MSG_GRP_SIMULATOR_1 + 0x10, MSG_SIMULATOR_FS_CLOSE =
	    MSG_GRP_SIMULATOR_1 + 0x12, MSG_SIMULATOR_FS_FLUSH =
	    MSG_GRP_SIMULATOR_1 + 0x14, MSG_SIMULATOR_FS_GEFREESPACE =
	    MSG_GRP_SIMULATOR_1 + 0x16, MSG_SIMULATOR_FS_GETCURRENTDIR =
	    MSG_GRP_SIMULATOR_1 + 0x18, MSG_SIMULATOR_FS_GETFILEDONE =
	    MSG_GRP_SIMULATOR_1 + 0x1a, MSG_SIMULATOR_FS_GETFILEFIRST =
	    MSG_GRP_SIMULATOR_1 + 0x1c, MSG_SIMULATOR_FS_GETFILENEXT =
	    MSG_GRP_SIMULATOR_1 + 0x1e, MSG_SIMULATOR_FS_MAKEDIR =
	    MSG_GRP_SIMULATOR_1 + 0x20, MSG_SIMULATOR_FS_OPEN =
	    MSG_GRP_SIMULATOR_1 + 0x22, MSG_SIMULATOR_FS_READ =
	    MSG_GRP_SIMULATOR_1 + 0x24, MSG_SIMULATOR_FS_REMOVE =
	    MSG_GRP_SIMULATOR_1 + 0x26, MSG_SIMULATOR_FS_REMOVEDIR =
	    MSG_GRP_SIMULATOR_1 + 0x28, MSG_SIMULATOR_FS_RENAME =
	    MSG_GRP_SIMULATOR_1 + 0x2a, MSG_SIMULATOR_FS_SEEK =
	    MSG_GRP_SIMULATOR_1 + 0x2c, MSG_SIMULATOR_FS_SETCURRENTDIR =
	    MSG_GRP_SIMULATOR_1 + 0x2e, MSG_SIMULATOR_FS_TELL =
	    MSG_GRP_SIMULATOR_1 + 0x30, MSG_SIMULATOR_FS_WRITE =
	    MSG_GRP_SIMULATOR_1 + 0x32, MSG_SIMULATOR_GETATCMDIDBYMPXCHANNEL =
	    MSG_GRP_SIMULATOR_1 + 0x34, MSG_SIMULATOR_GETATCMDRSPMPXCHANNEL =
	    MSG_GRP_SIMULATOR_1 + 0x36, MSG_SIMULATOR_GETPEERNAME =
	    MSG_GRP_SIMULATOR_1 + 0x38, MSG_SIMULATOR_GETSMSBEARERTYPE =
	    MSG_GRP_SIMULATOR_1 + 0x3a, MSG_SIMULATOR_GETSMSRVCENTERNUMBER =
	    MSG_GRP_SIMULATOR_1 + 0x3c, MSG_SIMULATOR_GETSOCKNAME =
	    MSG_GRP_SIMULATOR_1 + 0x3e, MSG_SIMULATOR_GETSOCKOPT =
	    MSG_GRP_SIMULATOR_1 + 0x40, MSG_SIMULATOR_GETV24OPERATIONMODE =
	    MSG_GRP_SIMULATOR_1 + 0x42, MSG_SIMULATOR_GPIO_CLEARINT =
	    MSG_GRP_SIMULATOR_1 + 0x44, MSG_SIMULATOR_GPIO_CONFIGINPUT =
	    MSG_GRP_SIMULATOR_1 + 0x46, MSG_SIMULATOR_GPIO_CONFIGKEYPAD =
	    MSG_GRP_SIMULATOR_1 + 0x48, MSG_SIMULATOR_GPIO_CONFIGOUTPUT =
	    MSG_GRP_SIMULATOR_1 + 0x4a, MSG_SIMULATOR_GPIO_DISABLEINT =
	    MSG_GRP_SIMULATOR_1 + 0x4c, MSG_SIMULATOR_GPIO_ENABLEINT =
	    MSG_GRP_SIMULATOR_1 + 0x4e, MSG_SIMULATOR_GPIO_KEYPADREGISTER =
	    MSG_GRP_SIMULATOR_1 + 0x50, MSG_SIMULATOR_GPIO_READ =
	    MSG_GRP_SIMULATOR_1 + 0x52, MSG_SIMULATOR_GPIO_READINTSTATUS =
	    MSG_GRP_SIMULATOR_1 + 0x54, MSG_SIMULATOR_GPIO_REGISTER =
	    MSG_GRP_SIMULATOR_1 + 0x56, MSG_SIMULATOR_GPIO_SELECTROW =
	    MSG_GRP_SIMULATOR_1 + 0x58, MSG_SIMULATOR_GPIO_WRITE =
	    MSG_GRP_SIMULATOR_1 + 0x5a, MSG_SIMULATOR_I2C_INIT =
	    MSG_GRP_SIMULATOR_1 + 0x5c, MSG_SIMULATOR_I2C_READ =
	    MSG_GRP_SIMULATOR_1 + 0x5e, MSG_SIMULATOR_I2C_RUN =
	    MSG_GRP_SIMULATOR_1 + 0x60, MSG_SIMULATOR_I2C_WRITE =
	    MSG_GRP_SIMULATOR_1 + 0x62, MSG_SIMULATOR_IMAGE_CONVERT =
	    MSG_GRP_SIMULATOR_1 + 0x64, MSG_SIMULATOR_IMAGE_DECODE =
	    MSG_GRP_SIMULATOR_1 + 0x66, MSG_SIMULATOR_IMAGE_GETINFO =
	    MSG_GRP_SIMULATOR_1 + 0x68, MSG_SIMULATOR_IMAGE_ROTATE =
	    MSG_GRP_SIMULATOR_1 + 0x6a, MSG_SIMULATOR_IMAGE_RUN =
	    MSG_GRP_SIMULATOR_1 + 0x6c, MSG_SIMULATOR_IMAGE_SCALE =
	    MSG_GRP_SIMULATOR_1 + 0x6e, MSG_SIMULATOR_IMAGE_SHUTDOWN =
	    MSG_GRP_SIMULATOR_1 + 0x70, MSG_SIMULATOR_IN_RESHOST =
	    MSG_GRP_SIMULATOR_1 + 0x72, MSG_SIMULATOR_IRQ_CLEAR =
	    MSG_GRP_SIMULATOR_1 + 0x74, MSG_SIMULATOR_IRQ_CLEARALL =
	    MSG_GRP_SIMULATOR_1 + 0x76, MSG_SIMULATOR_IRQ_CONTROLLER =
	    MSG_GRP_SIMULATOR_1 + 0x78, MSG_SIMULATOR_IRQ_DISABLE =
	    MSG_GRP_SIMULATOR_1 + 0x7a, MSG_SIMULATOR_IRQ_DISABLEALL =
	    MSG_GRP_SIMULATOR_1 + 0x7c, MSG_SIMULATOR_IRQ_ENABLE =
	    MSG_GRP_SIMULATOR_1 + 0x7e, MSG_SIMULATOR_IRQ_INIT =
	    MSG_GRP_SIMULATOR_1 + 0x80, MSG_SIMULATOR_IRQ_ISACTIVE =
	    MSG_GRP_SIMULATOR_1 + 0x82, MSG_SIMULATOR_IRQ_ISACTIVERAW =
	    MSG_GRP_SIMULATOR_1 + 0x84, MSG_SIMULATOR_IRQ_ISENABLED =
	    MSG_GRP_SIMULATOR_1 + 0x86, MSG_SIMULATOR_IRQ_REGISTER =
	    MSG_GRP_SIMULATOR_1 + 0x88, MSG_SIMULATOR_IRQ_RESTORE =
	    MSG_GRP_SIMULATOR_1 + 0x8a, MSG_SIMULATOR_IRQ_TRIGGERRIPINT =
	    MSG_GRP_SIMULATOR_1 + 0x8c,
	    MSG_SIMULATOR_KPD_DRV_GETLASTKEYPRESSTIME =
	    MSG_GRP_SIMULATOR_1 + 0x8e, MSG_SIMULATOR_KPD_DRV_INIT =
	    MSG_GRP_SIMULATOR_1 + 0x90, MSG_SIMULATOR_KPD_DRV_REGISTER =
	    MSG_GRP_SIMULATOR_1 + 0x92, MSG_SIMULATOR_KPD_DRV_RUN =
	    MSG_GRP_SIMULATOR_1 + 0x94, MSG_SIMULATOR_KPD_DRV_SHUTDOWN =
	    MSG_GRP_SIMULATOR_1 + 0x96, MSG_SIMULATOR_LISTEN =
	    MSG_GRP_SIMULATOR_1 + 0x98, MSG_SIMULATOR_LOG_DEBUGOUTPUTSTRING =
	    MSG_GRP_SIMULATOR_1 + 0x9a, MSG_SIMULATOR_LOG_DEBUGOUTPUTVALUE =
	    MSG_GRP_SIMULATOR_1 + 0x9c, MSG_SIMULATOR_LOG_ENABLELOGGING =
	    MSG_GRP_SIMULATOR_1 + 0x9e, MSG_SIMULATOR_LOG_ENABLERANGE =
	    MSG_GRP_SIMULATOR_1 + 0xa0, MSG_SIMULATOR_LOG_GETLOGGINGID =
	    MSG_GRP_SIMULATOR_1 + 0xa2, MSG_SIMULATOR_LOG_ISLOGGINGENABLE =
	    MSG_GRP_SIMULATOR_1 + 0xa4, MSG_SIMULATOR_MM_DELETE =
	    MSG_GRP_SIMULATOR_1 + 0xa6, MSG_SIMULATOR_MM_DELOCATE =
	    MSG_GRP_SIMULATOR_1 + 0xa8, MSG_SIMULATOR_MM_FREEATTRIBUTE =
	    MSG_GRP_SIMULATOR_1 + 0xaa, MSG_SIMULATOR_MM_GETATTRIBUTE =
	    MSG_GRP_SIMULATOR_1 + 0xac, MSG_SIMULATOR_MM_INIT =
	    MSG_GRP_SIMULATOR_1 + 0xae, MSG_SIMULATOR_MM_LISTATTRIBUTE =
	    MSG_GRP_SIMULATOR_1 + 0xb0, MSG_SIMULATOR_MM_RETRIEVE =
	    MSG_GRP_SIMULATOR_1 + 0xb2, MSG_SIMULATOR_MM_SETATTRIBUTE =
	    MSG_GRP_SIMULATOR_1 + 0xb4, MSG_SIMULATOR_MM_SHUTDOWN =
	    MSG_GRP_SIMULATOR_1 + 0xb6, MSG_SIMULATOR_MM_STOREASYNC =
	    MSG_GRP_SIMULATOR_1 + 0xb8, MSG_SIMULATOR_MM_STOREBYREF =
	    MSG_GRP_SIMULATOR_1 + 0xba, MSG_SIMULATOR_MPXCONFIG =
	    MSG_GRP_SIMULATOR_1 + 0xbc, MSG_SIMULATOR_MPXGETMUXPARAM =
	    MSG_GRP_SIMULATOR_1 + 0xbe, MSG_SIMULATOR_MS_GETGPRSATTACHSTATUS =
	    MSG_GRP_SIMULATOR_1 + 0xc0, MSG_SIMULATOR_MS_GETPLMNCODEBYNAME =
	    MSG_GRP_SIMULATOR_1 + 0xc2, MSG_SIMULATOR_MS_GETPLMNENTRYBYINDEX =
	    MSG_GRP_SIMULATOR_1 + 0xc4, MSG_SIMULATOR_MS_GETPLMNFORMAT =
	    MSG_GRP_SIMULATOR_1 + 0xc6, MSG_SIMULATOR_MS_GETPLMNLISTSIZE =
	    MSG_GRP_SIMULATOR_1 + 0xc8, MSG_SIMULATOR_MS_GETPLMNMCC =
	    MSG_GRP_SIMULATOR_1 + 0xca, MSG_SIMULATOR_MS_GETPLMNMNC =
	    MSG_GRP_SIMULATOR_1 + 0xcc, MSG_SIMULATOR_MS_GETPLMNMODE =
	    MSG_GRP_SIMULATOR_1 + 0xce, MSG_SIMULATOR_MS_GETPLMNNAMEBYCODE =
	    MSG_GRP_SIMULATOR_1 + 0xd0, MSG_SIMULATOR_MS_ISGPRSREGISTERED =
	    MSG_GRP_SIMULATOR_1 + 0xd2, MSG_SIMULATOR_MS_ISGSMREGISTERED =
	    MSG_GRP_SIMULATOR_1 + 0xd4, MSG_SIMULATOR_MS_ISPLMNFORBIDDEN =
	    MSG_GRP_SIMULATOR_1 + 0xd6, MSG_SIMULATOR_MS_PLMNSELECT =
	    MSG_GRP_SIMULATOR_1 + 0xd8, MSG_SIMULATOR_MS_SEARCHAVAILABLEPLMN =
	    MSG_GRP_SIMULATOR_1 + 0xda,
	    MSG_SIMULATOR_MS_SENDCOMBINEDATTACHREQ =
	    MSG_GRP_SIMULATOR_1 + 0xdc, MSG_SIMULATOR_MS_SENDDETACHREQ =
	    MSG_GRP_SIMULATOR_1 + 0xde, MSG_SIMULATOR_MS_SETCURRENTPLMN =
	    MSG_GRP_SIMULATOR_1 + 0xe0, MSG_SIMULATOR_MS_SETPLMNFORMAT =
	    MSG_GRP_SIMULATOR_1 + 0xe2, MSG_SIMULATOR_MS_SETPLMNMODE =
	    MSG_GRP_SIMULATOR_1 + 0xe4, MSG_SIMULATOR_MS_SETPOWERDOWNTIMER =
	    MSG_GRP_SIMULATOR_1 + 0xe6, MSG_SIMULATOR_MS_SETSTARTBAND =
	    MSG_GRP_SIMULATOR_1 + 0xe8, MSG_SIMULATOR_PBK_GETALPHA =
	    MSG_GRP_SIMULATOR_1 + 0xea,
	    MSG_SIMULATOR_PBK_ISEMERGENCYCALLNUMBER =
	    MSG_GRP_SIMULATOR_1 + 0xec, MSG_SIMULATOR_PBK_ISREADY =
	    MSG_GRP_SIMULATOR_1 + 0xee,
	    MSG_SIMULATOR_PBK_SENDFINDALPHAMATCHMULTIPLEREQ =
	    MSG_GRP_SIMULATOR_1 + 0xf0,
	    MSG_SIMULATOR_PBK_SENDFINDALPHAMATCHONEREQ =
	    MSG_GRP_SIMULATOR_1 + 0xf2, MSG_SIMULATOR_PBK_SENDINFOREQ =
	    MSG_GRP_SIMULATOR_1 + 0xf4,
	    MSG_SIMULATOR_PBK_SENDISNUMDIALLABLEREQ =
	    MSG_GRP_SIMULATOR_1 + 0xf6, MSG_SIMULATOR_PBK_SENDREADENTRYREQ =
	    MSG_GRP_SIMULATOR_1 + 0xf8, MSG_SIMULATOR_PBK_SENDWRITEENTRYREQ =
	    MSG_GRP_SIMULATOR_1 + 0xfa,
	    MSG_SIMULATOR_PDP_ACTIVATESNDCPCONNECTION =
	    MSG_GRP_SIMULATOR_1 + 0xfc,
	    ...
	    MSG_SIMULATOR_PDP_GETGPRSACTIVATESTATUS =
	    MSG_GRP_SIMULATOR_2 + 0x02, MSG_SIMULATOR_PDP_GETGPRSMINQOS =
	    MSG_GRP_SIMULATOR_2 + 0x04, MSG_SIMULATOR_PDP_GETGPRSMTPDPAUTORSP =
	    MSG_GRP_SIMULATOR_2 + 0x06, MSG_SIMULATOR_PDP_GETGPRSQOS =
	    MSG_GRP_SIMULATOR_2 + 0x08, MSG_SIMULATOR_PDP_GETMSCLASS =
	    MSG_GRP_SIMULATOR_2 + 0x0a, MSG_SIMULATOR_PDP_GETPDPADDRESS =
	    MSG_GRP_SIMULATOR_2 + 0x0c, MSG_SIMULATOR_PDP_GETPDPCONTEXT =
	    MSG_GRP_SIMULATOR_2 + 0x0e,
	    MSG_SIMULATOR_PDP_SENDMTPDPACTIVATIONRSP =
	    MSG_GRP_SIMULATOR_2 + 0x10, MSG_SIMULATOR_PDP_SENDPDPACTIVATEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x12,
	    MSG_SIMULATOR_PDP_SENDPDPDEACTIVATEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x14, MSG_SIMULATOR_PDP_SETGPRSMINQOS =
	    MSG_GRP_SIMULATOR_2 + 0x16, MSG_SIMULATOR_PDP_SETGPRSMTPDPAUTORSP =
	    MSG_GRP_SIMULATOR_2 + 0x18, MSG_SIMULATOR_PDP_SETGPRSQOS =
	    MSG_GRP_SIMULATOR_2 + 0x1a, MSG_SIMULATOR_PDP_SETMSCLASS =
	    MSG_GRP_SIMULATOR_2 + 0x1c, MSG_SIMULATOR_PDP_SETPDPCONTEXT =
	    MSG_GRP_SIMULATOR_2 + 0x1e, MSG_SIMULATOR_RECV =
	    MSG_GRP_SIMULATOR_2 + 0x20, MSG_SIMULATOR_RTC_ALARMREGISTER =
	    MSG_GRP_SIMULATOR_2 + 0x22, MSG_SIMULATOR_RTC_CACULWEEKDAY =
	    MSG_GRP_SIMULATOR_2 + 0x24, MSG_SIMULATOR_RTC_CHECKTIME =
	    MSG_GRP_SIMULATOR_2 + 0x26, MSG_SIMULATOR_RTC_DISABLEALARM =
	    MSG_GRP_SIMULATOR_2 + 0x28, MSG_SIMULATOR_RTC_DISABLEMINUTEINT =
	    MSG_GRP_SIMULATOR_2 + 0x2a, MSG_SIMULATOR_RTC_ENABLEALARM =
	    MSG_GRP_SIMULATOR_2 + 0x2c, MSG_SIMULATOR_RTC_FIREALARM =
	    MSG_GRP_SIMULATOR_2 + 0x2d, MSG_SIMULATOR_RTC_ENABLEMINUTEINT =
	    MSG_GRP_SIMULATOR_2 + 0x2e, MSG_SIMULATOR_RTC_GETALARMTIME =
	    MSG_GRP_SIMULATOR_2 + 0x30, MSG_SIMULATOR_RTC_GETCOUNT =
	    MSG_GRP_SIMULATOR_2 + 0x32, MSG_SIMULATOR_RTC_GETTIME =
	    MSG_GRP_SIMULATOR_2 + 0x34, MSG_SIMULATOR_RTC_OFFSETTODATE =
	    MSG_GRP_SIMULATOR_2 + 0x36, MSG_SIMULATOR_RTC_SETALARMTIME =
	    MSG_GRP_SIMULATOR_2 + 0x38, MSG_SIMULATOR_RTC_SETTIME =
	    MSG_GRP_SIMULATOR_2 + 0x3a, MSG_SIMULATOR_RTC_TIMEREGISTER =
	    MSG_GRP_SIMULATOR_2 + 0x3c, MSG_SIMULATOR_SATKCMDRESP =
	    MSG_GRP_SIMULATOR_2 + 0x3e, MSG_SIMULATOR_SELECT =
	    MSG_GRP_SIMULATOR_2 + 0x40, MSG_SIMULATOR_SEND =
	    MSG_GRP_SIMULATOR_2 + 0x42, MSG_SIMULATOR_SENDPPPCLOSEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x44, MSG_SIMULATOR_SENDPPPOPENREQ =
	    MSG_GRP_SIMULATOR_2 + 0x46, MSG_SIMULATOR_SENDPPPPDU =
	    MSG_GRP_SIMULATOR_2 + 0x48, MSG_SIMULATOR_SENDSMSREQ =
	    MSG_GRP_SIMULATOR_2 + 0x4a,
	    MSG_SIMULATOR_SENDSMSSRVCENTERNUMBERUPDATEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x4c, MSG_SIMULATOR_SENDSNPDUREQ =
	    MSG_GRP_SIMULATOR_2 + 0x4e, MSG_SIMULATOR_SERIAL_CLOSEDEVICE =
	    MSG_GRP_SIMULATOR_2 + 0x50, MSG_SIMULATOR_SERIAL_OPENDEVICE =
	    MSG_GRP_SIMULATOR_2 + 0x52, MSG_SIMULATOR_SERIAL_READ =
	    MSG_GRP_SIMULATOR_2 + 0x54,
	    MSG_SIMULATOR_SERIAL_REGISTEREVENTHANDLER =
	    MSG_GRP_SIMULATOR_2 + 0x56, MSG_SIMULATOR_SERIAL_WRITE =
	    MSG_GRP_SIMULATOR_2 + 0x58, MSG_SIMULATOR_SETSMSBEARERPREFERENCE =
	    MSG_GRP_SIMULATOR_2 + 0x5a, MSG_SIMULATOR_SETSOCKOPT =
	    MSG_GRP_SIMULATOR_2 + 0x5c, MSG_SIMULATOR_SETV24DCD =
	    MSG_GRP_SIMULATOR_2 + 0x5e,
	    MSG_SIMULATOR_SETV24OPERATIONMODEUINT8 =
	    MSG_GRP_SIMULATOR_2 + 0x60, MSG_SIMULATOR_SETV24RI =
	    MSG_GRP_SIMULATOR_2 + 0x62, MSG_SIMULATOR_SHUTDOWN =
	    MSG_GRP_SIMULATOR_2 + 0x64, MSG_SIMULATOR_SIM_GETCARDPHASE =
	    MSG_GRP_SIMULATOR_2 + 0x66, MSG_SIMULATOR_SIM_GETCPHSPHASE =
	    MSG_GRP_SIMULATOR_2 + 0x68, MSG_SIMULATOR_SIM_GETHOMEPLMN =
	    MSG_GRP_SIMULATOR_2 + 0x6a, MSG_SIMULATOR_SIM_GETIMSI =
	    MSG_GRP_SIMULATOR_2 + 0x6c, MSG_SIMULATOR_SIM_GETPINSTATUS =
	    MSG_GRP_SIMULATOR_2 + 0x6e, MSG_SIMULATOR_SIM_GETPRESENTSTATUS =
	    MSG_GRP_SIMULATOR_2 + 0x70, MSG_SIMULATOR_SIM_GETSIMTYPE =
	    MSG_GRP_SIMULATOR_2 + 0x72, MSG_SIMULATOR_SIM_GETSMSSCA =
	    MSG_GRP_SIMULATOR_2 + 0x74, MSG_SIMULATOR_SIM_GETSMSSTATUS =
	    MSG_GRP_SIMULATOR_2 + 0x76, MSG_SIMULATOR_SIM_GETSMSTOTALNUMBER =
	    MSG_GRP_SIMULATOR_2 + 0x78, MSG_SIMULATOR_SIM_ISCACHEDDATAREADY =
	    MSG_GRP_SIMULATOR_2 + 0x7a,
	    MSG_SIMULATOR_SIM_ISOPERATIONRESTRICTED =
	    MSG_GRP_SIMULATOR_2 + 0x7c, MSG_SIMULATOR_SIM_ISPIN2VERIFIED =
	    MSG_GRP_SIMULATOR_2 + 0x7e, MSG_SIMULATOR_SIM_ISPINBLOCKED =
	    MSG_GRP_SIMULATOR_2 + 0x80, MSG_SIMULATOR_SIM_ISPINOK =
	    MSG_GRP_SIMULATOR_2 + 0x82, MSG_SIMULATOR_SIM_ISPINREQUIRED =
	    MSG_GRP_SIMULATOR_2 + 0x84, MSG_SIMULATOR_SIM_ISPINVERIFIED =
	    MSG_GRP_SIMULATOR_2 + 0x86,
	    MSG_SIMULATOR_SIM_SENDBINARYEFILEREADREQ =
	    MSG_GRP_SIMULATOR_2 + 0x88,
	    MSG_SIMULATOR_SIM_SENDBINARYEFILEUPDATEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x8a, MSG_SIMULATOR_SIM_SENDCHANGECHVREQ =
	    MSG_GRP_SIMULATOR_2 + 0x8c,
	    MSG_SIMULATOR_SIM_SENDCYCLICEFILEUPDATEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x8e, MSG_SIMULATOR_SIM_SENDEFILEINFOREQ =
	    MSG_GRP_SIMULATOR_2 + 0x90, MSG_SIMULATOR_SIM_SENDINCREASEACMREQ =
	    MSG_GRP_SIMULATOR_2 + 0x92,
	    MSG_SIMULATOR_SIM_SENDLINEAREFILEUPDATEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x94, MSG_SIMULATOR_SIM_SENDREADACMMAXREQ =
	    MSG_GRP_SIMULATOR_2 + 0x96, MSG_SIMULATOR_SIM_SENDREADACMREQ =
	    MSG_GRP_SIMULATOR_2 + 0x98, MSG_SIMULATOR_SIM_SENDREADPUCTREQ =
	    MSG_GRP_SIMULATOR_2 + 0x9a,
	    MSG_SIMULATOR_SIM_SENDREADSVCPROVNAMEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x9c,
	    MSG_SIMULATOR_SIM_SENDRECORDEFILEREADREQ =
	    MSG_GRP_SIMULATOR_2 + 0x9e,
	    MSG_SIMULATOR_SIM_SENDREMAININGPINATTEMPTREQ =
	    MSG_GRP_SIMULATOR_2 + 0xa0, MSG_SIMULATOR_SIM_SENDSETCHV1ONOFFREQ =
	    MSG_GRP_SIMULATOR_2 + 0xa2, MSG_SIMULATOR_SIM_SENDSETOPERSTATEREQ =
	    MSG_GRP_SIMULATOR_2 + 0xa4, MSG_SIMULATOR_SIM_SENDUNBLOCKCHVREQ =
	    MSG_GRP_SIMULATOR_2 + 0xa6, MSG_SIMULATOR_SIM_SENDVERIFYCHVREQ =
	    MSG_GRP_SIMULATOR_2 + 0xaa,
	    MSG_SIMULATOR_SIM_SENDWHOLEBINARYEFILEREADREQ =
	    MSG_GRP_SIMULATOR_2 + 0xac, MSG_SIMULATOR_SIM_SENDWRITEACMMAXREQ =
	    MSG_GRP_SIMULATOR_2 + 0xae, MSG_SIMULATOR_SIM_SENDWRITEACMREQ =
	    MSG_GRP_SIMULATOR_2 + 0xb0, MSG_SIMULATOR_SIM_SENDWRITEPUCTREQ =
	    MSG_GRP_SIMULATOR_2 + 0xb2,
	    MSG_SIMULATOR_SIMLOCKCHANGEPHONELOCKPASSWORD =
	    MSG_GRP_SIMULATOR_2 + 0xb4, MSG_SIMULATOR_SIMLOCKCHECKALLLOCKS =
	    MSG_GRP_SIMULATOR_2 + 0xb6,
	    MSG_SIMULATOR_SIMLOCKGETCURRENTCLOSEDLOCK =
	    MSG_GRP_SIMULATOR_2 + 0xb8, MSG_SIMULATOR_SIMLOCKISLOCKON =
	    MSG_GRP_SIMULATOR_2 + 0xba,
	    MSG_SIMULATOR_SIMLOCKSETDEFAULTPHONELOCK =
	    MSG_GRP_SIMULATOR_2 + 0xbc, MSG_SIMULATOR_SIMLOCKSETLOCK =
	    MSG_GRP_SIMULATOR_2 + 0xbe, MSG_SIMULATOR_SIMLOCKUNLOCKSIM =
	    MSG_GRP_SIMULATOR_2 + 0xc0, MSG_SIMULATOR_SLEEP_ALLOCID =
	    MSG_GRP_SIMULATOR_2 + 0xc2, MSG_SIMULATOR_SLEEP_CONFIGDEEPSLEEP =
	    MSG_GRP_SIMULATOR_2 + 0xc4, MSG_SIMULATOR_SLEEP_DISABLEDEEPSLEEP =
	    MSG_GRP_SIMULATOR_2 + 0xc6, MSG_SIMULATOR_SLEEP_ENABLEDEEPSLEEP =
	    MSG_GRP_SIMULATOR_2 + 0xc8, MSG_SIMULATOR_SLEEP_INIT =
	    MSG_GRP_SIMULATOR_2 + 0xca, MSG_SIMULATOR_SMS_SEND_SMS_REQ =
	    MSG_GRP_SIMULATOR_2 + 0xd0, MSG_SIMULATOR_SMS_SEND_SMS_PDU_REQ =
	    MSG_GRP_SIMULATOR_2 + 0xd1, MSG_SIMULATOR_SMS_SEND_ACK_TO_NETWORK =
	    MSG_GRP_SIMULATOR_2 + 0xd2, MSG_SIMULATOR_SOCKET =
	    MSG_GRP_SIMULATOR_3 + 0x10, MSG_SIMULATOR_SOCKETCLOSE =
	    MSG_GRP_SIMULATOR_3 + 0x12, MSG_SIMULATOR_SS_ENDUSSDCONNECTREQ =
	    MSG_GRP_SIMULATOR_3 + 0x14,
	    MSG_SIMULATOR_SS_QUERYCALLBARRINGSTATUS =
	    MSG_GRP_SIMULATOR_3 + 0x16,
	    MSG_SIMULATOR_SS_QUERYCALLFORWARDSTATUS =
	    MSG_GRP_SIMULATOR_3 + 0x18,
	    MSG_SIMULATOR_SS_QUERYCALLINGLINEIDSTATUS =
	    MSG_GRP_SIMULATOR_3 + 0x1a,
	    MSG_SIMULATOR_SS_QUERYCALLINGLINERESTRICTIONSTATUS =
	    MSG_GRP_SIMULATOR_3 + 0x1c,
	    MSG_SIMULATOR_SS_QUERYCALLWAITINGSTATUS =
	    MSG_GRP_SIMULATOR_3 + 0x1e,
	    ...
	    MSG_GRP_SIMULATOR_3 + 0x24, MSG_SIMULATOR_SS_SENDCALLBARRINGREQ =
	    MSG_GRP_SIMULATOR_3 + 0x26, MSG_SIMULATOR_SS_SENDCALLFORWARDREQ =
	    MSG_GRP_SIMULATOR_3 + 0x28, MSG_SIMULATOR_SS_SENDCALLWAITINGREQ =
	    MSG_GRP_SIMULATOR_3 + 0x2a, MSG_SIMULATOR_SS_SENDUSSDCONNECTREQ =
	    MSG_GRP_SIMULATOR_3 + 0x2c, MSG_SIMULATOR_SS_SENDUSSDDATA =
	    MSG_GRP_SIMULATOR_3 + 0x2e, MSG_SIMULATOR_SYS_CLIENTINIT =
	    MSG_GRP_SIMULATOR_3 + 0x30, MSG_SIMULATOR_SYS_CLIENTRUN =
	    MSG_GRP_SIMULATOR_3 + 0x32,
	    MSG_SIMULATOR_SYS_DEREGISTERFORMSEVENT =
	    MSG_GRP_SIMULATOR_3 + 0x34, MSG_SIMULATOR_SYS_GETRSSITHRESHOLD =
	    MSG_GRP_SIMULATOR_3 + 0x36, MSG_SIMULATOR_SYS_GETRXSIGNALINFO =
	    MSG_GRP_SIMULATOR_3 + 0x38, MSG_SIMULATOR_SYS_ISBANDSUPPORTED =
	    MSG_GRP_SIMULATOR_3 + 0x3a, MSG_SIMULATOR_SYS_PROCESSNORFREQ =
	    MSG_GRP_SIMULATOR_3 + 0x3c, MSG_SIMULATOR_SYS_PROCESSPOWERDOWNREQ =
	    MSG_GRP_SIMULATOR_3 + 0x3e, MSG_SIMULATOR_SYS_PROCESSPOWERUPREQ =
	    MSG_GRP_SIMULATOR_3 + 0x40, MSG_SIMULATOR_SYS_REGISTERFORMSEVENT =
	    MSG_GRP_SIMULATOR_3 + 0x42, MSG_SIMULATOR_SYS_SELECTBAND =
	    MSG_GRP_SIMULATOR_3 + 0x44, MSG_SIMULATOR_SYS_SETRSSITHRESHOLD =
	    MSG_GRP_SIMULATOR_3 + 0x46, MSG_SIMULATOR_V24REGISTERCALLBACK =
	    MSG_GRP_SIMULATOR_3 + 0x48, MSG_SIMULATOR_V24SEND =
	    MSG_GRP_SIMULATOR_3 + 0x4a, MSG_SIMULATOR_CALLBACKMSG =
	    MSG_GRP_SIMULATOR_3 + 0x4c, MSG_SIMULATOR_CC_REPORTCALLMETERVAL =
	    MSG_GRP_SIMULATOR_3 + 0x4e, MSG_SIMULATOR_SIM_GET_SMSMEMEXC_FLAG =
	    MSG_GRP_SIMULATOR_3 + 0x50, MSG_SIMULATOR_SIM_IS_TEST_SIM =
	    MSG_GRP_SIMULATOR_3 + 0x52,
	    MSG_SIMULATOR_SIM_UPDATE_SMSCAPEXC_FLAG =
	    MSG_GRP_SIMULATOR_3 + 0x54, 
#endif //UNDER_CE
...
//TASKMSGS_INCLUDE taskmsgs_capi2.i
	    ...
	    //---------------------------------------------------
	    MSG_CAPI2_SS_REQ_START =
	    MSG_GRP_CAPI2_SS + 0x00, MSG_CAPI2_SS_REQ_END =
	    MSG_GRP_CAPI2_SS + 0xFF, 
	    //---------------------------------------------------
	    // MSG_GRP_CAPI2_UTIL,  (0x3E00)
	    //---------------------------------------------------
	...
	MSG_CAPI2_UNDETERMINED_RSP =
	    MSG_GRP_CAPI2_PRIVATE + 0xFC, MSG_CAPI2_RECV_MSG_FROM_AP =
	    MSG_GRP_CAPI2_PRIVATE + 0xFD, MSG_CAPI2_ACK_RSP =
	    MSG_GRP_CAPI2_PRIVATE + 0xFE, 
	    //---------------------------------------------------
...
//MSG_GEN_REQ_START = 0x0
	...
	**/ 
	...
	payload is ::Result_t 
	**/ 
	    MSG_SMS_SENDSMSSRVCENTERNUMBERUPDATE_RSP =
	    MSG_GRP_CAPI2_GEN_0 + 0x27B, 
	 /** 
	...
	**/ 
	...
	payload is void 
	**/ 
	    MSG_SMS_SETSMSREADSTATUSCHANGEMODE_RSP =
	    MSG_GRP_CAPI2_GEN_0 + 0x2E5, 
	 /** 
	api is CAPI2_SmsApi_GetSmsReadStatusChangeMode 
	**/ 
	    MSG_SMS_GETSMSREADSTATUSCHANGEMODE_REQ =
	    MSG_GRP_CAPI2_GEN_0 + 0x2E6, 
	 /** 
	payload is ::Boolean 
	**/ 
	...
	**/ 
	    MSG_SS_QUERYCALLINGLINERESTRICTIONSTATUS_REQ =
	    MSG_GRP_CAPI2_SS + 0x14, 
	 /** 
	...
	**/ 
	...
	payload is void 
	**/ 
	    MSG_SS_RESETCLIENTID_RSP =
	    MSG_GRP_CAPI2_SS + 0x3D, MSG_GRP_CAPI2_SS_END =
	    MSG_GRP_CAPI2_SS + 0xFF, 
	 /** 
	...
	**/ 
	...
	payload is ::Result_t 
	**/ 
	    MSG_SIM_PEROFRM_STEERING_OF_ROAMING_RSP =
	    MSG_GRP_CAPI2_GEN_0 + 0x4D3, 
	 /** 
...
**/ 
    InterTaskMsg_t * AllocInterTaskMsgFromHeap(MsgType_t msgType,
					       UInt16 dataLength);
...
**/ 
    UInt8 VccApi_ActivateVmfCtx(ClientInfo_t * inClientInfoPtr,
