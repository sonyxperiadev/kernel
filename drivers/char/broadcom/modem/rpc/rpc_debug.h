...
extern void RpcDbgLogGenInfo(char* logStr, UInt8 cid, UInt32 pktHandle, UInt32 cmd1, UInt32 cmd2);
...
#define HISTORY_RPC_LOG_CID(logStr, cid) HISTORY_RPC_LOG(logStr , cid, 0, 0,  0)
#define HISTORY_RPC_LOG_PKT(logStr, cid, pktHandle) HISTORY_RPC_LOG(logStr , cid, pktHandle,  0, 0)
...
void RpcDbgUpdatePktStateEx(UInt32 pktHandle, UInt32 pktstatus, UInt8 cid, UInt32 cidPktStatus, UInt8 context1, UInt16 context2, UInt32 itype);
#define RpcDbgUpdatePktState(a, b) RpcDbgUpdatePktStateEx(a, b, 0, 0, 0, 0, 0xFF)
