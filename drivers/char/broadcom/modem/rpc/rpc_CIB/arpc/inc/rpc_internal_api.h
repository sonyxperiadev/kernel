...
Result_t RPC_SendAck(UInt32 tid, UInt8 clientID,
			     RPC_ACK_Result_t ackResult, UInt32 ackUsrData,
			     UInt8 clientIndex);
...
UInt32 RPC_GetMaxPktSize(PACKET_InterfaceType_t interfaceType,
				 UInt32 size);
