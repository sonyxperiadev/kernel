...
//***************** < 6 > **********************
	...
	{ MSG_SYS_SIMLOCK_SET_STATUS_REQ,_T("MSG_SYS_SIMLOCK_SET_STATUS_REQ"), (xdrproc_t) xdr_SYS_SIMLOCKApi_SetStatus_Req_t, 0, 0},
	{ MSG_SYS_SIMLOCK_SET_STATUS_RSP,_T("MSG_SYS_SIMLOCK_SET_STATUS_RSP"), (xdrproc_t) xdr_default_proc, 0, 0 },
	{ MSG_SYS_GET_CUR_SIMLOCK_TYPE_REQ,_T("MSG_SYS_GET_CUR_SIMLOCK_TYPE_REQ"), (xdrproc_t) xdr_default_proc, 0, 0},
...
//***************** < 7 > **********************
	...
	SYS_SIMLOCKApi_SetStatus_Req_t   SYS_SIMLOCKApi_SetStatus_Req;
	SYS_SimApi_GetCurrLockedSimlockType_Rsp_t   SYS_SimApi_GetCurrLockedSimlockType_Rsp;
