...
Result_t AT_SendRpcMsg(UInt32 tid, UInt32 msgId, void *val);
...
Result_t AT_RPCTone(Boolean turn_on, UInt8 tone, UInt32 duration);
Result_t AT_RPCAudioPath(Boolean turn_on);
