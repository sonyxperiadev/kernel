...
#define AT_RANGE_SPECIAL		10      /// printable ascii chars allowed
#define AT_RANGE_SCALAR_INT32   11      /// value is a scalar Int32
#define AT_RANGE_MINMAX_INT32   12      /// two consecutive values are Int32 min and max
