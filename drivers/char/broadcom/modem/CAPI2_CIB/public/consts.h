...
*   @file   consts.h
*
*   @brief  This file contains definitions for global constants of
*			mobile station processor software component.
*
****************************************************************************/
...
#define	BIT03_MASK		(1 << BIT03)
#define	BIT04_MASK		(1 << BIT04)
#define	BIT05_MASK		(1 << BIT05)
#define	BIT06_MASK		(1 << BIT06)
#define	BIT07_MASK		(1 << BIT07)
#define	BIT08_MASK		(1 << BIT08)
#define	BIT09_MASK		(1 << BIT09)
#define	BIT10_MASK		(1 << BIT10)
#define	BIT11_MASK		(1 << BIT11)
#define	BIT12_MASK		(1 << BIT12)
#define	BIT13_MASK		(1 << BIT13)
#define	BIT14_MASK		(1 << BIT14)
#define	BIT15_MASK		(1 << BIT15)
#define	BIT16_MASK		(1 << BIT16)
#define	BIT17_MASK		(1 << BIT17)
#define	BIT18_MASK		(1 << BIT18)
#define	BIT19_MASK		(1 << BIT19)
#define	BIT20_MASK		(1 << BIT20)
#define	BIT21_MASK		(1 << BIT21)
#define	BIT22_MASK		(1 << BIT22)
#define	BIT23_MASK		(1 << BIT23)
#define	BIT24_MASK		(1 << BIT24)
#define	BIT25_MASK		(1 << BIT25)
#define	BIT26_MASK		(1 << BIT26)
#define	BIT27_MASK		(1 << BIT27)
#define	BIT28_MASK		(1 << BIT28)
#define	BIT29_MASK		(1 << BIT29)
