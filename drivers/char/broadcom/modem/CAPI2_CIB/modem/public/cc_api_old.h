...
/**
	...
	@param		callIndex (in) Index of call
	@param		cnapName (out) pointer to the CNAP name string (UCS2 capable).
	@param		nameLength (out) CNAP name string length
	@param		nameCoding (out) CNAP name coding format
	@return		None 
	@note 
...
void	CC_GetCNAPName(UInt8 callIndex, const UInt8** cnapName, UInt8* nameLength, ALPHA_CODING_t* nameCoding); 
