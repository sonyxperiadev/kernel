...
static long s5k5ccgx_ss_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
...
static int s5k5ccgx_power(bool bOn)
{
	if(bOn)
	{
...
static int s5k5ccgx_get_light_condition(struct v4l2_subdev *sd, int *Result)
{
#if 0
    struct i2c_client *client = v4l2_get_subdevdata(sd);	
...
/* mandatory*/
	sensor->thumbnail_ioctl			       = s5k5ccgx_ss_ioctl;
/*optional*/
	sensor->get_shutterspeed		   = s5k5ccgx_get_shutterspeed;
	sensor->get_iso_speed_rate        = s5k5ccgx_get_iso_speed_rate;
	sensor->get_ae_stable_status      =  s5k5ccgx_get_ae_stable_status;
	sensor->get_auto_focus_status     = s5k5ccgx_get_auto_focus_status;
//	sensor->set_touch_auto_focus      = s5k5ccgx_set_touch_auto_focus;
//	sensor->AAT_flash_control    	   = s5k5ccgx_AAT_flash_control;
//	sensor->i2c_set_data_burst   	   = s5k5ccgx_i2c_set_data_burst;
	sensor->check_flash_needed   	   = s5k5ccgx_check_flash_needed;
//	sensor->get_light_condition   = s5k5ccgx_get_light_condition;
	...
	sensor->rows_num_sharpness_plus_1_regs	 =	ARRAY_SIZE(s5k5ccgx_sharpness_plus_2_regs);
	...
	sensor->rows_num_quality_fine_regs	  = ARRAY_SIZE(s5k5ccgx_effect_normal_regs);

	sensor->quality_normal_regs 		   =	s5k5ccgx_quality_normal_regs;
	sensor->rows_num_quality_normal_regs  = ARRAY_SIZE(s5k5ccgx_effect_normal_regs);

	sensor->quality_economy_regs			 =	s5k5ccgx_quality_economy_regs;
	sensor->rows_num_quality_economy_regs   = ARRAY_SIZE(s5k5ccgx_effect_normal_regs);
