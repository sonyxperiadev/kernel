...
#define OV5640_TIMING_HS_HIGH           0x3800
#define OV5640_TIMING_HS_LOW            0x3801
#define OV5640_TIMING_VS_HIGH           0x3802
#define OV5640_TIMING_VS_LOW            0x3803
#define OV5640_TIMING_HW_HIGH           0x3804
#define OV5640_TIMING_HW_LOW            0x3805
#define OV5640_TIMING_VH_HIGH           0x3806
#define OV5640_TIMING_VH_LOW            0x3807
#define OV5640_TIMING_DVPHO_HIGH        0x3808
#define OV5640_TIMING_DVPHO_LOW         0x3809
#define OV5640_TIMING_DVPVO_HIGH        0x380A
#define OV5640_TIMING_DVPVO_LOW         0x380B
#define OV5640_TIMING_HTS_HIGH          0x380C
#define OV5640_TIMING_HTS_LOW           0x380D
#define OV5640_TIMING_VTS_HIGH          0x380E
#define OV5640_TIMING_VTS_LOW           0x380F
#define OV5640_TIMING_HOFFSET_HIGH      0x3810
#define OV5640_TIMING_HOFFSET_LOW       0x3811
#define OV5640_TIMING_VOFFSET_HIGH      0x3812
#define OV5640_TIMING_VOFFSET_LOW       0x3813
#define OV5640_TIMING_X_INC             0x3814
#define OV5640_TIMING_Y_INC             0x3815
#define OV5640_TIMING_HSYNC_START_HIGH  0x3816
#define OV5640_TIMING_HSYNC_START_LOW   0x3817
#define OV5640_TIMING_HSYNC_WIDTH_HIGH  0x3818
#define OV5640_TIMING_HSYNC_WIDTH_LOW   0x3819
#define OV5640_TIMING_VLIP              0x3820
#define OV5640_TIMING_MIRROR            0x3821

#define OV5640_SYSTEM_ROOT_DIVIDER      0x3108
#define OV5640_SC_PLL_CTRL1             0x3035
#define OV5640_FORMAT_CTRL              0x4300
#define OV5640_FRAME_CTRL1              0x4201
#define OV5640_FRAME_CTRL2              0x4202
...
//system
	...
	{0x3a19, 0x78},		// gain ceiling--f8,20120620
	{0x3635, 0x13},
	{0x3636, 0x03},
	{0x3634, 0x40},
	{0x3622, 0x01},
...
// CIP
	{0x5308, 0x75},		//25
	{0x5300, 0x08},		//;8x gain, 0x08/0x08=1x
	{0x5301, 0x10},		//;2x gain, 0x20/0x02=16x
	{0x5302, 0x04},		//30
	{0x5303, 0x00},
	{0x5309, 0x08},		//;8x gain, 0x08/0x08=1x
	{0x530a, 0x10},		//;2x gain, 0x20/0x02=16x
	{0x530b, 0x04},
	{0x530c, 0x10},

	//De-No,
	{0x5304, 0x0c},		//;8x gain, 0x08/0x08=1x
	{0x5305, 0x20},		//;2x gain, 0x20/0x02=16x
	{0x5306, 0x18},		//10
	{0x5307, 0x20},
...
// Kimi@20120721 for Turnkey Truly sensor
	...
	/* @@ Whole Image Average */
	//{8, 0x5688, 0x11},     /* Zone 1/Zone 0 weight */
	//{8, 0x5689, 0x11},     /* Zone 3/Zone 2 weight */
	//{8, 0x569a, 0x11},     /* Zone 5/Zone 4 weight */
	//{8, 0x569b, 0x11},     /* Zone 7/Zone 6 weight */
	//{8, 0x569c, 0x11},     /* Zone 9/Zone 8 weight */
	//{8, 0x569d, 0x11},     /* Zone b/Zone a weight */
	//{8, 0x569e, 0x11},     /* Zone d/Zone c weight */
	//{8, 0x569f, 0x11},     /* Zone f/Zone e weight */

	//AE Target
	//{8, 0x3a0f, 0x30}, // stable in high
	//{8, 0x3a10, 0x28}, // stable in low
	//{8, 0x3a1b, 0x30}, // stable out high
	//{8, 0x3a1e, 0x26}, // stable out low
	//{8, 0x3a11, 0x60}, // fast zone high
	//{8, 0x3a1f, 0x14}, // fast zone low
	{0x3a0f, 0x38},		//0x38 stable in high
	{0x3a10, 0x30},		//0x30 stable in low
	{0x3a11, 0x61},		//0x61 fast zone high
	{0x3a1b, 0x38},		//0x38 stable out high
	{0x3a1e, 0x30},		//0x30 stable out low
	{0x3a1f, 0x10},		//0x10 fast zone low
...
//---------------------
	...
	{0x3035, 0x11},
	//{8, 0x3036, 0x46}, //Kimi set to 20 fps @20120930
	//{8, 0x3036, 0x68}, //Kimi set to 30 fps @20120930
	...
	{0x3820, 0x46},		// ISP flip off, sensor flip off  --- for Turnkey
	{0x3821, 0x01},		// ISP mirror on, sensor mirror on --- for Turnkey
	...
	{0x3709, 0x52},
	{0x370c, 0x03},
	{0x3a02, 0x07},		// 60Hz max exposure, 10fps
	{0x3a03, 0xb0},		// 60Hz max exposure
	{0x3a14, 0x07},		// 50Hz max exposure, 10fps
...
static const struct ov5640_reg configscript_common1_back[] = {
	/* System Control */
	{0x3103, 0x11},
