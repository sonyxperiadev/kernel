...
/************************/
	...
	int rows_num_fmts;
	const struct v4l2_ctrl_config *controls;
...
/* Optional */
	...
	int (*set_capture_start)(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
	...
	int (*get_ae_stable_status)(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
	int (*set_auto_focus)(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
	int (*get_auto_focus_status)(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
	...
	int  (*get_touch_focus_status)(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
	...
	int (*set_scene_mode)(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);  /* denis */
	void (*smartStayChangeInitSetting)(struct camdrv_ss_sensor_cap *sensor);
        int(* get_prefalsh_on) (struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl); //Backporting Rhea to Hawaii: added to call sensor Specific preflash rotuine
