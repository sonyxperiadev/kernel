...
#elif defined(CONFIG_MACH_JAVA_SS_VICTOR3G)
...
static const struct v4l2_ctrl_config sr030pc50_controls[] = {
	...
	
	{
		...
		.type		= V4L2_CTRL_TYPE_INTEGER,
		.name		= "Focus",
		.min	    = FOCUS_MODE_INFINITY,
		.max		=  (1 << FOCUS_MODE_INFINITY),
		.step		= 1,
		.def		= FOCUS_MODE_INFINITY,
		.flags 	= 0,
	},	
