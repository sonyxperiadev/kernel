...
static char cabc_on_off_id_00[] = {
	0xBB, 0x00
};
static char cabc_user_param_id_00[] = {
...
static struct dsi_cmd_desc tmd_display_init_cmds_id_old[] = {
	...
	{DTYPE_GEN_WRITE2, 1, 0, 0, 0,
		sizeof(cabc_on_off_id_00), cabc_on_off_id_00},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0,
		sizeof(cabc_user_param_id_00), cabc_user_param_id_00},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0,
