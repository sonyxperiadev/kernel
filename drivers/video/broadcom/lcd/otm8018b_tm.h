...
*
* @file drivers/video/broadcom/lcd/otm8018b_tm.h
*
...
#ifndef __OTM8018B_TM_H__
#define __OTM8018B_TM_H__

#include "display_drv.h"
#include "lcd.h"

#define OTM8018B_TM_CMD_SLPIN 0x10
#define OTM8018B_TM_CMD_SLPOUT 0x11
#define OTM8018B_TM_CMD_DISPOFF 0x28
#define OTM8018B_TM_CMD_DISPON 0x29
#define OTM8018B_TM_CMD_RDID1     0xDA
#define OTM8018B_TM_CMD_RDID2     0xDB
#define OTM8018B_TM_CMD_RDID3     0xDC

#define OTM8018B_TM_UPDT_WIN_SEQ_LEN 13 /* (6 + 6 + 1) */


__initdata struct DSI_COUNTER otm8018b_tm_timing[] = {
...
__initdata DISPCTRL_REC_T otm8018b_tm_scrn_on[] = {
	{DISPCTRL_WR_CMND, OTM8018B_TM_CMD_DISPON},
	{DISPCTRL_SLEEP_MS, 20},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8018b_tm_scrn_off[] = {
	{DISPCTRL_WR_CMND, OTM8018B_TM_CMD_DISPOFF},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8018b_tm_id[] = {
	{DISPCTRL_WR_CMND, OTM8018B_TM_CMD_RDID1},
	{DISPCTRL_WR_DATA, 0x40},
	{DISPCTRL_WR_CMND, OTM8018B_TM_CMD_RDID2},
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_WR_CMND, OTM8018B_TM_CMD_RDID3},
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8018b_tm_slp_in[] = {
	{DISPCTRL_WR_CMND, OTM8018B_TM_CMD_DISPOFF},
	{DISPCTRL_WR_CMND, OTM8018B_TM_CMD_SLPIN},
	{DISPCTRL_SLEEP_MS, 120},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8018b_tm_slp_out[] = {
	{DISPCTRL_WR_CMND, OTM8018B_TM_CMD_SLPOUT},
	{DISPCTRL_SLEEP_MS, 120},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8018b_tm_init_panel_vid[] = {
...
__initdata struct lcd_config otm8018b_tm_cfg = {
	.name = "OTM8018B_TM",
	.mode_supp = LCD_VID_ONLY,
	.phy_timing = &otm8018b_tm_timing[0],
	.max_lanes = 2,
	...
	.phys_height = 99,
	.init_cmd_seq = NULL,
	.init_vid_seq = &otm8018b_tm_init_panel_vid[0],
	.slp_in_seq = &otm8018b_tm_slp_in[0],
	.slp_out_seq = &otm8018b_tm_slp_out[0],
	.scrn_on_seq = &otm8018b_tm_scrn_on[0],
	.scrn_off_seq = &otm8018b_tm_scrn_off[0],
	.id_seq = &otm8018b_tm_id[0],
	.verify_id = false,
	.updt_win_fn = otm8018b_tm_winset,
	.updt_win_seq_len = 0,
	.vid_cmnds = false,
	.vburst = false,
	.cont_clk = false,
