...
*
* @file drivers/video/broadcom/lcd/hx8379_hsd.h
*
...
#ifndef __HX8379_HSD_H__
#define __HX8379_HSD_H__

#include "display_drv.h"
#include "lcd.h"

#define HX8379_HSD_CMD_SLPIN 0x10
#define HX8379_HSD_CMD_SLPOUT 0x11
#define HX8379_HSD_CMD_DISPOFF 0x28
#define HX8379_HSD_CMD_DISPON 0x29

__initdata struct DSI_COUNTER hx8379_hsd_timing[] = {
...
__initdata DISPCTRL_REC_T hx8379_hsd_scrn_on[] = {
	{DISPCTRL_WR_CMND, 0x13},
	{DISPCTRL_WR_CMND, HX8379_HSD_CMD_DISPON},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8379_hsd_scrn_off[] = {
	{DISPCTRL_WR_CMND, 0x22},
	/* Commenting this since it results in a white screen
	{DISPCTRL_WR_CMND, HX8379_HSD_CMD_DISPOFF}, */
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8379_hsd_slp_in[] = {
	{DISPCTRL_WR_CMND, HX8379_HSD_CMD_DISPOFF},
	{DISPCTRL_WR_CMND, HX8379_HSD_CMD_SLPIN},
	{DISPCTRL_SLEEP_MS, 120},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8379_hsd_slp_out[] = {
	{DISPCTRL_WR_CMND, HX8379_HSD_CMD_SLPOUT},
	{DISPCTRL_SLEEP_MS, 120},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8379_hsd_init_panel_vid[] = {
...
void hx8379_hsd_winset(char *msgData, DISPDRV_WIN_t *p_win)
{
	return;
}

__initdata struct lcd_config hx8379_hsd_cfg = {
	.name = "HX8379_HSD",
	.mode_supp = LCD_VID_ONLY,
	.phy_timing = &hx8379_hsd_timing[0],
	.max_lanes = 2,
	...
	.phys_height = 95,
	.init_cmd_seq = NULL,
	.init_vid_seq = &hx8379_hsd_init_panel_vid[0],
	.slp_in_seq = &hx8379_hsd_slp_in[0],
	.slp_out_seq = &hx8379_hsd_slp_out[0],
	.scrn_on_seq = &hx8379_hsd_scrn_on[0],
	.scrn_off_seq = &hx8379_hsd_scrn_off[0],
	.id_seq = NULL,
	.verify_id = false,
	.updt_win_fn = hx8379_hsd_winset,
	.updt_win_seq_len = 0,
	.vid_cmnds = false,
	.vburst = true,
	.cont_clk = false,
