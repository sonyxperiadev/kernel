...
NEW_DISPCTRL_REC_T power_on_seq_s5d05a1x31_cooperve_AUO[] =
{
	...
	{DISPCTRL_WR_CMND_DATA, 7, {0xF6,0x00,0x00,0x05,0x03,0x01,0x00}},// (SRCCTL)
	
	//Initialize sequence
	{DISPCTRL_WR_CMND_DATA, 2,{0x35,0x01}}, // (TEON)
	{DISPCTRL_WR_CMND_DATA, 2,{0x36,0xD8}}, //RGB/BRG
	{DISPCTRL_WR_CMND_DATA, 2,{0x3A,0x55}}, //Format RGB565
	{DISPCTRL_WR_CMND_DATA, 6, {0xF7,0x40,0x00,0x10,0x12,0x00}},
	{DISPCTRL_WR_CMND_DATA, 3,{0xF8,0x11,0x00}},
	{DISPCTRL_WR_CMND_DATA, 20,{0xF2,0x3B,0x3A,0x03,0x04,0x02,0x08,0x08,0x00,0x08,0x08,0x00,0x00,0x00,0x00,0x54,0x08,0x08,0x08,0x08}},
	{DISPCTRL_WR_CMND_DATA, 3, {0xF0,0xA5,0xA5}},//Gama setting
