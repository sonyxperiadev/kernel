...
#ifndef __OTM8009A_H__
#define __OTM8009A_H__
...
#define OTM8009A_UPDT_WIN_SEQ_LEN 13 /* (6 + 6 + 1) */


__initdata struct DSI_COUNTER otm8009a_timing[] = {
...
__initdata DISPCTRL_REC_T otm8009a_scrn_on[] = {
	{DISPCTRL_WR_CMND, OTM8009A_CMD_DISPON},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8009a_scrn_off[] = {
	{DISPCTRL_WR_CMND, OTM8009A_CMD_DISPOFF},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8009a_id[] = {
	{DISPCTRL_WR_CMND, OTM8009A_CMD_RDID1},
	{DISPCTRL_WR_DATA, 0x40},
	{DISPCTRL_WR_CMND, OTM8009A_CMD_RDID2},
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_WR_CMND, OTM8009A_CMD_RDID3},
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8009a_slp_in[] = {
	{DISPCTRL_WR_CMND, OTM8009A_CMD_DISPOFF},
	{DISPCTRL_WR_CMND, OTM8009A_CMD_SLPIN},
	{DISPCTRL_SLEEP_MS, 120},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8009a_slp_out[] = {
	{DISPCTRL_WR_CMND, OTM8009A_CMD_SLPOUT},
	{DISPCTRL_SLEEP_MS, 120},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T otm8009a_init_panel_vid[] = {
...
void otm8009a_winset(char *msgData, DISPDRV_WIN_t *p_win)
{
	return;
}

__initdata struct lcd_config otm8009a_cfg = {
	.name = "OTM8009A",
	.mode_supp = LCD_CMD_VID_BOTH,
	.phy_timing = &otm8009a_timing[0],
	.max_lanes = 2,
	.max_hs_bps = 500000000,
	.max_lp_bps = 5000000,
	.phys_width = 52,
	.phys_height = 88,
	.init_cmd_seq = &otm8009a_init_panel_vid[0],
	.init_vid_seq = &otm8009a_init_panel_vid[0],
	.slp_in_seq = &otm8009a_slp_in[0],
	.slp_out_seq = &otm8009a_slp_out[0],
	.scrn_on_seq = &otm8009a_scrn_on[0],
	.scrn_off_seq = &otm8009a_scrn_off[0],
	.id_seq = &otm8009a_id[0],
	.verify_id = false,
	.updt_win_fn = otm8009a_winset,
	.updt_win_seq_len = 0,
	.vid_cmnds = true,
	.vburst = true,
	.cont_clk = false,
