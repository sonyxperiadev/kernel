...
*
* @file drivers/video/broadcom/lcd/hx8389_tm.h
*
...
#ifndef __HX8389_TM_H__
#define __HX8389_TM_H__

#include "display_drv.h"
#include "lcd.h"

#define HX8389_TM_CMD_SLPIN 0x10
#define HX8389_TM_CMD_SLPOUT 0x11
#define HX8389_TM_CMD_DISPOFF 0x28
#define HX8389_TM_CMD_DISPON 0x29
#define HX8389_TM_CMD_RDID1     0xDA
#define HX8389_TM_CMD_RDID2     0xDB
#define HX8389_TM_CMD_RDID3     0xDC

#define HX8389_TM_UPDT_WIN_SEQ_LEN 13 /* (6 + 6 + 1) */

__initdata struct DSI_COUNTER hx8389_tm_timing[] = {
...
__initdata DISPCTRL_REC_T hx8389_tm_scrn_on[] = {
	{DISPCTRL_WR_CMND, HX8389_TM_CMD_DISPON},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8389_tm_scrn_off[] = {
	{DISPCTRL_WR_CMND, HX8389_TM_CMD_DISPOFF},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8389_tm_id[] = {
	{DISPCTRL_WR_CMND, HX8389_TM_CMD_RDID1},
	{DISPCTRL_WR_DATA, 0x83},
	{DISPCTRL_WR_CMND, HX8389_TM_CMD_RDID2},
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_WR_CMND, HX8389_TM_CMD_RDID3},
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8389_tm_slp_in[] = {
	{DISPCTRL_WR_CMND, HX8389_TM_CMD_DISPOFF},
	{DISPCTRL_WR_CMND, HX8389_TM_CMD_SLPIN},
	{DISPCTRL_SLEEP_MS, 120},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8389_tm_slp_out[] = {
	{DISPCTRL_WR_CMND, HX8389_TM_CMD_SLPOUT},
	{DISPCTRL_SLEEP_MS, 120},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8389_tm_init_panel_vid[] = {
...
void hx8389_tm_winset(char *msgData, DISPDRV_WIN_t *p_win)
{
	int i = 0;
	...
	if (i != HX8389_TM_UPDT_WIN_SEQ_LEN)
		pr_err("hx8389_tm_winset msg len incorrect!\n");

}

__initdata struct lcd_config hx8389_tm_cfg = {
	.name = "HX8389_TM",
	.mode_supp = LCD_VID_ONLY,
	.phy_timing = &hx8389_tm_timing[0],
	.max_lanes = 2,
	...
	.phys_height = 95,
	.init_cmd_seq = NULL,
	.init_vid_seq = &hx8389_tm_init_panel_vid[0],
	.slp_in_seq = &hx8389_tm_slp_in[0],
	.slp_out_seq = &hx8389_tm_slp_out[0],
	.scrn_on_seq = &hx8389_tm_scrn_on[0],
	.scrn_off_seq = &hx8389_tm_scrn_off[0],
	.id_seq = &hx8389_tm_id[0],
	.verify_id = false,
	.updt_win_fn = hx8389_tm_winset,
	.updt_win_seq_len = 0,
	.vid_cmnds = false,
	.vburst = true,
	.cont_clk = false,
