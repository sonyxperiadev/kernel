...
extern int kona_otg_cp_id_change(const struct kona_otg_cp *cp, enum kona_otg_cp_id id);
extern int kona_otg_cp_volt_change(const struct kona_otg_cp *cp, enum kona_otg_cp_volt_state volt_state);
