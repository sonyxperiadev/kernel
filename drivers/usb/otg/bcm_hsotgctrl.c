...
/* Rhea and Island RDB use different defines for same register and bit definitions */
#ifdef CONFIG_ARCH_ISLAND
#define	CHIPREG_MDIO_CTRL_ADDR_WRDATA_MDIO_ID_SHIFT	CHIPREG_USB_INTERNAL_MDIO0_MDIO_ID_SHIFT
#define	CHIPREG_MDIO_CTRL_ADDR_WRDATA_MDIO_REG_ADDR_SHIFT	CHIPREG_USB_INTERNAL_MDIO0_MDIO_REG_ADDR_SHIFT
#define	CHIPREG_MDIO_CTRL_ADDR_WRDATA_OFFSET	CHIPREG_USB_INTERNAL_MDIO0_OFFSET
#define	CHIPREG_MDIO_CTRL_ADDR_WRDATA_MDIO_WRITE_START_MASK	CHIPREG_USB_INTERNAL_MDIO0_MDIO_WRITE_START_MASK
#define	CHIPREG_MDIO_CTRL_ADDR_WRDATA_MDIO_SM_SEL_MASK	CHIPREG_USB_INTERNAL_MDIO0_MDIO_SM_SEL_MASK
#endif
