 ...
 *         and transferring data with Sentral (formerly "driver_interface.h")
 *
...
#define DRIVER_BUILD 3892      /**< build; change this to match Sentral RAM version this driver; probably works with other versions */
 ...
 *         an error */
   struct DI_ERROR
   {
      ...
      RegSentralStatus sentral_status;                               /**< a copy of the SR_SENTRAL_STATUS register */
 ...
 *         instance of the Sentral driver */
   struct DI_INSTANCE
   {
	  ...
	  DI_SENSOR_TYPE_T installed_sensors[DST_NUM_SENSOR_TYPES];		
   };
 ...
 */
  ...
  extern  bool di_upload_eeprom(DI_INSTANCE_T * instance, u8 * data, int len);
/**
 ...
 * \param instance - the driver instance
 * \param sensors_present - an array allocated by the caller to 
 *                        which identifiers for all sensors
 *                        present will be stored
 * \param sensors_present_size - the maximum size of the array 
 *                             to prevent buffer overflows
 * \return bool false if Sentral could not be reached
 */
   extern bool di_query_features(DI_INSTANCE_T *instance, DI_SENSOR_TYPE_T *sensors_present, u8 sensors_present_size);
 ...
 *         could not be reached
 */
   extern bool di_enable_sensor_acquisition(DI_INSTANCE_T *instance, DI_SENSOR_TYPE_T *sensors_to_enable, u8 num_to_enable);
 ...
 *         DE_I2C_PENDING
*/
   extern bool di_query_sensor_finish(DI_INSTANCE_T *instance, DI_SENSOR_TYPE_T sensor, DI_SENSOR_INT_DATA_T *data);
 ...
 *         could not be reached
 */
   extern bool reset_sentral(DI_INSTANCE_T *instance, bool wait_for_standby);
 ...
 *         could not be reached
 */
   extern bool set_passthrough_mode(DI_INSTANCE_T *instance, bool enable);
