...
#ifndef _SENTRAL_REGISTERS_H_
#define _SENTRAL_REGISTERS_H_
...
#define SR_SENTRAL_STATUS        0x37 /**< RO; U8; bit flags; see RegSentralStatus below */
