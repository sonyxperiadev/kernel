...
#define SENSOR_ACCEL_RATE_MAX		100
#define SENSOR_GYRO_RATE_MIN		10
#define SENSOR_GYRO_RATE_MAX		100
#define SENSOR_MAG_RATE_MIN			1		
#define SENSOR_MAG_RATE_MAX			30			
#define SENSOR_QUATERNION_RATE_MIN		10
#define SENSOR_QUATERNION_RATE_MAX		100
#define SENSOR_CUST0_RATE_MIN		1
#define SENSOR_CUST0_RATE_MAX		1
#define SENSOR_CUST1_RATE_MIN		1
#define SENSOR_CUST1_RATE_MAX		1

#define SENSOR_ACCEL_NAME			"accel"
#define SENSOR_GYRO_NAME			"gyro"
#define SENSOR_MAG_NAME				"mag"
#define SENSOR_QUATERNION_NAME		"quat"
#define SENSOR_CUST0_NAME			"still"
#define SENSOR_CUST1_NAME			"pedo"
#define SENSOR_CUST2_NAME			"tilt"
									  ...
									  int * rate_min, int * rate_max )
{
	...
	switch(sensor)
	{
		case DST_ACCEL: 
		{
			/* accel must be min 100Hz for quaternion */
...
bool di_query_features(DI_INSTANCE_T *instance)
{
   ...
   for (sensor = DST_QUATERNION; sensor < DST_NUM_SENSOR_TYPES; sensor++)
...
#define SETUP_SENSOR(t, d)													\
   ...
   {
	  /* default 9DOF mode deps includes MAG */
