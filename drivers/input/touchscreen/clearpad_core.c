...
{
	struct clearpad *this = container_of(work,
			struct clearpad, notify_resume);
...
{
	struct clearpad *this = container_of(work,
			struct clearpad, notify_suspend);
				...
				unsigned long event, void *data)
{
	...
	int *blank;
	struct clearpad *this =
		container_of(self, struct clearpad, fb_notif);
