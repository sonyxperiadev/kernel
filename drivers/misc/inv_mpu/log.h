...
#define MPL_LOGV_VAR(v, f) \
		MPL_LOGV("%s|%d : var %s = " f, __func__, __LINE__, #v, v);
#define MPL_LOGV_ARRAY_3(v, f) \
		MPL_LOGV("%s|%d : arr %s[3] = {" f ", " f ", " f "}\n", \
			__func__, __LINE__, #v, (v)[0], (v)[1], (v)[2]);
#define MPL_LOGV_ARRAY_4(v, f) \
		MPL_LOGV("%s|%d : arr %s[4] = " \
			"{" f ", " f ", " f ", " f "}\n", \
			__func__, __LINE__, #v, (v)[0], (v)[1], (v)[2], (v)[3]);
