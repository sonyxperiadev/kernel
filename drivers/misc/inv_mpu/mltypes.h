 ...
 *          - (115)             INV_ERROR_SELFTEST_FAILURE
 *
 *          The available warning codes and their associated values are:
 *          - (128)             INV_WARNING_MOTION_RACE
 *          - (129)             INV_WARNING_QUAT_TRASHED
 *          - (130)             INV_WARNING_GYRO_MAG
 *
 *  @{
 *      @file mltypes.h
 *  @}
...
/* Self Test */
#define INV_ERROR_SELFTEST_FAILURE              (INV_ERROR_BASE + 83)

/* No Motion Warning States */
#define INV_WARNING_MOTION_RACE                 (INV_ERROR_BASE + 96)
#define INV_WARNING_QUAT_TRASHED                (INV_ERROR_BASE + 97)
#define INV_WARNING_GYRO_MAG                    (INV_ERROR_BASE + 98)
...
#define ML_ERROR_SELFTEST_FAILURE         INV_ERROR_SELFTEST_FAILURE
