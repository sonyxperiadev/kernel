 ...
 *
 ******************************************************/
const unsigned char aw86214_reg_list[] = {
	AW86214_REG_ID,
	AW86214_REG_SYSST,
	AW86214_REG_SYSINT,
	AW86214_REG_SYSINTM,
 ...
 *
 ******************************************************/
static char *aw86214_ram_name = "aw86214_haptic.bin";
			   ...
			   unsigned char *buf, unsigned int len)
{
	...
	ret = i2c_master_send(aw86214->i2c, &reg_addr, AW_I2C_BYTE_ONE);
	if (ret < 0) {
		aw_dev_err("%s: couldn't send addr:0x%02x, ret=%d\n",
			   __func__, reg_addr, ret);
		return ret;
	}
	ret = i2c_master_recv(aw86214->i2c, buf, len);
	if (ret != len) {
		aw_dev_err("%s: couldn't read data, ret=%d\n",
			   __func__, ret);
		return ret;
	}
	return ret;
...
irqreturn_t aw86214_irq(int irq, void *data)
{
 ...
 *
 *****************************************************/
int aw86214_parse_dt(struct aw86214 *aw86214, struct device *dev,
		     struct device_node *np)
{
	unsigned int val = 0;
...
static int aw86214_haptic_stop(struct aw86214 *aw86214)
{
...
int aw86214_ram_work_init(struct aw86214 *aw86214)
{
...
static int aw86214_haptic_brightness_set(struct led_classdev *cdev,
...
struct attribute_group aw86214_vibrator_attribute_group = {
...
int aw86214_vibrator_init(struct aw86214 *aw86214)
{
	int ret = 0;
	...
	aw86214->vib_dev.brightness_set_blocking = aw86214_haptic_brightness_set;
...
int aw86214_haptic_init(struct aw86214 *aw86214)
{
	int ret = 0;
	unsigned char reg_val = 0;
...
void aw86214_interrupt_setup(struct aw86214 *aw86214)
{
	unsigned char reg_val = 0;
...
char aw86214_check_qualify(struct aw86214 *aw86214)
{
	unsigned char reg = 0;
	int ret = 0;
