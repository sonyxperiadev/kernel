...
#ifdef	AMI304_MODEL
#define AMI_I2C_ADDRESS 		0x0F	/* new Addr=0x0E(Low), old Addr=0x0F(High) */
#else
#define AMI_I2C_ADDRESS 		0x0E	/* new Addr=0x0E(Low), old Addr=0x0F(High) */
#endif

/* AMI-Sensor Internal Register Address  (Please refer to AMI-Sensor Specifications) */
