...
static const struct smb5_iio_prop_channels smb5_chans_pmic[] = {
	...
	SMB5_CHAN_INDEX("battery_smart_charging_interruption", SMART_CHARGING_INTERRUPTION)
	SMB5_CHAN_ACTIVITY("battery_lrc_socmax", LRC_SOCMAX)
	SMB5_CHAN_ACTIVITY("battery_lrc_socmin", LRC_SOCMIN)
	SMB5_CHAN_INDEX("battery_lrc_not_startup", LRC_NOT_STARTUP)
	SMB5_CHAN_INDEX("battery_enable_shutdown_at_low_battery", ENABLE_SHUTDOWN_AT_LOW_BATTERY)
	SMB5_CHAN_INDEX("battery_bootup_shutdown_phase", BOOTUP_SHUTDOWN_PHASE)
	SMB5_CHAN_CUR("battery_chg_pwr_fcc", CHG_PWR_FCC)
	SMB5_CHAN_CUR("battery_chg_pwr_icl", CHG_PWR_ICL)
	SMB5_CHAN_INDEX("battery_chg_pwr_indication_control", CHG_PWR_INDICATION_CONTROL)
	SMB5_CHAN_INDEX("battery_smart_charging_status", SMART_CHARGING_STATUS)
	SMB5_CHAN_CUR("battery_jeita_step_fcc", JEITA_STEP_FCC)
	SMB5_CHAN_VOLT("battery_jeita_step_fv", JEITA_STEP_FV)
	SMB5_CHAN_CUR("battery_jeita_step_iterm", JEITA_STEP_ITERM)
	SMB5_CHAN_INDEX("battery_jeita_condition", JEITA_CONDITION)
	SMB5_CHAN_INDEX("battery_profile_fv_rb_en", PROFILE_FV_RB_EN)
	SMB5_CHAN_INDEX("usb_typec_power_role_for_wdet", TYPEC_POWER_ROLE_FOR_WDET)
	SMB5_CHAN_INDEX("usb_cc_reconnection_running", CC_RECONNECTION_RUNNING)
	SMB5_CHAN_INDEX("usb_legacy_cable_status", LEGACY_CABLE_STATUS)
	SMB5_CHAN_INDEX("usb_charger_type_determined", CHARGER_TYPE_DETERMINED)
	SMB5_CHAN_INDEX("battery_system_temp_level", SYSTEM_TEMP_LEVEL)
	SMB5_CHAN_INDEX("battery_system_temp_level_max", SYSTEM_TEMP_LEVEL_MAX)
	SMB5_CHAN_INDEX("battery_cv_status", CV_STATUS)
#endif
};
