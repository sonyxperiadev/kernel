...
.constraints = { .name = "rfldo", .min_uV = 1300000, .max_uV = 3300000, .valid_ops_mask = REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE | REGULATOR_CHANGE_VOLTAGE , .always_on = 1, .valid_modes_mask = REGULATOR_MODE_NORMAL | REGULATOR_MODE_STANDBY },
...
.constraints = { .name = "hv2ldo", .min_uV = 1300000, .max_uV = 3300000, .valid_ops_mask = REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE | REGULATOR_CHANGE_VOLTAGE , .always_on = 1, .valid_modes_mask = REGULATOR_MODE_NORMAL | REGULATOR_MODE_STANDBY },
...
.constraints = { .name = "hv5ldo", .min_uV = 1300000, .max_uV = 3300000, .valid_ops_mask = REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE | REGULATOR_CHANGE_VOLTAGE , .always_on = 1, .valid_modes_mask = REGULATOR_MODE_NORMAL | REGULATOR_MODE_STANDBY },
...
.constraints = { .name = "simldo", .min_uV = 1300000, .max_uV = 3300000, .valid_ops_mask = REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE | REGULATOR_CHANGE_VOLTAGE , .always_on = 1, .valid_modes_mask = REGULATOR_MODE_NORMAL | REGULATOR_MODE_STANDBY},
...
.constraints = { .name = "csrldo", .min_uV = 700000, .max_uV = 1800000, .valid_ops_mask = REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE | REGULATOR_CHANGE_VOLTAGE , .always_on = 1, .boot_on = 1, .valid_modes_mask = REGULATOR_MODE_NORMAL | REGULATOR_MODE_STANDBY  },
...
.constraints = { .name = "iosrldo", .min_uV = 700000, .max_uV = 1800000, .valid_ops_mask = REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE | REGULATOR_CHANGE_VOLTAGE , .always_on = 1, .valid_modes_mask = REGULATOR_MODE_NORMAL | REGULATOR_MODE_STANDBY },
...
.constraints = { .name = "sdsrldo", .min_uV = 700000, .max_uV = 1800000, .valid_ops_mask = REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE | REGULATOR_CHANGE_VOLTAGE , .always_on = 1, .valid_modes_mask = REGULATOR_MODE_NORMAL | REGULATOR_MODE_STANDBY },
...
struct bcm590xx_regulator_init_data bcm59055_regulators[] =
{
	...
	{ BCM59055_CSR, &bcm59055_csr_data, (LPM_PC2PC1_00 | ON_PC2PC1_01 | ON_PC2PC1_10) },
...
{
	return bcm59055_regulators;
}

int bcm590xx_num_regl(void)
{
	return ARRAY_SIZE(bcm59055_regulators);
}
