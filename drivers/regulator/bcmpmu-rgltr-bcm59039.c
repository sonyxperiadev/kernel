...
struct bcmpmu_reg_info bcm59039_register_info[BCMPMU_REGULATOR_MAX] = {
	[BCMPMU_REGULATOR_RFLDO] = {
		...
		.num_voltages = ARRAY_SIZE(bcm59039_ldo_v_table),
		.mode_mask = 0xFF,
	...
	[BCMPMU_REGULATOR_HV8LDO] = {
		...
		.reg_addr_volt_l = PMU_REG_HVLDO8CTRL,
		.reg_addr_volt_t = PMU_REG_HVLDO8CTRL,
		.en_dis_mask = 0x3,
		.en_dis_shift = 6,
		.vout_mask = 0x7,
		.vout_shift = 0,
	...
	[BCMPMU_REGULATOR_HV9LDO] = {
		...
		.reg_addr_volt_l = PMU_REG_HVLDO9CTRL,
		.reg_addr_volt_t = PMU_REG_HVLDO9CTRL,
		.en_dis_mask = 0x3,
		.en_dis_shift = 6,
		.vout_mask = 0x7,
		.vout_shift = 0,
	...
	[BCMPMU_REGULATOR_HV10LDO] = {
		...
		.reg_addr_volt_l = PMU_REG_HVLDO10CTRL,
		.reg_addr_volt_t = PMU_REG_HVLDO10CTRL,
		.en_dis_mask = 0x3,
		.en_dis_shift = 6,
		.vout_mask = 0x7,
		.vout_shift = 0,
	...
	[BCMPMU_REGULATOR_CSR] = {
		...
		.num_voltages = ARRAY_SIZE(bcm59039_sr_v_table),
		.mode_mask = 0xFF,
		.ldo_or_sr = BCMPMU_SR,
	},
	[BCMPMU_REGULATOR_IOSR] = {
