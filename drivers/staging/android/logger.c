...
struct struct_marks_ver_mark {
	...
	/* this is used for addressing log buffer in 2 dump files*/
	void *this;
...
static int __init logger_init(void)
{
	int ret;
#ifdef CONFIG_CDEBUGGER
	/* TODO: If there are more than one bank we need to take care.
	 * As of today we have only one bank in all the boards */
	marks_ver_mark.first_size = meminfo.bank[0].size;
