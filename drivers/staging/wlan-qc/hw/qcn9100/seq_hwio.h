...
//xiuhongs: conflict with msmhwio.h for CDVI_SVTB
#include "HALhwio.h"
//#include "msmhwio.h"
...
#define SEQ_INFH(base, regtype, reg, fld) \
        (SEQ_##regtype##_INMH(base, reg, HWIO_SPRUCE_FMSK(regtype, fld)) >> HWIO_SPRUCE_SHFT(regtype, fld))
...
#define SEQ_OUTFH(base, regtype, reg, fld, val) \
        SEQ_##regtype##_OUTMH(base, reg, HWIO_SPRUCE_FMSK(regtype, fld), val << HWIO_SPRUCE_SHFT(regtype, fld))
