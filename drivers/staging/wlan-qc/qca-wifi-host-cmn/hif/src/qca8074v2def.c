...
#define QCA8074V2_BOARD_DATA_SZ MISSING
#define QCA8074V2_BOARD_EXT_DATA_SZ MISSING

#define MY_TARGET_DEF QCA8074V2_TARGETDEF
#define MY_HOST_DEF QCA8074V2_HOSTDEF
#define MY_CEREG_DEF QCA8074V2_CE_TARGETDEF
#define MY_TARGET_BOARD_DATA_SZ QCA8074V2_BOARD_DATA_SZ
#define MY_TARGET_BOARD_EXT_DATA_SZ QCA8074V2_BOARD_EXT_DATA_SZ
#include "targetdef.h"
#include "hostdef.h"
qdf_export_symbol(QCA8074V2_CE_TARGETDEF);
#else
#include "common_drv.h"
#include "targetdef.h"
#include "hostdef.h"
struct targetdef_s *QCA8074V2_TARGETDEF;
struct hostdef_s *QCA8074V2_HOSTDEF;
#endif /*QCA8074V2_HEADERS_DEF */
qdf_export_symbol(QCA8074V2_TARGETDEF);
qdf_export_symbol(QCA8074V2_HOSTDEF);
