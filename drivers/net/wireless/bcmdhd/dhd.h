...
#define DHD_OS_PREALLOC(osh, section, size) dhd_os_prealloc((void*)osh, section, size)
#define DHD_OS_PREFREE(osh, addr, size) dhd_os_prefree((void*)osh, addr, size)

#else

#define DHD_OS_PREALLOC(osh, section, size) MALLOC((void*)osh, size)
#define DHD_OS_PREFREE(osh, addr, size) MFREE((void*)osh, addr, size)
