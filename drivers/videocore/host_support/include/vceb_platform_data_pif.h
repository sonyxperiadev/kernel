...
#ifndef VCEB_PLATFORM_DATA_PIF_H_
#define VCEB_PLATFORM_DATA_PIF_H_
...
typedef struct vceb_platform_data_pif_t
{
    VCEB_HOST_INTERFACE_CREATE_PARAMS_T     create_params;

    unsigned        target;
    unsigned        bootFromKernel;
...
} VCEB_PLATFORM_DATA_PIF_T;

#endif  /* VCEB_PLATFORM_DATA_PIF_H_ */
