...
#ifndef VCEB_PLATFORM_DATA_MPHI_H_
#define VCEB_PLATFORM_DATA_MPHI_H_
...
typedef struct vceb_platform_data_mphi_t
{
...
} VCEB_PLATFORM_DATA_MPHI_T;

#endif  /* VCEB_PLATFORM_DATA_MPHI_H_ */
