...
static const struct bcmpmu_reg_map bcm59039_reg_map[PMU_REG_MAX] = {
	...
	[PMU_REG_RFLDOCTRL] =		{.map = 0x00, .addr = 0xB1, .mask = 0xFF, .ro = 0},
	[PMU_REG_CAMLDOCTRL] =		{.map = 0x00, .addr = 0xB2, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO1CTRL] =		{.map = 0x00, .addr = 0xB3, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO2CTRL] =		{.map = 0x00, .addr = 0xB4, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO3CTRL] =		{.map = 0x00, .addr = 0xB5, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO4CTRL] =		{.map = 0x00, .addr = 0xB6, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO5CTRL] =		{.map = 0x00, .addr = 0xB7, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO6CTRL] =		{.map = 0x00, .addr = 0xB8, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO7CTRL] =		{.map = 0x00, .addr = 0xB9, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO8CTRL] =		{.map = 0x00, .addr = 0xBA, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO9CTRL] =		{.map = 0x00, .addr = 0xBB, .mask = 0xFF, .ro = 0},
	[PMU_REG_HVLDO10CTRL] =		{.map = 0x00, .addr = 0xBC, .mask = 0xFF, .ro = 0},
	[PMU_REG_SIMLDOCTRL] =		{.map = 0x00, .addr = 0xBD, .mask = 0xFF, .ro = 0},
	...
	/* audio */
	[PMU_REG_IHFTOP_IHF_IDDQ] =	{.map = 0x01, .addr = 0x80, .mask = 0xFF, .ro = 0},
	[PMU_REG_IHFLDO_PUP] =		{.map = 0x01, .addr = 0x82, .mask = 0x7F, .ro = 0},
	[PMU_REG_IHFPOP_PUP] =		{.map = 0x01, .addr = 0x83, .mask = 0x7F, .ro = 0},
	[PMU_REG_IHFPGA2_GAIN] =	{.map = 0x01, .addr = 0x8E, .mask = 0x3F, .ro = 0},
	[PMU_REG_HSPUP1_IDDQ_PWRDWN] =	{.map = 0x01, .addr = 0xAA, .mask = 0x10, .ro = 0},
	[PMU_REG_HSPUP2_HS_PWRUP] =	{.map = 0x01, .addr = 0xAB, .mask = 0x80, .ro = 0},
	[PMU_REG_HSPGA1_GAIN] =		{.map = 0x01, .addr = 0xA6, .mask = 0x3F, .ro = 0},
	...
	[PMU_REG_OTG_VBUS_DISCHRG] =	{.map = 0, .addr = 0, .mask = 0x02, .ro = 0, .shift = 1},
	[PMU_REG_OTG_ENABLE] =		{.map = 0, .addr = 0, .mask = 0x40, .ro = 0, .shift = 6},
	[PMU_REG_ADP_SENSE] =		{.map = 0, .addr = 0, .mask = 0x10, .ro = 0, .shift = 4},
	[PMU_REG_ADP_COMP_DB_TM] =	{.map = 0, .addr = 0, .mask = 0x03, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB] =		{.map = 0, .addr = 0, .mask = 0x01, .ro = 0, .shift = 0},
	[PMU_REG_ADP_CAL_PRB] =		{.map = 0, .addr = 0, .mask = 0xFF, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB_MOD] =		{.map = 0, .addr = 0, .mask = 0x06, .ro = 0, .shift = 1},
	[PMU_REG_ADP_PRB_CYC_TIME] =	{.map = 0, .addr = 0, .mask = 0x08, .ro = 0, .shift = 3},
	[PMU_REG_ADP_COMP_METHOD] =	{.map = 0, .addr = 0, .mask = 0x60, .ro = 0, .shift = 5},
	[PMU_REG_ADP_ENABLE] =		{.map = 0, .addr = 0, .mask = 0x08, .ro = 0, .shift = 3},
	[PMU_REG_ADP_PRB_COMP] =	{.map = 0, .addr = 0, .mask = 0x01, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB_REG_RST] =	{.map = 0, .addr = 0, .mask = 0x10, .ro = 0, .shift = 4},
	...
	[PMU_REG_ADP_STATUS_ATTACH_DET] =	{.map = 0, .addr = 0, .mask = 0x04, .ro = 0, .shift = 3},
...
static const struct bcmpmu_adc_map bcm59039_adc_map[PMU_ADC_MAX] = {
	...
	[PMU_ADC_32KTEMP] =		{.addr0 = 0x93, .addr1 = 0x92, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x08, .vrng = 1200},
	[PMU_ADC_PATEMP] =		{.addr0 = 0x93, .addr1 = 0x92, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x09, .vrng = 1200},
