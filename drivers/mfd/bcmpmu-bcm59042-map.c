...
static const struct bcmpmu_env_info bcm59042_env_reg_map[PMU_ENV_MAX] = {
	...
	[PMU_ENV_P_UBPD_INT] = 		{.regmap = {.addr = 0xE1, .mask = 0x02, .shift = 1, .ro = 1}, .bitmask = PMU_ENV_BITMASK_P_UBPD_INT},
...
static const struct bcmpmu_adc_map bcm59042_adc_map[PMU_ADC_MAX] = {
	...
	[PMU_ADC_VBUS] =		{.addr0 = 0x89, .addr1 = 0x88, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x03, .vrng = 14400},
	[PMU_ADC_ID] =			{.addr0 = 0x8B, .addr1 = 0x8A, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x04, .vrng = 1200},
	...
	[PMU_ADC_32KTEMP] =		{.addr0 = 0x8D, .addr1 = 0x8C, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x08, .vrng = 1200},
	[PMU_ADC_PATEMP] =		{.addr0 = 0x8D, .addr1 = 0x8C, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x09, .vrng = 1200},
	[PMU_ADC_RTM] =			{.addr0 = 0x99, .addr1 = 0x98, .dmask = 0x3FF, .vmask = 0x0000, .rtmsel = 0x00, .vrng = 0000},
	[PMU_ADC_FG_CURRSMPL] =		{.map = 1, .addr0 = 0x51, .addr1 = 0x50, .dmask = 0xFFFF, .vmask = 0x0000, .rtmsel = 0x00, .vrng = 0000},
	[PMU_ADC_FG_VMBATT] =		{.map = 1, .addr0 = 0x57, .addr1 = 0x56, .dmask = 0x03FF, .vmask = 0x0000, .rtmsel = 0x00, .vrng = 4800},
};
