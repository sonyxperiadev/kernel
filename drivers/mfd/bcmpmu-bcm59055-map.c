...
static const struct bcmpmu_reg_map bcm59055_reg_map[PMU_REG_MAX] = {	/* revisit */
	...
	[PMU_REG_IHFTOP_IHF_IDDQ] = {.map = 0x01, .addr = 0x80, .mask = 0x01, .ro =
				     0},
	...
	[PMU_REG_IHFPGA2_GAIN] = {.map = 0x01, .addr = 0x8A, .mask = 0x3F, .ro =
				  0},
	[PMU_REG_HSPUP1_IDDQ_PWRDWN] = {.map = 0x01, .addr = 0xA2, .mask =
					0x10, .ro = 0},
	[PMU_REG_HSPUP2_HS_PWRUP] = {.map = 0x01, .addr = 0xA3, .mask = 0x80, .ro =
				     0},
