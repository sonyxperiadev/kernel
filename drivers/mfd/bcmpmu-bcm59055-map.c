...
static const struct bcmpmu_reg_map bcm59055_reg_map[PMU_REG_MAX] = {//revisit
	...
	[PMU_REG_CHRGR_EOC] =		{.map = 0x00, .addr = 0x53, .mask = 0x0F, .ro = 0, .shift = 1},  //MBCCTRL4, different meaning from 59039
	/* fuel gauge */
	...
	[PMU_REG_FG_FRZREAD] =		{.map = 0x01, .addr = 0x41, .mask = 0xFF, .ro = 0, .shift = 5},
	[PMU_REG_FG_FRZSMPL] =		{.map = 0x01, .addr = 0x41, .mask = 0xFF, .ro = 0, .shift = 6},
	/* usb control */
	...
	[PMU_REG_MBCCTRL3] =	{.map = 0x00, .addr = 0x52, .mask = 0x1F, .ro = 0},
};
...
static const struct bcmpmu_irq_map bcm59055_irq_map[PMU_IRQ_MAX] = {//revisit
	...
	[PMU_IRQ_CHGINS] =		{.int_addr = 0x31, .mask_addr = 0x41, .bit_mask = 0x01},
	[PMU_IRQ_CHGRM] =		{.int_addr = 0x31, .mask_addr = 0x41, .bit_mask = 0x02},
	...
	[PMU_IRQ_PONKEYB_F] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_PONKEYB_R] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
