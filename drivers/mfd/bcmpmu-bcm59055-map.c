...
static const struct bcmpmu_reg_map bcm59055_reg_map[PMU_REG_MAX] = {//revisit
	...
	[PMU_REG_CHP_TYP]	=		{.map = 0x00, .addr = 0x54, .mask = 0x30, .ro = 0, .shift = 4},
	/* fuel gauge */
	...
	[PMU_REG_ADP_SENSE] =		{.map = 0, .addr = 0x7A, .mask = 0x02, .ro = 0, .shift = 1},
	[PMU_REG_ADP_STATUS_RISE_TIMES_LSB] =	{.map = 0x01, .addr = 0x71, .mask = 0xFF, .ro = 0, .shift = 0},
#else
	[PMU_REG_ADP_SENSE] =		{.map = 0, .addr = 0x71, .mask = 0x10, .ro = 0, .shift = 4},
	[PMU_REG_ADP_STATUS_RISE_TIMES_LSB] =	{.map = 0x01, .addr = 0x73, .mask = 0xFF, .ro = 0, .shift = 0},
#endif
	[PMU_REG_ADP_COMP_DB_TM] =	{.map = 0, .addr = 0x71, .mask = 0x03, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB] =		{.map = 0, .addr = 0x7A, .mask = 0x01, .ro = 0, .shift = 0},
	[PMU_REG_ADP_CAL_PRB] =		{.map = 0, .addr = 0x0, .mask = 0x0, .ro = 0, .shift = 0},
...
static const struct bcmpmu_irq_map bcm59055_irq_map[PMU_IRQ_MAX] = {//revisit
	...
	[PMU_IRQ_BATINS] =		{.int_addr = 0x35, .mask_addr = 0x45, .bit_mask = 0x10},
	...
	[PMU_IRQ_MBTEMPLOW] =		{.int_addr = 0x35, .mask_addr = 0x45, .bit_mask = 0x04},
	[PMU_IRQ_MBTEMPHIGH] =		{.int_addr = 0x35, .mask_addr = 0x45, .bit_mask = 0x08},
...
static const struct bcmpmu_env_info bcm59055_env_reg_map[PMU_ENV_MAX] = {//revisit
	...
	[PMU_ENV_CGPD_ENV] = 		{.regmap = {.addr = 0xE1, .mask = 0x01, .shift = 0, .ro = 1}, .bitmask = PMU_ENV_BITMASK_CGPD_ENV},
	[PMU_ENV_UBPD_ENV] = 		{.regmap = {.addr = 0xE1, .mask = 0x02, .shift = 1, .ro = 1}, .bitmask = PMU_ENV_BITMASK_UBPD_ENV},
	[PMU_ENV_UBPD_USBDET] = 	{.regmap = {.addr = 0xE1, .mask = 0x04, .shift = 2, .ro = 1}, .bitmask = PMU_ENV_BITMASK_UBPD_USBDET},
	[PMU_ENV_CGPD_PRI] = 		{.regmap = {.addr = 0xE1, .mask = 0x10, .shift = 4, .ro = 1}, .bitmask = PMU_ENV_BITMASK_CGPD_PRI},
	[PMU_ENV_UBPD_PRI] = 		{.regmap = {.addr = 0xE1, .mask = 0x20, .shift = 5, .ro = 1}, .bitmask = PMU_ENV_BITMASK_UBPD_PRI},
...
static const struct bcmpmu_adc_map bcm59055_adc_map[PMU_ADC_MAX] = {
	...
	[PMU_ADC_BOM] =			{.map = 0, .addr0 = 0x91, .addr1 = 0x90, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x07, .vrng = 1200},
