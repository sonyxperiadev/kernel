...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_enable(CHAL_HANDLE handle,
* cUInt16 enable)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_int_enable(CHAL_HANDLE handle,
* cUInt16 fifo_int_enable, cUInt16 err_int_enable )
*
...
cVoid chal_audio_eancpath_int_enable(CHAL_HANDLE handle,
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_dma_enable(CHAL_HANDLE handle,
* cUInt16 dma_enable)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_encepath_set_gain(CHAL_HANDLE handle,
* cUInt32 gain)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_set_bits_per_sample(
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_set_pack(CHAL_HANDLE handle,
* Boolean pack)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_set_fifo_thres(CHAL_HANDLE handle,
...
cVoid chal_audio_eancpath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres,
					 cUInt16 thres_2)
{
	cUInt32 reg_val;
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function: cUInt32 chal_audio_eancpath_read_int_status(CHAL_HANDLE handle)
*
...
cVoid chal_audio_eancpath_clr_int(CHAL_HANDLE handle)
{
	...
	reg_val = BRCM_READ_REG(base, AUDIOH_AUDIO_INT_STATUS);
	reg_val |=
	    (AUDIOH_AUDIO_INT_STATUS_EANC_INT_MASK |
	     AUDIOH_AUDIO_INT_STATUS_EANC_FIFO_ERR_MASK);
...
/*============================================================================
*
* Function: cUInt32 chal_audio_eancpath_read_fifo_status(CHAL_HANDLE handle)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_enable_IIR_coef(CHAL_HANDLE handle,
* Boolean enable)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_enable_FIR_coef(CHAL_HANDLE handle,
* Boolean enable)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_set_mode(CHAL_HANDLE handle,
* Boolean mode)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_set_input_mic(CHAL_HANDLE handle,
* cUInt16 dmic)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_ctrl_tap(CHAL_HANDLE handle,
* cUInt32 tap)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_ctrl_shift(CHAL_HANDLE handle,
* cUInt32 shift)
*
...
cVoid chal_audio_eancpath_DIIR_shift(CHAL_HANDLE handle, cUInt32 shift_H,
				     cUInt32 shift_L)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;

	BRCM_WRITE_REG(base, AUDIOH_EANC_DIIR_SHIFT_L,
		       (shift_L &
			AUDIOH_EANC_DIIR_SHIFT_L_EANC_DIIR_SHIFT_L_MASK));
	BRCM_WRITE_REG(base, AUDIOH_EANC_DIIR_SHIFT_H,
		       (shift_H &
			AUDIOH_EANC_DIIR_SHIFT_H_EANC_DIIR_SHIFT_H_MASK));
...
cVoid chal_audio_eancpath_AIIR_shift(CHAL_HANDLE handle, cUInt32 shift_H,
				     cUInt32 shift_L)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;

	BRCM_WRITE_REG(base, AUDIOH_EANC_AIIR_SHIFT_L,
		       (shift_L &
			AUDIOH_EANC_AIIR_SHIFT_L_EANC_AIIR_SHIFT_L_MASK));
	BRCM_WRITE_REG(base, AUDIOH_EANC_AIIR_SHIFT_H,
		       (shift_H &
			AUDIOH_EANC_AIIR_SHIFT_H_EANC_AIIR_SHIFT_H_MASK));
...
cVoid chal_audio_eancpath_UIIR_shift(CHAL_HANDLE handle, cUInt32 shift_H,
				     cUInt32 shift_L)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;

	BRCM_WRITE_REG(base, AUDIOH_EANC_UIIR_SHIFT_L,
		       (shift_L &
			AUDIOH_EANC_UIIR_SHIFT_L_EANC_UIIR_SHIFT_L_MASK));
	BRCM_WRITE_REG(base, AUDIOH_EANC_UIIR_SHIFT_H,
		       (shift_H &
			AUDIOH_EANC_UIIR_SHIFT_H_EANC_UIIR_SHIFT_H_MASK));
...
cVoid chal_audio_eancpath_set_cic_gain(CHAL_HANDLE handle, cUInt16 ucic_gain,
				       cUInt16 dcic_gain)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 cic_gain = 0;
...
/*============================================================================
*
* Function Name: chal_audio_eancpath_set_AIIR_coef(CHAL_HANDLE handle,
* cUInt32 AIIR_coef )
*
...
cVoid chal_audio_eancpath_set_AIIR_coef(CHAL_HANDLE handle, cUInt32 *AIIR_coef)
{
	...
	for (index = 0; index < 20; index++) {
		BRCM_WRITE_REG_IDX(base, AUDIOH_EANC_CO_AIIR, index,
				   AIIR_coef[index]);
	}
...
/*============================================================================
*
* Function Name: chal_audio_eancpath_set_AFIR_coef(CHAL_HANDLE handle,
* cUInt32 AFIR_coef )
*
...
cVoid chal_audio_eancpath_set_AFIR_coef(CHAL_HANDLE handle, cUInt32 *AFIR_coef)
{
	...
	for (index = 0; index < 10; index++) {
		BRCM_WRITE_REG_IDX(base, AUDIOH_EANC_CO_AFIR, index,
				   AFIR_coef[index]);
	}
...
/*============================================================================
*
* Function Name: chal_audio_eancpath_set_DIIR_coef(CHAL_HANDLE handle,
* cUInt32 DIIR_coef )
*
...
cVoid chal_audio_eancpath_set_DIIR_coef(CHAL_HANDLE handle, cUInt32 *DIIR_coef)
{
	...
	for (index = 0; index < 30; index++) {
		BRCM_WRITE_REG_IDX(base, AUDIOH_EANC_CO_DIIR, index,
				   DIIR_coef[index]);
	}
...
/*============================================================================
*
* Function Name: chal_audio_eancpath_set_UIIR_coef(CHAL_HANDLE handle,
* cUInt32 DIIR_coef )
*
...
cVoid chal_audio_eancpath_set_UIIR_coef(CHAL_HANDLE handle, cUInt32 *UIIR_coef)
{
	...
	for (index = 0; index < 30; index++) {
		BRCM_WRITE_REG_IDX(base, AUDIOH_EANC_CO_UIIR, index,
				   UIIR_coef[index]);
	}
...
cUInt32 chal_audio_eancpath_read_fifo(CHAL_HANDLE handle, cUInt32 *src,
				      cUInt32 length, Boolean ign_udf)
{
	UInt32 n;
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;

/* Check if the FIFO is underflow, if ign_udf flag is not set */
	if (ign_udf == CHAL_AUDIO_STOP_ON_FIFO_UNDERFLOW) {
		for (n = 0; n < length; n++) {
			if (chal_audio_eancpath_read_fifo_status(handle) &
...
/*============================================================================
*
* Function: cVoid chal_audio_eancpath_get_dma_port_addr(CHAL_HANDLE handle,
* UInt32 *dma_addr)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_eancpath_int_clear(CHAL_HANDLE handle,
* cUInt16 fifo_int_enable, cUInt16 err_int_enable )
*
...
*
*============================================================================*/
cVoid chal_audio_eancpath_int_clear(CHAL_HANDLE handle, Boolean fifo_int,
				    Boolean err_int)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 reg_val = 0;
