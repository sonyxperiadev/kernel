...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_enable(CHAL_HANDLE handle,
* cUInt16 enable)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_int_enable(CHAL_HANDLE handle,
...
*
*============================================================================*/
cVoid chal_audio_earpath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable,
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_dma_enable(CHAL_HANDLE handle,
* cUInt16 dma_enable)
*
...
/*============================================================================
*
* Function: cVoid chal_audio_earpath_mute(CHAL_HANDLE handle, Boolean mute)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_set_gain(CHAL_HANDLE handle,
* cUInt32 gain)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_set_bits_per_sample(
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_set_mono_stereo(
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_set_pack(CHAL_HANDLE handle,
* Boolean pack)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_set_fifo_thres(CHAL_HANDLE handle,
...
cVoid chal_audio_earpath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres,
					cUInt16 thres_2)
{
	cUInt32 reg_val;
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function Name: chal_audio_earpath_write_fifo(CHAL_HANDLE handle,
...
cUInt32 chal_audio_earpath_write_fifo(CHAL_HANDLE handle, cUInt32 *src,
				      cUInt32 length, Boolean ign_ovf)
{
	...
	if (ign_ovf == CHAL_AUDIO_STOP_ON_FIFO_OVERFLOW) {
		for (n = 0; n < length; n++) {
			...
			BRCM_WRITE_REG(base, AUDIOH_VOUT_FIFO_DATA,
				       ((cUInt32) *src++));
		}
	} else {
...
/*============================================================================
*
* Function Name: chal_audio_earpath_sidetone_in(CHAL_HANDLE handle,
* cUInt16 enable)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_sdm_set_dither_poly(
...
cVoid chal_audio_earpath_sdm_set_dither_poly(CHAL_HANDLE handle,
					     cUInt32 vout_dither_poly)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;

	BRCM_WRITE_REG(base, AUDIOH_VOUT_DITHER_POLY,
		       (vout_dither_poly |
...
cVoid chal_audio_earpath_sdm_set_dither_seed(CHAL_HANDLE handle,
...
cVoid chal_audio_earpath_get_dma_port_addr(CHAL_HANDLE handle,
					   UInt32 *dma_addr)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function Name: chal_audio_earpath_sdm_set_coef(CHAL_HANDLE handle,
* cUInt32 *SDM_coef )
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_int_clear(CHAL_HANDLE handle, c
* UInt16 thr_int_enable, cUInt16 err_int_enable )
*
...
*
*============================================================================*/
cVoid chal_audio_earpath_int_clear(CHAL_HANDLE handle, Boolean thr_int,
				   Boolean err_int)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 reg_val = 0;
...
*
* Parameters:   handle     - audio chal handle.
*               enable     - Specifies which DAC channel power need
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_set_drv_pwr(CHAL_HANDLE handle,
*  cUInt16 enable)
*
*
...
*
* Parameters:   handle     - audio chal handle.
*               enable   - Specifies which DAC channel to be enabled/disabled
*
* Return:       None.
*
*============================================================================*/
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_set_slowramp_ctrl(CHAL_HANDLE handle,
* cUInt16 sr_ctrl)
*
* Description:  Set AudioTx Slow Ramp Generator Controls
*
* Parameters:   handle - audio chal handle.
*		sr_ctrl - Slow Ramp controls.
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_clear_slowramp_ctrl(
...
*
*============================================================================*/
cVoid chal_audio_earpath_clear_slowramp_ctrl(CHAL_HANDLE handle,
					     cUInt16 sr_ctrl)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 reg_value;
...
*
*============================================================================*/
cVoid chal_audio_earpath_set_isolation_ctrl(CHAL_HANDLE handle,
					    cUInt16 iso_ctrl)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 reg_value;
...
/*============================================================================
*
* Function Name: cVoid chal_audio_earpath_set_filter(CHAL_HANDLE handle,
* cUInt16 filter)
*
...
*
*============================================================================*/
cVoid chal_audio_earpath_set_filter(CHAL_HANDLE handle, cUInt16 filter)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 reg_val;
