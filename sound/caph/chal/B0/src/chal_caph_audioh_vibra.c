...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_enable
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_int_enable
...
*
*============================================================================*/
cVoid chal_audio_vibra_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable,
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_dma_enable
...
cVoid chal_audio_vibra_get_dma_port_addr(CHAL_HANDLE handle, UInt32 *dma_addr)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_set_gain
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_set_bits_per_sample
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_set_bypass
* (CHAL_HANDLE handle, Boolean bypass)
*
* Description:  Set the gain on vibra path
*
* Parameters:   handle - audio chal handle.
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_set_mono_stereo
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_set_pack
...
cVoid chal_audio_vibra_clr_int(CHAL_HANDLE handle)
{
	...
	reg_val =
	    AUDIOH_AUDIO_INT_STATUS_VIBRA_INT_MASK |
	    AUDIOH_AUDIO_INT_STATUS_VIBRA_FIFO_ERR_MASK;
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_set_fifo_thres
...
cVoid chal_audio_vibra_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres,
				      cUInt16 thres_2)
{
	cUInt32 reg_val;
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function Name: chal_audio_vibra_write_fifo
...
cUInt32 chal_audio_vibra_write_fifo(CHAL_HANDLE handle, cUInt32 *src,
				    cUInt32 length, Boolean ign_ovf)
{
	...
	if (ign_ovf == CHAL_AUDIO_STOP_ON_FIFO_OVERFLOW) {
		for (n = 0; n < length; n++) {
			...
			if (chal_audio_vibra_read_fifo_status(handle) &
			    CHAL_AUDIO_FIFO_STATUS_NEAR_FULL) {
				break;
			}
			BRCM_WRITE_REG(base, AUDIOH_VIBRA_FIFO_DATA,
				       ((cUInt32) *src++));
		}
	} else {
		for (n = 0; n < length; n++) {
...
/*============================================================================
*
* Function Name: chal_audio_vibra_sdm_set_coef
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_int_clear
* (CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable )
*
...
*
*============================================================================*/
cVoid chal_audio_vibra_int_clear(CHAL_HANDLE handle, Boolean thr_int,
				 Boolean err_int)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 reg_val = 0;
...
*
* Parameters:   handle     - audio chal handle.
*            enable_chan   - which DAC channel power to be enabled or disabled
* Return:       None.
*
============================================================================*/
...
/*============================================================================
*
* Function Name: cVoid chal_audio_vibra_set_filter(CHAL_HANDLE handle,
* cUInt16 filter)
*
