...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_enable(CHAL_HANDLE handle,
* cUInt16 enable)
*
* Description:  Enable or Disable IHF path
*
* Parameters:  handle    - audio chal handle.
*		enable    -  enable_chn : bit3 (left channel )
...
cVoid chal_audio_ihfpath_enable(CHAL_HANDLE handle, cUInt16 enable_chan)
{
	...
	reg_val &=
	    ~(AUDIOH_DAC_CTL_IHF_L_ENABLE_MASK |
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_int_enable(CHAL_HANDLE handle,
...
cVoid chal_audio_ihfpath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable,
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_dma_enable(CHAL_HANDLE handle,
* cUInt16 dma_enable)
*
...
/*============================================================================
*
* Function: cVoid chal_audio_ihfpath_mute(CHAL_HANDLE handle, Boolean mute)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_set_gain(CHAL_HANDLE handle,
* cUInt32 gain)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_set_bits_per_sample
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_set_mono_stereo(
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_set_pack(CHAL_HANDLE handle,
* Boolean pack)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hsath_set_fifo_thres(CHAL_HANDLE handle,
...
cVoid chal_audio_ihfpath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres,
					cUInt16 thres_2)
{
	cUInt32 reg_val;
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function: cUInt32 chal_audio_ihfpath_read_fifo_status(CHAL_HANDLE handle)
*
...
/*============================================================================
*
* Function Name: chal_audio_ihfpath_write_fifo(CHAL_HANDLE handle,
...
cUInt32 chal_audio_ihfpath_write_fifo(CHAL_HANDLE handle, cUInt32 *src,
				      cUInt32 length, Boolean ign_ovf)
{
	...
	if (ign_ovf == CHAL_AUDIO_STOP_ON_FIFO_OVERFLOW) {
		for (n = 0; n < length; n++) {
			...
			BRCM_WRITE_REG(base, AUDIOH_IHF_FIFO_DATA,
				       ((cUInt32) *src++));
		}
	} else {
		for (n = 0; n < length; n++)
...
/*============================================================================
*
* Function Name: chal_audio_ihfpath_eanc_in(CHAL_HANDLE handle,
* cUInt16 mix_in)
*
...
/*============================================================================
*
* Function Name: chal_audio_ihfpath_sidetone_in(CHAL_HANDLE handle,
* cUInt16 enable )
*
...
cVoid chal_audio_ihfpath_sdm_enable_dither(CHAL_HANDLE handle, cUInt16 enable)
{
	cUInt32 reg_val;
...
/*============================================================================
*
* Function Name: cVoid hal_audio_ihfpath_sdm_enable_dither_gain(
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_sdm_set_dither_strength(
...
cVoid chal_audio_ihfpath_sdm_set_coef(CHAL_HANDLE handle, cUInt32 ihf_coef_L,
				      cUInt32 ihf_coef_R)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_sdm_set_dither_poly(
* CHAL_HANDLE handle,
...
cVoid chal_audio_ihfpath_sdm_set_dither_poly(CHAL_HANDLE handle,
					     ...
					     cUInt32 ihf_dither_poly_R)
{
	...
	reg_value =
	    ihf_dither_poly_L | AUDIOH_IHF_DITHER_POLY_L_IHF_DITHER_SET_L_MASK;
	BRCM_WRITE_REG(base, AUDIOH_IHF_DITHER_POLY_L, reg_value);
	...
	reg_value =
	    ihf_dither_poly_R | AUDIOH_IHF_DITHER_POLY_R_IHF_DITHER_SET_R_MASK;
	BRCM_WRITE_REG(base, AUDIOH_IHF_DITHER_POLY_R, reg_value);
...
cVoid chal_audio_ihfpath_sdm_set_dither_seed(CHAL_HANDLE handle,
...
cVoid chal_audio_ihfpath_get_dma_port_addr(CHAL_HANDLE handle,
					   UInt32 *dma_addr)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_int_clear(CHAL_HANDLE handle,
* cUInt16 thr_int_enable, cUInt16 err_int_enable )
*
...
*
*============================================================================*/
cVoid chal_audio_ihfpath_int_clear(CHAL_HANDLE handle, Boolean thr_int,
				   Boolean err_int)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 reg_val = 0;
...
*
* Parameters:   handle     - audio chal handle.
*     enable_chan   - Specifies which DAC channel power enabled or disabled
...
/*============================================================================
*
* Function Name: cVoid chal_audio_ihfpath_set_filter(
