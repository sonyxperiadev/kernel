...
/*============================================================================
*
* Function: cVoid chal_audio_hspath_enable(CHAL_HANDLE handle, cUInt16 enable)
*
* Description:  Enable or Disable headset path
*
* Parameters:   handle    - audio chal handle.
*		enable    -  enable_chn : bit1 (left channel )
*		true : enable, false : disable.
*		enable_chn : bit0 (rightchannel )
*		true : enable, false : disable.
* Return:       None.
*
*============================================================================*/
cVoid chal_audio_hspath_enable(CHAL_HANDLE handle, cUInt16 enable_chan)
{
	...
	reg_val &=
	    ~(AUDIOH_DAC_CTL_STEREO_L_ENABLE_MASK |
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_int_enable(CHAL_HANDLE handle,
...
cVoid chal_audio_hspath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable,
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_set_gain(CHAL_HANDLE handle,
* cUInt32 gain)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_set_bits_per_sample(
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_set_mono_stereo(
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_set_pack(CHAL_HANDLE handle,
* Boolean pack)
*
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_set_fifo_thres(CHAL_HANDLE handle,
...
cVoid chal_audio_hspath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres,
				       cUInt16 thres_2)
{
	cUInt32 reg_val;
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function Name: chal_audio_hspath_sidetone_in(CHAL_HANDLE handle,
* cUInt16 enable)
*
...
/*============================================================================
*
* Function Name: cVoid hal_audio_hspath_sdm_enable_dither_gain(
...
cVoid chal_audio_hspath_sdm_set_coef(CHAL_HANDLE handle, cUInt32 hs_coef_L,
				     cUInt32 hs_coef_R)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function: cVoid chal_audio_hspath_sdm_set_dither_poly(CHAL_HANDLE handle,
...
cVoid chal_audio_hspath_sdm_set_dither_poly(CHAL_HANDLE handle,
...
cVoid chal_audio_hspath_sdm_set_dither_seed(CHAL_HANDLE handle,
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_hs_supply_ctrl(CHAL_HANDLE handle,
* cUInt32 vout_supply_ctrl)
*
...
*              hs_ds_delay - Signal Delay in step of 8 samples,
*		3-bit integer, 000--no delay, 111--56 symbols delay
*              hs_ds_lag    - Lag control, 8-bit, in audio samples (48KHz)
*
* Return:       None.
*
*============================================================================*/

cVoid chal_audio_hspath_hs_supply_ctrl(CHAL_HANDLE handle, Boolean hs_ds_pol,
				       cUInt8 hs_ds_delay, cUInt8 hs_ds_lag)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_hs_supply_thres(CHAL_HANDLE handle,
...
/*============================================================================
*
* Function Name: cVoid chal_audio_hspath_int_clear(CHAL_HANDLE handle,
* Boolean thr_int, Boolean err_int )
*
...
*
*============================================================================*/
cVoid chal_audio_hspath_int_clear(CHAL_HANDLE handle, Boolean thr_int,
				  Boolean err_int)
{
	cUInt32 base = ((ChalAudioCtrlBlk_t *) handle)->audioh_base;
	cUInt32 reg_val = 0;
...
*
* Parameters:   handle     - audio chal handle.
*               enable_chan   - Specifies which DAC channel power need to be
*		 enabled or disabled
* Return:       None.
*
*============================================================================*/
...
cVoid chal_audio_hspath_set_dac_pwr(CHAL_HANDLE handle, cUInt16 enable_chan)
{
	...
	*/
	...
	if (enable_chan) {
		reg_value &= ~AUDIOH_HS_PWR_AUDIOTX_HS_RESET_MASK;
