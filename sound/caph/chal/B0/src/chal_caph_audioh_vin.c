...
//============================================================================
//
// Function Name: cVoid cchal_audio_vinpath_select_primary_mic( CHAL_HANDLE handle,
//                                            cUInt16 digital_mic )
//
...
cVoid chal_audio_vinpath_select_primary_mic( CHAL_HANDLE handle,  cUInt16 digital_mic )
{
...
//============================================================================
//
// Function Name: chal_audio_vinpath_digi_mic_disable(CHAL_HANDLE handle, cUInt16 disable)
//
...
//
//============================================================================
cVoid chal_audio_vinpath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable )
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_val;
...
//============================================================================
//
// Function Name: cVoid chal_audio_vinpath_set_bits_per_sample(CHAL_HANDLE handle,
//                        cUInt16 bits)
//
...
//============================================================================
//
// Function Name: cVoid chal_audio_vinpath_set_pack(CHAL_HANDLE handle, Boolean pack)
//
...
cVoid chal_audio_vinpath_select_sidetone (CHAL_HANDLE handle,Boolean read_sidetone)
{
    cUInt32     reg_val;
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
cVoid chal_audio_vinpath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres, cUInt16 thres_2 )
{
    cUInt32     reg_val;
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
//============================================================================
//
// Function Name: cUInt32 chal_audio_vinpath_read_fifo_status2(CHAL_HANDLE handle)
//
// Description:  Read the FIFO 2 status (including interrupts) on voice input path
//
// Parameters:   handle  the voice input path handle.
//
// Return:       the status.
...
cUInt32 chal_audio_vinpath_read_fifo(CHAL_HANDLE handle, cUInt32 *src, cUInt32 length, Boolean ign_udf)
{
    UInt32 n;
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
cUInt32 chal_audio_vinpath_read_fifo2(CHAL_HANDLE handle, cUInt32 *src, cUInt32 length, Boolean ign_udf)
{
    UInt32 n;
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
//============================================================================
//
// Function Name: cVoid chal_audio_vinpath_int_clear(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable )
//
...
//
//============================================================================
cVoid chal_audio_vinpath_int_clear(CHAL_HANDLE handle, Boolean thr_int, Boolean err_int)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_val = 0;
...
//============================================================================
//
// Function Name: cVoid chal_audio_vinpath_set_filter(CHAL_HANDLE handle, cUInt16 filter)
//
