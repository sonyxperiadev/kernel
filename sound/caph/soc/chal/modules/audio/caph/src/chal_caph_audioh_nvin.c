...
//============================================================================
//
// Function Name: chal_audio_nvinpath_digi_mic_disable(CHAL_HANDLE handle, cUInt16 disable)
//
...
//============================================================================
//
// Function Name: cVoid chal_audio_nvinpath_get_dma_port_addr2(CHAL_HANDLE handle,
//									UInt32 *dma_addr)
//
...
cUInt32 chal_audio_nvinpath_read_fifo2(CHAL_HANDLE handle, cUInt32 *src, cUInt32 length, Boolean ign_udf)
{
    UInt32 n;
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
//============================================================================
//
// Function Name: cVoid chal_audio_nvinpath_set_filter(CHAL_HANDLE handle, cUInt16 filter)
//
