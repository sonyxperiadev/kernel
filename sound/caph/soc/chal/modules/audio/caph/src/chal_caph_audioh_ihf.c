...
cVoid chal_audio_ihfpath_set_dac_pwr(CHAL_HANDLE handle, cUInt16 enable_chan)
{
    ...
    {
// This will affect Microphone path. Reason is unknown. For now flag this 
// code out.
#if 0	    
...
//============================================================================
//
// Function Name: cVoid chal_audio_ihfpath_set_filter(CHAL_HANDLE handle, cUInt16 filter)
//
...
//============================================================================
cVoid chal_audio_ihfpath_set_filter(CHAL_HANDLE handle, cUInt16 filter)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_val;
