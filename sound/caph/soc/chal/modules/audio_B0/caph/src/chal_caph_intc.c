...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_set_cfifo_int_detect_level(CHAL_HANDLE handle,
*            cUInt16 fifo,
*            cUInt16 detectLevel)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_set_dma_int_detect_level(CHAL_HANDLE handle,
*            cUInt16 channel,
*            cUInt16 detectLevel)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_disable_ssp_int_err(CHAL_HANDLE handle,
            cUInt8 ssp,
            CAPH_ARM_DSP_e owner)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_set_ssp_int_detect_level(CHAL_HANDLE handle,
*            cUInt8 ssp,
*            cUInt8 detectLevel)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_enable_switch_intr_err(CHAL_HANDLE handle,
*            CAPH_ARM_DSP_e owner)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_disable_switch_intr_err(CHAL_HANDLE handle,
*            CAPH_ARM_DSP_e owner)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_set_switch_int_detect_level(CHAL_HANDLE handle,
*            cUInt8 detectLevel)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_enable_audioh_intr_err(CHAL_HANDLE handle,
*            cUInt8 fifo,
*            CAPH_ARM_DSP_e owner)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_disable_audioh_intr_err(CHAL_HANDLE handle,
*            cUInt8 fifo,
*            CAPH_ARM_DSP_e owner)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_set_audioh_int_detect_level(CHAL_HANDLE handle,
*            cUInt8 fifo,
*            cUInt8 detectLevel)
*
            ...
            CAPH_ARM_DSP_e owner)
{
    cUInt32 base = (cUInt32)handle;
    cUInt32 int_en;
    cUInt32 int_dis = (channel << AHINTC_ENABLE_ARM_STD_1_ENABLE_A_S_TAP_OUTCH4_1_SHIFT);
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_intc_set_tap_int_detect_level(CHAL_HANDLE handle,
*            cUInt8 channel,
*            cUInt8 detectLevel)
*
