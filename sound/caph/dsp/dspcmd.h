...
//audio command
	...
	DSPCMD_TYPE_AUDIO_ENABLE,  /*7*/
	DSPCMD_TYPE_EC_ON,
	DSPCMD_TYPE_NS_ON,
	DSPCMD_TYPE_CONFIG_EC_FAR_IN_FILTER, /*10*/
	...
	DSPCMD_TYPE_CONFIG_COMPANDER_FLAG, /*30*/
