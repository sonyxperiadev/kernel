...
***/
...
#ifdef tempInterface_DSP_FEATURE_MIC2_ECGAINS
	...
	PARAM_AMIC_DGA_COARSE_GAIN,	//251
	...
	PARAM_SRCMIXER_INPUT_GAIN_L,	//261
	PARAM_SRCMIXER_OUTPUT_COARSE_GAIN_L,
	PARAM_SRCMIXER_OUTPUT_FINE_GAIN_L,
	PARAM_SRCMIXER_INPUT_GAIN_R,
	PARAM_SRCMIXER_OUTPUT_COARSE_GAIN_R,
	PARAM_SRCMIXER_OUTPUT_FINE_GAIN_R,

	PARAM_EXT_SPEAKER_HIGH_GAIN_MODE_ENABLE,	//267
	PARAM_EXT_SPEAKER_PGA_L, 	
	PARAM_EXT_SPEAKER_PGA_R, 
...
#endif
	PARAM_HW_SIDETONE_ENABLE, //288
	PARAM_HW_SIDETONE_GAIN,
	PARAM_HW_SIDETONE_EQ,


 //for Athena:
	PARAM_MM_SPEAKER_PGA=291,					// 291
	PARAM_MM_EXT_SPEAKER_PGA,					// 292
	PARAM_MM_EXT_SPEAKER_PREAMP_PGA,			// 293
	PARAM_MM_MIC_PGA,						// 294
	PARAM_MM_AUDVOC_VSLOPGAIN,					// 295
	PARAM_MM_AUDVOC_PSLOPGAIN,					// 296
	PARAM_MM_AUDVOC_ASLOPGAIN,					// 297
	PARAM_MM_AUDVOC_MIXERGAIN,					// 298
	PARAM_MM_AUDVOC_VCFGR,					// 299
	PARAM_MM_DOWNLINK_VOICE_VOLUME,			// 300
	
	AUDIO_PARM_NUMBER   								// 301
