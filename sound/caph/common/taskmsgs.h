...
//*****************************************************************************
//*****************************************************************************
// message moved to taskmsgs_atc.i
...
//MSG_GEN_REQ_START = 0x0
	...
	**/
	MSG_SYS_ENABLE_CELL_INFO_REQ  = MSG_GRP_CAPI2_GEN_0 + 0x1CC,	///<Payload type {::CAPI2_SYS_EnableCellInfoMsg_Req_t}
	 /** 
	payload is void 
	**/
	...
	**/
	MSG_CC_GETCNAPNAME_RSP  = MSG_GRP_CAPI2_GEN_0 + 0x4B5,	///<Payload type {::CNAP_NAME_t}
	 /** 
