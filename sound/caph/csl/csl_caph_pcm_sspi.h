 ...
 * i2s should be
 */
/*defined as following.  If the size is less then the following value,
 * the transferring
 */
...
#define CSL_CAPH_SSP_e enum CSL_CAPH_SSP_e

struct CSL_PCM_HANDLE_t {
	cUInt32 base;
	cUInt32 type;
};

#define CSL_PCM_HANDLE_t struct CSL_PCM_HANDLE_t
...
#define CSL_PCM_OPSTATUS_t enum CSL_PCM_OPSTATUS_t
...
#define csl_pcm_mode_t enum csl_pcm_mode_t
...
#define csl_pcm_protocol_t enum csl_pcm_protocol_t
...
#define csl_pcm_tx_channel_t enum csl_pcm_tx_channel_t
...
#define csl_pcm_rx_channel_t enum csl_pcm_rx_channel_t
...
#define csl_pcm_dma_size_t enum csl_pcm_dma_size_t
 ...
 *
 */
enum csl_pcm_sample_rate_t {
	CSL_PCM_SAMPLERATE_48000HZ,	/*48000HZ*/
	CSL_PCM_SAMPLERATE_96000HZ	/*96000HZ*/
};

#define csl_pcm_sample_rate_t enum csl_pcm_sample_rate_t
...
#define csl_pcm_data_format_t enum csl_pcm_data_format_t
...
#define csl_pcm_config_tx_t struct csl_pcm_config_tx_t
...
#define csl_pcm_config_rx_t struct csl_pcm_config_rx_t
 ...
 *
 */
struct csl_pcm_config_device_t {
...
#define csl_pcm_config_device_t struct csl_pcm_config_device_t
 ...
 *
 */
CSL_PCM_OPSTATUS_t csl_pcm_start_tx(CSL_PCM_HANDLE handle,
		UInt8 channel);
 ...
 *
 */
CSL_PCM_OPSTATUS_t csl_pcm_start_rx(CSL_PCM_HANDLE handle,
		UInt8 channel);
 ...
 *
 */
CSL_PCM_OPSTATUS_t csl_pcm_stop_tx(CSL_PCM_HANDLE handle,
		UInt8 channel);
 ...
 *
 */
CSL_PCM_OPSTATUS_t csl_pcm_stop_rx(CSL_PCM_HANDLE handle,
		UInt8 channel);
