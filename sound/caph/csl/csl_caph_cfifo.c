...
/*    {CSL_CAPH_CFIFO_FIFO12, 0x0880, 0x80, 0x1, CAPH_DSP, 0, CSL_CAPH_DMA_CH12},
    ...
    {CSL_CAPH_CFIFO_FIFO12, 0x0880, 0x200, 0x1, CAPH_DSP, 0, CSL_CAPH_DMA_CH12},
    {CSL_CAPH_CFIFO_FIFO13, 0x0A80, 0x8, 0x7, CAPH_DSP, 0, CSL_CAPH_DMA_CH13},
    {CSL_CAPH_CFIFO_FIFO14, 0x0A88, 0x8, 0x7,  CAPH_DSP, 0, CSL_CAPH_DMA_CH14},
    {CSL_CAPH_CFIFO_FIFO15, 0x0A90, 0x8, 0x7,  CAPH_DSP, 0, CSL_CAPH_DMA_CH15},
    {CSL_CAPH_CFIFO_FIFO16, 0x0A98, 0x8, 0x7,  CAPH_DSP, 0, CSL_CAPH_DMA_CH16}
#else
    {CSL_CAPH_CFIFO_FIFO12, 0x0880, 0x80, 0x1, CAPH_DSP, 0, CSL_CAPH_DMA_CH12},
...
void csl_caph_cfifo_release_fifo(CSL_CAPH_CFIFO_FIFO_e fifo)
{
	...
	_DBG_(Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_release_fifo:: %d\n", fifo));
...
UInt32 csl_caph_cfifo_get_fifo_addr(CSL_CAPH_CFIFO_FIFO_e csl_fifo)
{
	...
	_DBG_(Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_get_fifo_addr:: %d\n", csl_fifo));
...
void csl_caph_cfifo_start_fifo(CSL_CAPH_CFIFO_FIFO_e csl_fifo)
{
	...
	_DBG_(Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_start_fifo:: %d\n", csl_fifo));
...
void csl_caph_cfifo_stop_fifo(CSL_CAPH_CFIFO_FIFO_e csl_fifo)
{
	...
	_DBG_(Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_stop_fifo:: %d\n", csl_fifo));
...
CSL_CAPH_CFIFO_FIFO_e csl_caph_cfifo_get_fifo_by_dma(CSL_CAPH_DMA_CHNL_e dmaCH)
{
	...
	Log_DebugPrintf(LOGID_SOC_AUDIO, "csl_caph_cfifo_get_fifo_by_dma:: %d\n", dmaCH);
