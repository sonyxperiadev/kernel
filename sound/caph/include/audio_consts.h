...
enum _AudioApp_t {
	...
	AUDIO_APP_RECORDING_HQ = 0,
	AUDIO_APP_RECORDING = 0,	/* AUDIO_APP_RECORDING_LQ */
	AUDIO_APP_RECORDING_GVS = 0,
	AUDIO_APP_FM = 0,		/*AUDIO_APP_FM_RADIO */
	AUDIO_APP_VOIP = 0,
	AUDIO_APP_VOIP_INCOMM = 0,
	AUDIO_APP_VT_CALL = 0,	/*AUDIO_APP_VT_NB */
	AUDIO_APP_VT_CALL_WB = 0,	/*AUDIO_APP_VT_WB */
	AUDIO_APP_LOOPBACK = 0,
	AUDIO_APP_RESERVED12  = 0,
	AUDIO_APP_RESERVED13 = 0,
	AUDIO_APP_RESERVED14 = 0,
	AUDIO_APP_RESERVED15 = 0
#else
