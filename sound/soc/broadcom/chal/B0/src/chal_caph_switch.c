...
typedef struct
{
    ...
    cBool   alloc_status[CHAL_CAPH_SWITCH_MAX_CHANNELS];   /* allocation status for each channel */
} chal_caph_swwitch_cb_t;
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_switch_free_channel(CHAL_HANDLE handle, CAPH_SWITCH_CHNL_e channel)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_switch_enable_clock_bypass(CHAL_HANDLE handle)
*
...
/****************************************************************************
*
*  Function Name: cVoid chal_caph_switch_disable_clock_bypass(CHAL_HANDLE handle)
*
