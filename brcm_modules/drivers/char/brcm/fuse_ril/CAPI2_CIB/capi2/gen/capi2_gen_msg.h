...
typedef struct
{
	...
	UInt8  path_len;
	UInt16  *select_path;
}CAPI2_SIM_SubmitDFileInfoReqOld_Req_t;

typedef struct
{
	SIM_DFILE_INFO_t	*val;
}CAPI2_SIM_SubmitDFileInfoReqOld_Rsp_t;
...
{
	SmsSimMsg_t	*val;
}CAPI2_SmsApi_ReadSmsMsgReq_Rsp_t;
...
{
	UInt8  cid;
}CAPI2_PCHEx_GetDecodedProtConfig_Req_t;

typedef struct
{
	PCHDecodedProtConfig_t  outParam;
}CAPI2_PCHEx_GetDecodedProtConfig_Rsp_t;
...
}CAPI2_PCHEx_BuildIpConfigOptions2_Req_t;

typedef struct
{
	PCHProtConfig_t  ip_cnfg;
}CAPI2_PCHEx_BuildIpConfigOptions2_Rsp_t;
...
typedef struct
{
	UInt8  *status;
	UInt8  data_len;
}CAPI2_SATK_SendBrowsingStatusEvent_Req_t;
...
typedef struct
{
	UInt8  *inData;
	UInt32  inDataLen;
}CAPI2_LCS_SendRrlpDataToNetwork_Req_t;
...
}CAPI2_LCS_RrcMeasurementReport_Req_t;
...
typedef struct
{
	...
	UInt32  inErrorCode;
}CAPI2_LCS_RrcMeasurementControlFailure_Req_t;

typedef struct
{
	LcsRrcMcStatus_t  inStatus;
}CAPI2_LCS_RrcStatus_Req_t;
...
{
	UInt8  cid;
}CcApi_PdpApi_GetPDPContextEx_Req_t;

typedef struct
{
	PDPDefaultContext_t  pDefaultContext;
}CcApi_PdpApi_GetPDPContextEx_Rsp_t;
