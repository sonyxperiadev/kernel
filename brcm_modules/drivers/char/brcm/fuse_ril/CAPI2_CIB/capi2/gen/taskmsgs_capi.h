...
#ifndef _CAPI_TASKMSGS_H_
#define _CAPI_TASKMSGS_H_
...
MSG_MEASURE_REPORT_PARAM_IND	= MSG_GRP_INT_UTIL+0x00,	 ///<Payload type {::MS_RxTestParam_t}
	...
	**/
	...
	/**
	This message contains the response for "MSG_SIM_SEND_APDU_REQ".
	For payload contents see :: SimApduRsp_t
	**/
	MSG_SIM_SEND_APDU_RSP				= MSG_GRP_SIM+0x70,	///<Payload type {::SimApduRsp_t}

	/**
	This message contains the response for "MSG_SIM_SELECT_APPLICATION_REQ".
	For payload contents see :: SIM_SELECT_APPLICATION_RES_t
	**/
	MSG_SIM_SELECT_APPLICATION_RSP		= MSG_GRP_SIM+0x71,	///<Payload type {::SIM_SELECT_APPLICATION_RES_t}
