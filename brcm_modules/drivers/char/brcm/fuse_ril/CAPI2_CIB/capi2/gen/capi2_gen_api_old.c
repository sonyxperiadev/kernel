...
void CAPI2_SendDFileInfoReq(UInt32 tid, UInt8 clientId, APDUFileID_t dfile_id, UInt8 path_len, const UInt16 *select_path)
{
...
void CAPI2_USIM_IsApplicationSupported(UInt32 tid, UInt8 clientId, USIM_APPLICATION_TYPE appli_type)
{
	...
	CAPI2_USimApi_IsApplicationSupported ( &clientInfo,appli_type);
...
void CAPI2_USIM_GetUst(UInt32 tid, UInt8 clientId)
{
	...
	CAPI2_USimApi_GetUst ( &clientInfo);
...
void CAPI2_PDP_GetPDPContextEx(UInt32 tid, UInt8 clientId, UInt8 cid)
{
	...
	CcApi_PdpApi_GetPDPContextEx ( &clientInfo,cid);
...
void CAPI2_PDP_RejectNWIPDPActivation(UInt32 tid, UInt8 clientId, PCHPDPAddress_t pdpAddress, PCHRejectCause_t cause, PCHAPN_t apn)
{
	...
	CAPI2_PdpApi_RejectNWIPDPActivation ( &clientInfo,pdpAddress,cause,apn);
