...
void GenGetPayloadInfo(void* dataBuf, MsgType_t msgType, void** ppBuf, UInt32* len)
{
	...
	{
		CAPI2_SIM_SubmitDFileInfoReqOld_Rsp_t* pVal = (CAPI2_SIM_SubmitDFileInfoReqOld_Rsp_t*)dataBuf;
		*ppBuf = (void*)(pVal->val);
		break;
	}
	...
	{
		CAPI2_SmsApi_ReadSmsMsgReq_Rsp_t* pVal = (CAPI2_SmsApi_ReadSmsMsgReq_Rsp_t*)dataBuf;
		*ppBuf = (void*)(pVal->val);
		break;
	}
	...
	{
		CAPI2_PCHEx_GetDecodedProtConfig_Rsp_t* pVal = (CAPI2_PCHEx_GetDecodedProtConfig_Rsp_t*)dataBuf;
		*ppBuf = (void*)pVal;
		break;
	}
	...
	{
		CAPI2_PCHEx_BuildIpConfigOptions2_Rsp_t* pVal = (CAPI2_PCHEx_BuildIpConfigOptions2_Rsp_t*)dataBuf;
		*ppBuf = (void*)pVal;
		break;
	}
	...
	case MSG_UTIL_GET_IMEI_STR_RSP:
	{
	...
	{
		CAPI2_USimApi_GetUst_Rsp_t* pVal = (CAPI2_USimApi_GetUst_Rsp_t*)dataBuf;
		*ppBuf = (void*)(pVal->val);
		break;
	}
	...
	{
		CcApi_PdpApi_GetPDPContextEx_Rsp_t* pVal = (CcApi_PdpApi_GetPDPContextEx_Rsp_t*)dataBuf;
		*ppBuf = (void*)pVal;
		break;
	}
