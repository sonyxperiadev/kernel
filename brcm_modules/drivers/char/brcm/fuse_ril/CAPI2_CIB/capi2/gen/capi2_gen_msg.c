...
bool_t xdr_CAPI2_SIM_SubmitDFileInfoReqOld_Req_t(void* xdrs, CAPI2_SIM_SubmitDFileInfoReqOld_Req_t *rsp)
{
	u_int len;

	XDR_LOG(xdrs,"CAPI2_SIM_SubmitDFileInfoReqOld_Req_t")
...
bool_t xdr_CAPI2_SIM_SubmitDFileInfoReqOld_Rsp_t(void* xdrs, CAPI2_SIM_SubmitDFileInfoReqOld_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_SIM_SubmitDFileInfoReqOld_Rsp_t")
...
bool_t xdr_CAPI2_AT_Response_Rsp_t(void* xdrs, CAPI2_AT_Response_Rsp_t *rsp)
{
	...
	if(
		 xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( AtResponse_t ), xdr_AtResponse_t) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_PMU_Battery_Register_Rsp_t(void* xdrs, CAPI2_PMU_Battery_Register_Rsp_t *rsp)
{
	...
	if(
		 xdr_HAL_EM_BATTMGR_ErrorCode_en_t(xdrs, &rsp->val) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_BattLevelInd_Rsp_t(void* xdrs, CAPI2_BattLevelInd_Rsp_t *rsp)
{
	...
	if(
		 xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( HAL_EM_BatteryLevel_t ), xdr_HAL_EM_BatteryLevel_t) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_LCS_RegisterRrlpDataHandler_Req_t(void* xdrs, CAPI2_LCS_RegisterRrlpDataHandler_Req_t *rsp)
{
	...
	if(
		xdr_ClientInfo_t(xdrs, &rsp->inRrlpHandler) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_LCS_RegisterRrcDataHandler_Req_t(void* xdrs, CAPI2_LCS_RegisterRrcDataHandler_Req_t *rsp)
{
	...
	if(
		xdr_ClientInfo_t(xdrs, &rsp->inRrcHandler) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_SmsApi_ReadSmsMsgReq_Rsp_t(void* xdrs, CAPI2_SmsApi_ReadSmsMsgReq_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_SmsApi_ReadSmsMsgReq_Rsp_t")
...
bool_t xdr_CAPI2_PdpApi_GetGPRSActivateStatus_Rsp_t(void* xdrs, CAPI2_PdpApi_GetGPRSActivateStatus_Rsp_t *rsp)
{
	...
	if(
		...
		xdr_GPRSActivate_t(xdrs, &rsp->outCidActivate) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_PCHEx_GetDecodedProtConfig_Req_t(void* xdrs, CAPI2_PCHEx_GetDecodedProtConfig_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_PCHEx_GetDecodedProtConfig_Req_t")
...
bool_t xdr_CAPI2_PCHEx_GetDecodedProtConfig_Rsp_t(void* xdrs, CAPI2_PCHEx_GetDecodedProtConfig_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_PCHEx_GetDecodedProtConfig_Rsp_t")
...
bool_t xdr_CAPI2_PCHEx_BuildIpConfigOptions2_Req_t(void* xdrs, CAPI2_PCHEx_BuildIpConfigOptions2_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_PCHEx_BuildIpConfigOptions2_Req_t")
...
bool_t xdr_CAPI2_PCHEx_BuildIpConfigOptions2_Rsp_t(void* xdrs, CAPI2_PCHEx_BuildIpConfigOptions2_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_PCHEx_BuildIpConfigOptions2_Rsp_t")
...
bool_t xdr_CAPI2_UTIL_ExtractImei_Rsp_t(void* xdrs, CAPI2_UTIL_ExtractImei_Rsp_t *rsp)
{
	...
	if(
		xdr_opaque(xdrs, (caddr_t)(void*)rsp->inImeiStrPtr,17 ) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_USimApi_GetUst_Rsp_t(void* xdrs, CAPI2_USimApi_GetUst_Rsp_t *rsp)
{
	u_int len;

	XDR_LOG(xdrs,"CAPI2_USimApi_GetUst_Rsp_t")

	if(
		xdr_copy_len(&len, MAX_UST_LEN ) && xdr_bytes(xdrs, (char **)(void*)&rsp->val, &len , ~0) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_SATK_SendBrowsingStatusEvent_Req_t(void* xdrs, CAPI2_SATK_SendBrowsingStatusEvent_Req_t *rsp)
{
	u_int len;

	XDR_LOG(xdrs,"CAPI2_SATK_SendBrowsingStatusEvent_Req_t")
...
bool_t xdr_CAPI2_LCS_SendRrlpDataToNetwork_Req_t(void* xdrs, CAPI2_LCS_SendRrlpDataToNetwork_Req_t *rsp)
{
	u_int len;

	XDR_LOG(xdrs,"CAPI2_LCS_SendRrlpDataToNetwork_Req_t")
...
bool_t xdr_CAPI2_LCS_RrcMeasurementReport_Req_t(void* xdrs, CAPI2_LCS_RrcMeasurementReport_Req_t *rsp)
{
	u_int len;

	XDR_LOG(xdrs,"CAPI2_LCS_RrcMeasurementReport_Req_t")

	if(
		_xdr_UInt16(xdrs, &rsp->inMeasurementId,"inMeasurementId") &&
		xdr_UInt32(xdrs, &rsp->inMeasDataLen) &&
		xdr_copy_len(&len, (u_int)(rsp->inMeasDataLen)) && xdr_bytes(xdrs, (char **)(void*)&rsp->inMeasData, &len, 0xFFFF) &&
		xdr_UInt32(xdrs, &rsp->inEventDataLen) &&
		xdr_copy_len(&len, (u_int)(rsp->inEventDataLen)) && xdr_bytes(xdrs, (char **)(void*)&rsp->inEventData, &len, 0xFFFF) &&
		_xdr_Boolean(xdrs, &rsp->inAddMeasResult,"inAddMeasResult") &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_LCS_RrcMeasurementControlFailure_Req_t(void* xdrs, CAPI2_LCS_RrcMeasurementControlFailure_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_LCS_RrcMeasurementControlFailure_Req_t")
...
bool_t xdr_CAPI2_LCS_RrcStatus_Req_t(void* xdrs, CAPI2_LCS_RrcStatus_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_LCS_RrcStatus_Req_t")
...
bool_t xdr_CAPI2_CcApi_MakeDataCall_Req_t(void* xdrs, CAPI2_CcApi_MakeDataCall_Req_t *rsp)
{
	...
	if(
		xdr_pointer(xdrs, (char**)(void*)&rsp->callNum,sizeof( UInt8 ), xdr_UInt8) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CcApi_PdpApi_GetPDPContextEx_Req_t(void* xdrs, CcApi_PdpApi_GetPDPContextEx_Req_t *rsp)
{
	XDR_LOG(xdrs,"CcApi_PdpApi_GetPDPContextEx_Req_t")
...
bool_t xdr_CcApi_PdpApi_GetPDPContextEx_Rsp_t(void* xdrs, CcApi_PdpApi_GetPDPContextEx_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CcApi_PdpApi_GetPDPContextEx_Rsp_t")
...
bool_t xdr_CAPI2_PdpApi_SendPDPActivateReq_PDU_Req_t(void* xdrs, CAPI2_PdpApi_SendPDPActivateReq_PDU_Req_t *rsp)
{
	...
	if(
		...
		xdr_PCHPDPActivatePDU_t(xdrs, &rsp->pdu) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_PdpApi_RejectNWIPDPActivation_Req_t(void* xdrs, CAPI2_PdpApi_RejectNWIPDPActivation_Req_t *rsp)
{
	...
	if(
		xdr_PCHPDPAddress_t(xdrs, &rsp->pdpAddress) &&
		xdr_PCHRejectCause_t(xdrs, &rsp->cause) &&
		xdr_PCHAPN_t(xdrs, &rsp->apn) &&
	1)
		return TRUE;
	else
		return FALSE;
