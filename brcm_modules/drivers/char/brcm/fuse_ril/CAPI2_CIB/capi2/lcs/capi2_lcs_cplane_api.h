...
**/
extern void CAPI2_LCS_SendRrlpDataToNetwork(ClientInfo_t inRrlpHandler, const UInt8 *inData, UInt32 inDataLen);
...
*	@param		inRrlpHandler	(in) The info of the client that will handle the RRLP messages.
	...
	@sa			::MSG_LCS_REG_RRLP_HDL_REQ  ::ClientInfo_t<br>
			
**/
extern void CAPI2_LCS_RegisterRrlpDataHandler(UInt32 tid,  UInt8 clientID, ClientInfo_t inRrlpHandler);
...
*
	...
	@sa			::MSG_LCS_REG_RRC_HDL_REQ  ::ClientInfo_t<br>
			
**/
extern void CAPI2_LCS_RegisterRrcDataHandler(UInt32 tid,  UInt8 clientID, ClientInfo_t inRrcHandler);
...
**/
extern void CAPI2_LCS_RrcMeasurementReport(ClientInfo_t inRrcHandler, 
...
**/
extern void CAPI2_LCS_RrcMeasurementControlFailure(ClientInfo_t inRrcHandler, 
...
**/
extern void CAPI2_LCS_RrcStatus(ClientInfo_t inRrcHandler, LcsRrcMcStatus_t inStatus);
