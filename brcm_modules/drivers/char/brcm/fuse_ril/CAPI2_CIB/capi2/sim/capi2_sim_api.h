...
/**
	...
	@param		*client_info_ptr (in) pointer to ClientInfo
...
void CAPI2_SIM_SubmitDFileInfoReqOld(UInt32 tid, UInt8 clientID,  UInt8 socket_id, APDUFileID_t dfile_id, UInt8 path_len,
