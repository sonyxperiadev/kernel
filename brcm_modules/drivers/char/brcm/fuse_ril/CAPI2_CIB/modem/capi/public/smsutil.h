...
*   @file   smsutil.h
*
*   @brief  This file defines the utilities interface for SMS API.
*
****************************************************************************/
...
// default setting API
void SMS_InitDefaultTxParam(void);
SmsTxParam_t* SMS_GetDefaultTxParamPtr( void );
void SMS_InitDefRxSettings(void);
...
void SMS_InitSmsBearerPref( void );
void SMS_InitSmsPrefProfile( void );
...
// These functions are moved to sms_util.c:
UInt8 SMS_BCDConversion(UInt8 bcd_digit);
