...
// High and Low watermark         Flow Control, Tony, 09/18/10
#define HIGH_WATERMARK            90    // Each block size is 3200 may contains 2 packets with 1500 byte, then 15/16 = 93.75%
#define LOW_WATERMARK             75    // 
...
/* MobC00061383/CSP204798 */
    ...
    UInt8  r7_qos_ext;
    Boolean watermark_updated;        // flow control, Tony, 09/18/10
