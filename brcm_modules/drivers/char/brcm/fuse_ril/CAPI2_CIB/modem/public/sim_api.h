...
**/	
const UInt8* USimApi_GetUst(ClientInfo_t* inClientInfoPtr);
...
**/	
Boolean USimApi_IsApplicationSupported(ClientInfo_t* inClientInfoPtr, USIM_APPLICATION_TYPE appli_type);
