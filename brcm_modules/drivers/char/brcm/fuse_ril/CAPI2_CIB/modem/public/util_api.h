...
//**************************************************************************************
/**
	Util_GetPartyAddress() This function parses the party number, which  consists of
	Type of Number (TON), Numbering Plan Identification (NPI) and number of digits.
	@param		inPartyAddPtr (in) Called/Calling party phone address pointer.
	@param		inLength (in) Length of the number dialed.
	@param		inDataPtr (in) Pointer to the dialed number.
	@return		void (out)
**/
void Util_GetPartyAddress(	PartyAddress_t*	inPartyAddPtr,
							UInt8			inLength,
							UInt8*			inDataPtr);
//**************************************************************************************
/**
	Util_GetPartyAddress() This function parses the party number sub-address, which
	consists of Type of Subaddress (TOS), Odd/Even indicator, and number of digits.
	@param		inPartySubAddPtr (in) Called/Calling party phone subaddress pointer.
	@param		inLength (in) Length of the number dialed.
	@param		inDataPtr (in) Pointer to the dialed number.
	@return		void (out)
**/
void Util_GetPartySubAdd(	PartySubAdd_t*	inPartySubAddPtr,
							UInt8			inLength,
							UInt8*			inDataPtr);
//***********************************************************************************
/**
