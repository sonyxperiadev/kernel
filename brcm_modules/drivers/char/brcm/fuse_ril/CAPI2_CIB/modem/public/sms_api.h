...
// This header file is included here to make the xscript to build. Once the xscript includes the new header file in the 
// next CIB release, this include can then be removed.
