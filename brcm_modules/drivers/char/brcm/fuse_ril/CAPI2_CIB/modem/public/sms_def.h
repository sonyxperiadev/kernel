...
// API logging data types for SMS
typedef struct {
	ClientInfo_t clientInfo;
	UInt8 length;
	UInt8 inSmsPdu[SMS_MAX_PDU_STRING_LENGTH];
	Sms_411Addr_t sca;
} T_SmsApi_SendSMSPduReq;
/*
typedef struct {
	SIGNAL_VARS
	T_SmsApi_SendSMSPduReq Param1;
} yPDef_SMSAPI_SEND_SMS_PDU_REQ;
*/
typedef struct {
	ClientInfo_t clientInfo;
	UInt8 inNum[20];
...
typedef struct {
	SIGNAL_VARS
	T_SmsApi_SendSMSReq Param1;
} yPDef_SMSAPI_SEND_SMS_REQ;
*/
