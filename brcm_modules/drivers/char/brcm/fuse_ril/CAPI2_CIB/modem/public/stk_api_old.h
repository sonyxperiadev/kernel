...
**/
void SATK_SendBrowsingStatusEvent(UInt8 *status, UInt8 len);
...
**/
void SATK_SendNwSearchModeChgEvent(PlmnSelectMode_t plmnMode);

//**************************************************************************************
/**
    This function sends terminal response to USIMAP for Active command.

    @param resultCode (in) One of SATK_Result_CmdSuccess; SATK_Result_BeyondMeCapability; SATK_Result_DataUnknownToMe; SATK_Result_MeUnableToProcessCmd.

**/
void SATK_SendActivateRes(SATK_ResultCode_t resultCode);
