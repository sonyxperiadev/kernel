...
*
*******************************************************************************/
extern Result_t LCS_RegisterRrcDataHandler(ClientInfo_t inRrcHandler);
...
extern Result_t LCS_RrcMeasurementReport(ClientInfo_t inRrcHandler, 
...
**
********************************************************************************/
extern Result_t LCS_RrcMeasurementControlFailure(ClientInfo_t inRrcHandler, UInt16 inTransactionId, LcsRrcMcFailure_t inMcFailure, UInt32 inErrorCode);
...
**
********************************************************************************/
extern Result_t LCS_RrcStatus(ClientInfo_t inRrcHandler, LcsRrcMcStatus_t inStatus);
