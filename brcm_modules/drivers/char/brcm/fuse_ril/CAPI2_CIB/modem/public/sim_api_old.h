...
//***************************************************************************************
/**
	This function returns the pointer to the EF-UST data.

    @return Pointer to the EF-UST data.
**/	
const UInt8* USIM_GetUst(void);
...
**/	
Boolean USIM_IsApplicationSupported(USIM_APPLICATION_TYPE appli_type);
...
**/	
Result_t SIM_SendDFileInfoReq(ClientInfo_t* client_info_ptr, APDUFileID_t dfile_id, UInt8 path_len,
