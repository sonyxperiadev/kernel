...
#if defined(RTOS_NUCLEUS) || defined(WIN32)
#define	OS_MAX_NAME_LEN					8	// must be 8 chars
#define	OS_QUEUE_SIZE					18  // ulongs
#define	OS_EVENT_GROUP_SIZE				9  // ulongs
#define	OS_SEMAPHORE_SIZE				10  // ulongs
#define	OS_MUTEX_SIZE					10
#define	OS_TIMER_SIZE					17  // ulongs
#define	OS_PARTITION_POOL_SIZE			15  // ulongs
#define	OS_MEMORY_POOL_SIZE				17  // ulongs
#define OS_BLOCK_MEMORY_HEADER_SIZE     32  //bytes
#define OS_BYTE_MEMORY_HEADER_SIZE      32  //bytes
#define OS_TCB_HEADER_SIZE              168  //bytes
...
#ifdef ARM_FPU
#define OS_TCB_HEADER_SIZE              532  //bytes
#else
#define OS_TCB_HEADER_SIZE              256  //bytes
#endif
