...
*/
HAL_EM_PMU_Result_en_t HAL_EM_PMU_Ctrl_Private(
...
*   PMU hardware events
*/
HAL_EM_PMU_Result_en_t HAL_EM_PMU_RegisterEventCB_Private(
...
*   PMU ID change event
*/
HAL_EM_PMU_Result_en_t HAL_EM_PMU_RegisterIDChangEventCB(
	HAL_EM_PMU_IdChange_cb_t			callback				///< (in) Callback routine
	);

/**
*   Function for lower layer: PMU driver to call for ID change
*   event
*/
