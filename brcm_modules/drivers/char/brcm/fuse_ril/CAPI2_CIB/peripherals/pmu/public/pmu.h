...
// Maintain legacy switches for 603. Define one module only.
#ifdef PMU_PCF50603					// this is a global switch
	#undef  PMU_PCF50604_04_1  		// for PMU1B
	#undef  PMU_PCF50604_03_2		// for PMU2
	#undef	PMU_PCF50603_1A			// for PMU version 50603_1A
	#define PMU_PCF50603_1B			// for PMU version 50603_1B
#endif	// #ifdef PMU_PCF50603

// Select specific PMU device header
#ifdef PMU_PCF50604_04_1
    #include "pmu_pcf50604_04_1.h"
#elif defined( PMU_PCF50604_03_2 )
    #include "pmu_pcf50604_03_2.h"
#elif defined( PMU_PCF50603_1A )
    #include "pmu_pcf50603_1a.h"
#elif defined( PMU_PCF50603_1B )
	#include "pmu_pcf50603.h"
	#define PMU_PCF50603_1A
#elif defined( PMU_PCF50611 )
    #include "pmu_pcf50611.h"
#elif defined ( WIN32)         
    #if defined ( PMU_BCM59001 )
         #include "pmu_bcm59001.h"
    #elif defined ( PMU_BCM59035 )
       #if defined (BCM59035_REV_B0)
         #include "pmu_bcm59035b0.h"
       #else
         #include "pmu_bcm59035.h"
       #endif
	#elif defined(PMU_BCM59036)
		#include "pmu_bcm59036.h"
...
//*******************************************************************************
/**
*PMU_DRV_DeactivateSIM
*******************************************************************************/
void PMU_DRV_DeactivateSIM( PMU_SIMLDO_t simldo );
