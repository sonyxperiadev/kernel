...
****************************************************************************/
	...
	**/
	MSG_SIM_EFILE_UPDATE_REQ  = 0x40B3,	///<Payload type {::CAPI2_SimFileInfo_t}
	 /** 
	capi2 api is CAPI2_SIM_SubmitLinearEFileUpdateReq 
	**/
	MSG_SIM_LINEAR_EFILE_UPDATE_REQ  = 0x40B4,	///<Payload type {::CAPI2_SimFileInfo_t}
	 /** 
	capi2 api is CAPI2_SIM_SubmitSeekRecordReq 
	**/
	MSG_SIM_SEEK_RECORD_REQ  = 0x40B5,	///<Payload type {::CAPI2_SimFileInfo_t}
	 /** 
	capi2 api is CAPI2_SIM_SubmitCyclicEFileUpdateReq 
	**/
	MSG_SIM_CYCLIC_EFILE_UPDATE_REQ  = 0x40B6,	///<Payload type {::CAPI2_SimFileInfo_t}
	 /** 
	capi2 api is CAPI2_SIM_SendRemainingPinAttemptReq 
	**/
	MSG_SIM_PIN_ATTEMPT_REQ  = 0x40B7,
	 /** 
	capi2 api is CAPI2_SIM_IsCachedDataReady 
	**/
	MSG_SIM_CACHE_DATA_READY_REQ  = 0x40B8,
	 /** 
	payload is ::SIM_BOOLEAN_DATA_t 
	**/
	MSG_SIM_CACHE_DATA_READY_RSP  = 0x40B9,	///<Payload type {::SIM_BOOLEAN_DATA_t}
	 /** 
	capi2 api is CAPI2_SIM_GetServiceCodeStatus 
	**/
	MSG_SIM_SERVICE_CODE_STATUS_REQ  = 0x40BA,	///<Payload type {::CAPI2_SIM_GetServiceCodeStatus_Req_t}
	 /** 
	payload is ::SIM_SERVICE_FLAG_STATUS_t 
	**/
	MSG_SIM_SERVICE_CODE_STATUS_RSP  = 0x40BB,	///<Payload type {::SIM_SERVICE_FLAG_STATUS_t}
	 /** 
	capi2 api is CAPI2_SIM_CheckCphsService 
	**/
	MSG_SIM_CHECK_CPHS_REQ  = 0x40BC,	///<Payload type {::CAPI2_SIM_CheckCphsService_Req_t}
	 /** 
	payload is ::SIM_BOOLEAN_DATA_t 
	**/
	MSG_SIM_CHECK_CPHS_RSP  = 0x40BD,	///<Payload type {::SIM_BOOLEAN_DATA_t}
	 /** 
	capi2 api is CAPI2_SIM_GetCphsPhase 
	**/
	MSG_SIM_CPHS_PHASE_REQ  = 0x40BE,
	 /** 
	payload is ::SIM_INTEGER_DATA_t 
	**/
	MSG_SIM_CPHS_PHASE_RSP  = 0x40BF,	///<Payload type {::SIM_INTEGER_DATA_t}
	 /** 
	capi2 api is CAPI2_SIM_GetSmsSca 
	**/
	MSG_SIM_SMS_SCA_REQ  = 0x40C0,	///<Payload type {::CAPI2_SIM_GetSmsSca_Req_t}
	 /** 
	payload is ::SIM_SCA_DATA_RESULT_t 
	**/
	MSG_SIM_SMS_SCA_RSP  = 0x40C1,	///<Payload type {::SIM_SCA_DATA_RESULT_t}
	 /** 
	capi2 api is CAPI2_SIM_GetIccid 
	**/
	MSG_SIM_ICCID_PARAM_REQ  = 0x40C2,
	 /** 
	payload is ::SIM_ICCID_STATUS_t 
	**/
	MSG_SIM_ICCID_PARAM_RSP  = 0x40C3,	///<Payload type {::SIM_ICCID_STATUS_t}
	 /** 
	capi2 api is CAPI2_SIM_IsALSEnabled 
	**/
	MSG_SIM_ALS_STATUS_REQ  = 0x40C4,
	 /** 
	payload is ::SIM_BOOLEAN_DATA_t 
	**/
	MSG_SIM_ALS_STATUS_RSP  = 0x40C5,	///<Payload type {::SIM_BOOLEAN_DATA_t}
	 /** 
	capi2 api is CAPI2_SIM_GetAlsDefaultLine 
	**/
	MSG_SIM_ALS_DEFAULT_LINE_REQ  = 0x40C6,
	 /** 
	payload is ::SIM_INTEGER_DATA_t 
	**/
	MSG_SIM_ALS_DEFAULT_LINE_RSP  = 0x40C7,	///<Payload type {::SIM_INTEGER_DATA_t}
	 /** 
	capi2 api is CAPI2_SIM_SetAlsDefaultLine 
	**/
	MSG_SIM_SET_ALS_DEFAULT_REQ  = 0x40C8,	///<Payload type {::CAPI2_SIM_SetAlsDefaultLine_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SIM_SET_ALS_DEFAULT_RSP  = 0x40C9,
	 /** 
	capi2 api is CAPI2_SIM_GetCallForwardUnconditionalFlag 
	**/
	MSG_SIM_CALLFWD_COND_FLAG_REQ  = 0x40CA,
	 /** 
	payload is ::SIM_CALL_FORWARD_UNCONDITIONAL_STATUS_t 
	**/
	MSG_SIM_CALLFWD_COND_FLAG_RSP  = 0x40CB,	///<Payload type {::SIM_CALL_FORWARD_UNCONDITIONAL_STATUS_t}
	 /** 
	capi2 api is CAPI2_SIM_GetApplicationType 
	**/
	MSG_SIM_APP_TYPE_REQ  = 0x40CC,
	 /** 
	payload is ::SIM_APPL_TYPE_RESULT_t 
	**/
	MSG_SIM_APP_TYPE_RSP  = 0x40CD,	///<Payload type {::SIM_APPL_TYPE_RESULT_t}
	 /** 
	capi2 api is CAPI2_USIM_GetUst 
	**/
	MSG_USIM_UST_DATA_REQ  = 0x40CE,
	 /** 
	payload is ::USIM_UST_DATA_RSP_t 
	**/
	MSG_USIM_UST_DATA_RSP  = 0x40CF,	///<Payload type {::USIM_UST_DATA_RSP_t}
	 /** 
	capi2 api is CAPI2_SIM_SendUpdatePrefListReq 
	**/
	MSG_SIM_PLMN_WRITE_REQ  = 0x40D0,	///<Payload type {::CAPI2_SIM_SendUpdatePrefListReq_t}
	 /** 
	capi2 api is CAPI2_SIM_SendWritePuctReq 
	**/
	MSG_SIM_PUCT_UPDATE_REQ  = 0x40D1,	///<Payload type {::CAPI2_SIM_SendWritePuctReq_t}
	 /** 
	capi2 api is CAPI2_SIM_SendGenericAccessReq 
	**/
	MSG_SIM_GENERIC_ACCESS_REQ  = 0x40D2,	///<Payload type {::CAPI2_SIM_SendGenericAccessReq_t}
	 /** 
	capi2 api is CAPI2_SIM_SubmitRestrictedAccessReq 
	**/
	MSG_SIM_RESTRICTED_ACCESS_REQ  = 0x40D3,	///<Payload type {::CAPI2_SIM_SendRestrictedAccessReq_t}
	 /** 
	capi2 api is CAPI2_ADCMGR_Start 
	**/
	MSG_ADC_START_REQ  = 0x40D4,	///<Payload type {::CAPI2_ADCMGR_Start_Req_t}
	 /** 
	capi2 api is CAPI2_AT_ProcessCmd 
	**/
	MSG_CAPI2_AT_COMMAND_REQ  = 0x40D5,	///<Payload type {::CAPI2_AT_ProcessCmd_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_CAPI2_AT_COMMAND_RSP  = 0x40D6,
	 /** 
	capi2 api is CAPI2_MS_GetSystemRAT 
	**/
	MSG_MS_GET_SYSTEM_RAT_REQ  = 0x40D7,
	 /** 
	payload is ::RATSelect_t 
	**/
	MSG_MS_GET_SYSTEM_RAT_RSP  = 0x40D8,	///<Payload type {::RATSelect_t}
	 /** 
	capi2 api is CAPI2_MS_GetSupportedRAT 
	**/
	MSG_MS_GET_SUPPORTED_RAT_REQ  = 0x40D9,
	 /** 
	payload is ::RATSelect_t 
	**/
	MSG_MS_GET_SUPPORTED_RAT_RSP  = 0x40DA,	///<Payload type {::RATSelect_t}
	 /** 
	capi2 api is CAPI2_MS_GetSystemBand 
	**/
	MSG_MS_GET_SYSTEM_BAND_REQ  = 0x40DB,
	 /** 
	payload is ::BandSelect_t 
	**/
	MSG_MS_GET_SYSTEM_BAND_RSP  = 0x40DC,	///<Payload type {::BandSelect_t}
	 /** 
	capi2 api is CAPI2_MS_GetSupportedBand 
	**/
	MSG_MS_GET_SUPPORTED_BAND_REQ  = 0x40DD,
	 /** 
	payload is ::BandSelect_t 
	**/
	MSG_MS_GET_SUPPORTED_BAND_RSP  = 0x40DE,	///<Payload type {::BandSelect_t}
	 /** 
	capi2 api is CAPI2_SYSPARM_GetMSClass 
	**/
	MSG_SYSPARAM_GET_MSCLASS_REQ  = 0x40DF,
	 /** 
	payload is ::UInt16 
	**/
	MSG_SYSPARAM_GET_MSCLASS_RSP  = 0x40E0,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_AUDIO_GetMicrophoneGainSetting 
	**/
	MSG_AUDIO_GET_MIC_GAIN_REQ  = 0x40E1,
	 /** 
	payload is ::UInt16 
	**/
	MSG_AUDIO_GET_MIC_GAIN_RSP  = 0x40E2,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_AUDIO_GetSpeakerVol 
	**/
	MSG_AUDIO_GET_SPEAKER_VOL_REQ  = 0x40E3,
	 /** 
	payload is ::UInt16 
	**/
	MSG_AUDIO_GET_SPEAKER_VOL_RSP  = 0x40E4,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_AUDIO_SetSpeakerVol 
	**/
	MSG_AUDIO_SET_SPEAKER_VOL_REQ  = 0x40E5,	///<Payload type {::CAPI2_AUDIO_SetSpeakerVol_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_AUDIO_SET_SPEAKER_VOL_RSP  = 0x40E6,
	 /** 
	capi2 api is CAPI2_AUDIO_SetMicrophoneGain 
	**/
	MSG_AUDIO_SET_MIC_GAIN_REQ  = 0x40E7,	///<Payload type {::CAPI2_AUDIO_SetMicrophoneGain_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_AUDIO_SET_MIC_GAIN_RSP  = 0x40E8,
	 /** 
	capi2 api is CAPI2_SYSPARM_GetManufacturerName 
	**/
	MSG_SYSPARAM_GET_MNF_NAME_REQ  = 0x40E9,
	 /** 
	payload is ::uchar_ptr_t 
	**/
	MSG_SYSPARAM_GET_MNF_NAME_RSP  = 0x40EA,	///<Payload type {::uchar_ptr_t}
	 /** 
	capi2 api is CAPI2_SYSPARM_GetModelName 
	**/
	MSG_SYSPARAM_GET_MODEL_NAME_REQ  = 0x40EB,
	 /** 
	payload is ::uchar_ptr_t 
	**/
	MSG_SYSPARAM_GET_MODEL_NAME_RSP  = 0x40EC,	///<Payload type {::uchar_ptr_t}
	 /** 
	capi2 api is CAPI2_SYSPARM_GetSWVersion 
	**/
	MSG_SYSPARAM_GET_SW_VERSION_REQ  = 0x40ED,
	 /** 
	payload is ::uchar_ptr_t 
	**/
	MSG_SYSPARAM_GET_SW_VERSION_RSP  = 0x40EE,	///<Payload type {::uchar_ptr_t}
	 /** 
	capi2 api is CAPI2_SYSPARM_GetEGPRSMSClass 
	**/
	MSG_SYSPARAM_GET_EGPRS_CLASS_REQ  = 0x40EF,
	 /** 
	payload is ::UInt16 
	**/
	MSG_SYSPARAM_GET_EGPRS_CLASS_RSP  = 0x40F0,	///<Payload type {::UInt16}
	 /** 
	...
	**/
	MSG_SYSPARAM_GET_IMEI_REQ  = 0x4105,	///<Payload type {::CAPI2_SYSPARM_GetImei_Req_t}
	 /** 
	...
	**/
	MSG_AUDIO_DRV_SetAudioMode_REQ  = 0x4263,	///<Payload type {::CAPI2_AUDIO_DRV_SetAudioMode_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_AUDIO_DRV_SetAudioMode_RSP  = 0x4264,
	 /** 
	capi2 api is CAPI2_SPEAKER_StartTone 
	**/
	MSG_SPEAKER_StartTone_REQ  = 0x4265,	///<Payload type {::CAPI2_SPEAKER_StartTone_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SPEAKER_StartTone_RSP  = 0x4266,
	 /** 
	capi2 api is CAPI2_SPEAKER_StartGenericTone 
	**/
	MSG_SPEAKER_StartGenericTone_REQ  = 0x4267,	///<Payload type {::CAPI2_SPEAKER_StartGenericTone_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SPEAKER_StartGenericTone_RSP  = 0x4268,
	 /** 
	capi2 api is CAPI2_SPEAKER_StopTone 
	**/
	MSG_SPEAKER_StopTone_REQ  = 0x4269,
	 /** 
	payload is ::default_proc 
	**/
	MSG_SPEAKER_StopTone_RSP  = 0x426A,
	 /** 
	capi2 api is CAPI2_AUDIO_Turn_EC_NS_OnOff 
	**/
	MSG_AUDIO_Turn_EC_NS_OnOff_REQ  = 0x426B,	///<Payload type {::CAPI2_AUDIO_Turn_EC_NS_OnOff_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_AUDIO_Turn_EC_NS_OnOff_RSP  = 0x426C,
	 /** 
	capi2 api is CAPI2_ECHO_SetDigitalTxGain 
	**/
	MSG_ECHO_SetDigitalTxGain_REQ  = 0x426D,	///<Payload type {::CAPI2_ECHO_SetDigitalTxGain_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_ECHO_SetDigitalTxGain_RSP  = 0x426E,
	 /** 
	capi2 api is CAPI2_RIPCMDQ_Connect_Uplink 
	**/
	MSG_RIPCMDQ_Connect_Uplink_REQ  = 0x426F,	///<Payload type {::CAPI2_RIPCMDQ_Connect_Uplink_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_RIPCMDQ_Connect_Uplink_RSP  = 0x4270,
	 /** 
	capi2 api is CAPI2_RIPCMDQ_Connect_Downlink 
	**/
	MSG_RIPCMDQ_Connect_Downlink_REQ  = 0x4271,	///<Payload type {::CAPI2_RIPCMDQ_Connect_Downlink_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_RIPCMDQ_Connect_Downlink_RSP  = 0x4272,
	 /** 
	capi2 api is CAPI2_VOLUMECTRL_SetBasebandVolume 
	**/
	MSG_VOLUMECTRL_SetBasebandVolume_REQ  = 0x4273,	///<Payload type {::CAPI2_VOLUMECTRL_SetBasebandVolume_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_VOLUMECTRL_SetBasebandVolume_RSP  = 0x4274,
	 /** 
	capi2 api is CAPI2_DIAG_ApiMeasurmentReportReq 
	**/
	MSG_DIAG_MEASURE_REPORT_REQ  = 0x4275,	///<Payload type {::CAPI2_DIAG_ApiMeasurmentReportReq_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_DIAG_MEASURE_REPORT_RSP  = 0x4276,
	 /** 
	capi2 api is CAPI2_PMU_BattChargingNotification 
	**/
	MSG_PMU_BATT_CHARGING_NOTIFICATION_REQ  = 0x4277,	///<Payload type {::CAPI2_PMU_BattChargingNotification_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_PMU_BATT_CHARGING_NOTIFICATION_RSP  = 0x4278,
	 /** 
	capi2 api is CAPI2_PATCH_GetRevision 
	**/
	MSG_PATCH_GET_REVISION_REQ  = 0x4279,
	 /** 
	payload is ::CAPI2_Patch_Revision_Ptr_t 
	**/
	MSG_PATCH_GET_REVISION_RSP  = 0x427A,	///<Payload type {::CAPI2_Patch_Revision_Ptr_t}
	 /** 
	capi2 api is CAPI2_RTC_SetTime 
	**/
	MSG_RTC_SetTime_REQ  = 0x427B,	///<Payload type {::CAPI2_RTC_SetTime_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_RTC_SetTime_RSP  = 0x427C,
	 /** 
	capi2 api is CAPI2_RTC_SetDST 
	**/
	MSG_RTC_SetDST_REQ  = 0x427D,	///<Payload type {::CAPI2_RTC_SetDST_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_RTC_SetDST_RSP  = 0x427E,
	 /** 
	capi2 api is CAPI2_RTC_SetTimeZone 
	**/
	MSG_RTC_SetTimeZone_REQ  = 0x427F,	///<Payload type {::CAPI2_RTC_SetTimeZone_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_RTC_SetTimeZone_RSP  = 0x4280,
	 /** 
	capi2 api is CAPI2_MS_InitCallCfg 
	**/
	MSG_MS_INITCALLCFG_REQ  = 0x4281,
	 /** 
	payload is ::default_proc 
	**/
	MSG_MS_INITCALLCFG_RSP  = 0x4282,
	 /** 
	capi2 api is CAPI2_MS_InitFaxConfig 
	**/
	MSG_MS_INITFAXCFG_REQ  = 0x4283,
	 /** 
	payload is ::default_proc 
	**/
	MSG_MS_INITFAXCFG_RSP  = 0x4284,
	 /** 
	capi2 api is CAPI2_MS_InitVideoCallCfg 
	**/
	MSG_MS_INITVIDEOCALLCFG_REQ  = 0x4285,
	 /** 
	payload is ::default_proc 
	**/
	MSG_MS_INITVIDEOCALLCFG_RSP  = 0x4286,
	 /** 
	capi2 api is CAPI2_MS_InitCallCfgAmpF 
	**/
	MSG_MS_INITCALLCFGAMPF_REQ  = 0x4287,
	 /** 
	payload is ::default_proc 
	**/
	MSG_MS_INITCALLCFGAMPF_RSP  = 0x4288,
	 /** 
	capi2 api is CAPI2_RTC_GetTime 
	**/
	MSG_RTC_GetTime_REQ  = 0x4289,	///<Payload type {::CAPI2_RTC_GetTime_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_RTC_GetTime_RSP  = 0x428A,
	 /** 
	capi2 api is CAPI2_RTC_GetTimeZone 
	**/
	MSG_RTC_GetTimeZone_REQ  = 0x428B,
	 /** 
	payload is ::Int8 
	**/
	MSG_RTC_GetTimeZone_RSP  = 0x428C,	///<Payload type {::Int8}
	 /** 
	capi2 api is CAPI2_RTC_GetDST 
	**/
	MSG_RTC_GetDST_REQ  = 0x428D,
	 /** 
	payload is ::UInt8 
	**/
	MSG_RTC_GetDST_RSP  = 0x428E,	///<Payload type {::UInt8}
	 /** 
	capi2 api is CAPI2_SMS_GetMeSmsBufferStatus 
	**/
	MSG_SMS_GETMESMS_BUF_STATUS_REQ  = 0x428F,	///<Payload type {::CAPI2_SMS_GetMeSmsBufferStatus_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SMS_GETMESMS_BUF_STATUS_RSP  = 0x4290,
	 /** 
	capi2 api is CAPI2_SMS_GetRecordNumberOfReplaceSMS 
	**/
	MSG_SMS_GETRECORDNUMBEROFREPLACESMS_REQ  = 0x4291,	///<Payload type {::CAPI2_SMS_GetRecordNumberOfReplaceSMS_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SMS_GETRECORDNUMBEROFREPLACESMS_RSP  = 0x4292,
	 /** 
	capi2 api is CAPI2_PMU_BattFullInd 
	**/
	MSG_PMU_BATT_FULL_REQ  = 0x4293,
	 /** 
	payload is ::default_proc 
	**/
	MSG_PMU_BATT_FULL_RSP  = 0x4294,
	 /** 
	capi2 api is CAPI2_FLASH_SaveImage 
	**/
	MSG_FLASH_SAVEIMAGE_REQ  = 0x4295,	///<Payload type {::CAPI2_FLASH_SaveImage_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_FLASH_SAVEIMAGE_RSP  = 0x4296,
	 /** 
	capi2 api is CAPI2_AUDIO_GetSettings 
	**/
	MSG_AUDIO_GET_SETTINGS_REQ  = 0x4297,	///<Payload type {::CAPI2_AUDIO_GetSettings_Req_t}
	 /** 
	payload is ::Capi2AudioParams_t 
	**/
	MSG_AUDIO_GET_SETTINGS_RSP  = 0x4298,	///<Payload type {::Capi2AudioParams_t}
	 /** 
	capi2 api is CAPI2_AUDIO_GetSettingsEx 
	**/
	MSG_AUDIO_GET_SETTINGSEX_REQ  = 0x4299,	///<Payload type {::CAPI2_AUDIO_GetSettingsEx_Req_t}
	 /** 
	payload is ::Capi2AudioParams_t 
	**/
	MSG_AUDIO_GET_SETTINGSEX_RSP  = 0x429A,	///<Payload type {::Capi2AudioParams_t}
	 /** 
	capi2 api is CAPI2_SIMLOCK_GetStatus 
	**/
	MSG_SIMLOCK_GET_STATUS_REQ  = 0x429B,	///<Payload type {::CAPI2_SIMLOCK_GetStatus_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SIMLOCK_GET_STATUS_RSP  = 0x429C,
	 /** 
	capi2 api is CAPI2_SIMLOCK_SetStatus 
	**/
	MSG_SIMLOCK_SET_STATUS_REQ  = 0x429D,	///<Payload type {::CAPI2_SIMLOCK_SetStatus_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SIMLOCK_SET_STATUS_RSP  = 0x429E,
	 /** 
	capi2 api is CAPI2_SYSPARM_GetActualLowVoltReading 
	**/
	MSG_SYSPARM_GET_ACTUAL_LOW_VOLT_REQ  = 0x429F,
	 /** 
	payload is ::UInt16 
	**/
	MSG_SYSPARM_GET_ACTUAL_LOW_VOLT_RSP  = 0x42A0,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_SYSPARM_GetActual4p2VoltReading 
	**/
	MSG_SYSPARM_GET_ACTUAL_4P2_VOLT_REQ  = 0x42A1,
	 /** 
	payload is ::UInt16 
	**/
	MSG_SYSPARM_GET_ACTUAL_4P2_VOLT_RSP  = 0x42A2,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_program_equalizer 
	**/
	MSG_PROG_EQU_TYPE_REQ  = 0x42A3,	///<Payload type {::CAPI2_program_equalizer_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_PROG_EQU_TYPE_RSP  = 0x42A4,
	 /** 
	capi2 api is CAPI2_program_poly_equalizer 
	**/
	MSG_PROG_POLY_EQU_TYPE_REQ  = 0x42A5,	///<Payload type {::CAPI2_program_poly_equalizer_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_PROG_POLY_EQU_TYPE_RSP  = 0x42A6,
	 /** 
	capi2 api is CAPI2_program_FIR_IIR_filter 
	**/
	MSG_PROG_FIR_IIR_FILTER_REQ  = 0x42A7,	///<Payload type {::CAPI2_program_FIR_IIR_filter_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_PROG_FIR_IIR_FILTER_RSP  = 0x42A8,
	 /** 
	capi2 api is CAPI2_program_poly_FIR_IIR_filter 
	**/
	MSG_PROG_POLY_FIR_IIR_FILTER_REQ  = 0x42A9,	///<Payload type {::CAPI2_program_poly_FIR_IIR_filter_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_PROG_POLY_FIR_IIR_FILTER_RSP  = 0x42AA,
	 /** 
	capi2 api is CAPI2_audio_control_generic 
	**/
	MSG_AUDIO_CTRL_GENERIC_REQ  = 0x42AB,	///<Payload type {::CAPI2_audio_control_generic_Req_t}
	 /** 
	payload is ::UInt32 
	**/
	MSG_AUDIO_CTRL_GENERIC_RSP  = 0x42AC,	///<Payload type {::UInt32}
	 /** 
	capi2 api is CAPI2_audio_control_dsp 
	**/
	MSG_AUDIO_CTRL_DSP_REQ  = 0x42AD,	///<Payload type {::CAPI2_audio_control_dsp_Req_t}
	 /** 
	payload is ::UInt32 
	**/
	MSG_AUDIO_CTRL_DSP_RSP  = 0x42AE,	///<Payload type {::UInt32}
	 /** 
	capi2 api is CAPI2_FFS_Read 
	**/
	MSG_FFS_READ_REQ  = 0x42AF,	///<Payload type {::CAPI2_FFS_Read_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_FFS_READ_RSP  = 0x42B0,
	 /** 
	capi2 api is CAPI2_DIAG_ApiCellLockReq 
	**/
	MSG_DIAG_CELLLOCK_REQ  = 0x42B1,	///<Payload type {::CAPI2_DIAG_ApiCellLockReq_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_DIAG_CELLLOCK_RSP  = 0x42B2,
	 /** 
	capi2 api is CAPI2_DIAG_ApiCellLockStatus 
	**/
	MSG_DIAG_CELLLOCK_STATUS_REQ  = 0x42B3,
	 /** 
	payload is ::Boolean 
	**/
	MSG_DIAG_CELLLOCK_STATUS_RSP  = 0x42B4,	///<Payload type {::Boolean}
	 /** 
	capi2 api is CAPI2_LCS_RegisterRrlpDataHandler 
	**/
	MSG_LCS_REG_RRLP_HDL_REQ  = 0x42B5,	///<Payload type {::CAPI2_LCS_RegisterRrlpDataHandler_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_LCS_REG_RRLP_HDL_RSP  = 0x42B6,
	 /** 
	capi2 api is CAPI2_LCS_SendRrlpDataToNetwork 
	**/
	MSG_LCS_SEND_RRLP_DATA_REQ  = 0x42B7,	///<Payload type {::CAPI2_LCS_RrlpData_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_LCS_SEND_RRLP_DATA_RSP  = 0x42B8,
	 /** 
	capi2 api is CAPI2_LCS_RegisterRrcDataHandler 
	**/
	MSG_LCS_REG_RRC_HDL_REQ  = 0x42B9,	///<Payload type {::CAPI2_LCS_RegisterRrcDataHandler_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_LCS_REG_RRC_HDL_RSP  = 0x42BA,
	 /** 
	capi2 api is CAPI2_LCS_RrcMeasurementReport 
	**/
	MSG_LCS_RRC_MEAS_REPORT_REQ  = 0x42BB,	///<Payload type {::CAPI2_LCS_RrcMeasReport_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_LCS_RRC_MEAS_REPORT_RSP  = 0x42BC,
	 /** 
	capi2 api is CAPI2_LCS_RrcMeasurementControlFailure 
	**/
	MSG_LCS_RRC_MEAS_FAILURE_REQ  = 0x42BD,	///<Payload type {::CAPI2_LCS_RrcMeasFailure_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_LCS_RRC_MEAS_FAILURE_RSP  = 0x42BE,
	 /** 
	capi2 api is CAPI2_LCS_RrcStatus 
	**/
	MSG_LCS_RRC_STATUS_REQ  = 0x42BF,	///<Payload type {::CAPI2_LCS_RrcStatus_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_LCS_RRC_STATUS_RSP  = 0x42C0,
	 /** 
	capi2 api is CAPI2_CC_IsThereEmergencyCall 
	**/
	MSG_CC_IS_THERE_EMERGENCY_CALL_REQ  = 0x42C1,
	 /** 
	payload is ::Boolean 
	**/
	MSG_CC_IS_THERE_EMERGENCY_CALL_RSP  = 0x42C2,	///<Payload type {::Boolean}
	 /** 
	capi2 api is CAPI2_SYSPARM_GetBattLowThresh 
	**/
	MSG_SYSPARM_GET_LOW_THRESHOLD_VOLT_REQ  = 0x42C3,
	 /** 
	payload is ::UInt16 
	**/
	MSG_SYSPARM_GET_LOW_THRESHOLD_VOLT_RSP  = 0x42C4,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_SYSPARM_GetDefault4p2VoltReading 
	**/
	MSG_SYSPARM_GET_DEFAULT_4P2_VOLT_REQ  = 0x42C5,
	 /** 
	payload is ::UInt16 
	**/
	MSG_SYSPARM_GET_DEFAULT_4P2_VOLT_RSP  = 0x42C6,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_L1_bb_isLocked 
	**/
	MSG_L1_BB_ISLOCKED_REQ  = 0x42C7,	///<Payload type {::CAPI2_L1_bb_isLocked_Req_t}
	 /** 
	payload is ::Boolean 
	**/
	MSG_L1_BB_ISLOCKED_RSP  = 0x42C8,	///<Payload type {::Boolean}
	 /** 
	capi2 api is CAPI2_MS_ForcePsReleaseReq 
	**/
	MSG_MS_FORCE_PS_REL_REQ  = 0x42C9,
	 /** 
	payload is ::default_proc 
	**/
	MSG_MS_FORCE_PS_REL_RSP  = 0x42CA,
	 /** 
	capi2 api is CAPI2_SYS_ProcessNoRfOnlyChgReq 
	**/
	MSG_SYS_POWERUP_NORF_CHG_REQ  = 0x42CB,
	 /** 
	payload is ::default_proc 
	**/
	MSG_SYS_POWERUP_NORF_CHG_RSP  = 0x42CC,
	 /** 
	capi2 api is CAPI2_SYSPARM_GetGPIO_Value 
	**/
	MSG_SYSPARM_GET_GPIO_REQ  = 0x42CD,
	 /** 
	payload is ::Capi2GpioValue_t 
	**/
	MSG_SYSPARM_GET_GPIO_RSP  = 0x42CE,	///<Payload type {::Capi2GpioValue_t}
	 /** 
	capi2 api is CAPI2_SYS_EnableCellInfoMsg 
	**/
	MSG_SYS_ENABLE_CELL_INFO_REQ  = 0x42CF,	///<Payload type {::CAPI2_SYS_EnableCellInfoMsg_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SYS_ENABLE_CELL_INFO_RSP  = 0x42D0,
	 /** 
	capi2 api is CAPI2_SYSPARM_SetHSDPAPHYCategory 
	**/
	MSG_SYS_SET_HSDPA_CATEGORY_REQ  = 0x42D1,	///<Payload type {::CAPI2_SYSPARM_SetHSDPAPHYCategory_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SYS_SET_HSDPA_CATEGORY_RSP  = 0x42D2,
	 /** 
	capi2 api is CAPI2_SYSPARM_GetHSDPAPHYCategory 
	**/
	MSG_SYS_GET_HSDPA_CATEGORY_REQ  = 0x42D3,
	 /** 
	payload is ::UInt32 
	**/
	MSG_SYS_GET_HSDPA_CATEGORY_RSP  = 0x42D4,	///<Payload type {::UInt32}
	 /** 
	capi2 api is CAPI2_SMS_StartMultiSmsTransferReq 
	**/
	MSG_SIM_START_MULTI_SMS_XFR_REQ  = 0x42D5,
	 /** 
	payload is ::default_proc 
	**/
	MSG_SIM_START_MULTI_SMS_XFR_RSP  = 0x42D6,
	 /** 
	capi2 api is CAPI2_SMS_StopMultiSmsTransferReq 
	**/
	MSG_SIM_STOP_MULTI_SMS_XFR_REQ  = 0x42D7,
	 /** 
	payload is ::default_proc 
	**/
	MSG_SIM_STOP_MULTI_SMS_XFR_RSP  = 0x42D8,
	 /** 
	capi2 api is CAPI2_SIM_SendWriteSmsReq 
	**/
	MSG_SIM_SMS_WRITE_REQ  = 0x42D9,	///<Payload type {::CAPI2_SIM_SendWriteSmsReq_Req_t}
	 /** 
	capi2 api is CAPI2_BATTMGR_GetChargingStatus 
	**/
	MSG_BATTMGR_GETCHARGINGSTATUS_REQ  = 0x42DA,
	 /** 
	payload is ::EM_BATTMGR_ChargingStatus_en_t 
	**/
	MSG_BATTMGR_GETCHARGINGSTATUS_RSP  = 0x42DB,	///<Payload type {::EM_BATTMGR_ChargingStatus_en_t}
	 /** 
	capi2 api is CAPI2_BATTMGR_GetPercentageLevel 
	**/
	MSG_BATTMGR_GETPERCENTAGELEVEL_REQ  = 0x42DC,
	 /** 
	payload is ::UInt16 
	**/
	MSG_BATTMGR_GETPERCENTAGELEVEL_RSP  = 0x42DD,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_BATTMGR_IsBatteryPresent 
	**/
	MSG_BATTMGR_ISBATTERYPRESENT_REQ  = 0x42DE,
	 /** 
	payload is ::Boolean 
	**/
	MSG_BATTMGR_ISBATTERYPRESENT_RSP  = 0x42DF,	///<Payload type {::Boolean}
	 /** 
	capi2 api is CAPI2_BATTMGR_IsChargerPlugIn 
	**/
	MSG_BATTMGR_ISCHARGERPLUGIN_REQ  = 0x42E0,
	 /** 
	payload is ::Boolean 
	**/
	MSG_BATTMGR_ISCHARGERPLUGIN_RSP  = 0x42E1,	///<Payload type {::Boolean}
	 /** 
	capi2 api is CAPI2_SYSPARM_GetBattTable 
	**/
	MSG_SYSPARM_GETBATT_TABLE_REQ  = 0x42E2,
	 /** 
	payload is ::Batt_Level_Table_t 
	**/
	MSG_SYSPARM_GETBATT_TABLE_RSP  = 0x42E3,	///<Payload type {::Batt_Level_Table_t}
	 /** 
	capi2 api is CAPI2_BATTMGR_GetLevel 
	**/
	MSG_BATTMGR_GET_LEVEL_REQ  = 0x42E4,
	 /** 
	payload is ::UInt16 
	**/
	MSG_BATTMGR_GET_LEVEL_RSP  = 0x42E5,	///<Payload type {::UInt16}
	 /** 
	capi2 api is CAPI2_AT_ProcessCmdToAP 
	**/
	MSG_CAPI2_AT_COMMAND_TO_AP_REQ  = 0x42E6,	///<Payload type {::CAPI2_AT_ProcessCmdToAP_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_CAPI2_AT_COMMAND_TO_AP_RSP  = 0x42E7,
	 /** 
	capi2 api is CAPI2_SMS_WriteSMSPduToSIMRecordReq 
	**/
	MSG_SMS_WRITESMSPDUTO_SIMRECORD_REQ  = 0x42E8,	///<Payload type {::CAPI2_SMS_WriteSMSPduToSIMRecordReq_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_SMS_WRITESMSPDUTO_SIMRECORD_RSP  = 0x42E9,
	 /** 
	capi2 api is CAPI2_ADCMGR_MultiChStart 
	**/
	MSG_ADC_MULTI_CH_START_REQ  = 0x42EA,	///<Payload type {::CAPI2_ADCMGR_MultiChStart_Req_t}
	 /** 
	payload is ::CAPI2_ADC_ChannelRsp_t 
	**/
	MSG_ADC_MULTI_CH_START_RSP  = 0x42EB,	///<Payload type {::CAPI2_ADC_ChannelRsp_t}
	 /** 
	capi2 api is CAPI2_InterTaskMsgToCP 
	**/
	MSG_INTERTASK_MSG_TO_CP_REQ  = 0x42EC,	///<Payload type {::CAPI2_InterTaskMsgToCP_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_INTERTASK_MSG_TO_CP_RSP  = 0x42ED,
	 /** 
	capi2 api is CAPI2_InterTaskMsgToAP 
	**/
	MSG_INTERTASK_MSG_TO_AP_REQ  = 0x42EE,	///<Payload type {::CAPI2_InterTaskMsgToAP_Req_t}
	 /** 
	payload is ::default_proc 
	**/
	MSG_INTERTASK_MSG_TO_AP_RSP  = 0x42EF,
	 /** 
	capi2 api is CAPI2_SIM_IsTestSIM 
	**/
	MSG_SIM_ISTESTSIM_REQ  = 0x42F0,
	 /** 
	payload is ::Boolean 
	**/
	MSG_SIM_ISTESTSIM_RSP  = 0x42F1,	///<Payload type {::Boolean}
	 /** 
	capi2 api is CAPI2_OEM_Set_Data 
	**/
	MSG_MS_OEM_SET_DATA_REQ  = 0x42F2,	///<Payload type {::CAPI2_OEM_Set_Data_Req_t}
	 /** 
	payload is ::UInt32 
	**/
	MSG_MS_OEM_SET_DATA_RSP  = 0x42F3,	///<Payload type {::UInt32}
	 /** 
	capi2 api is CAPI2_OEM_Get_Data 
	**/
	MSG_MS_OEM_GET_DATA_REQ  = 0x42F4,	///<Payload type {::CAPI2_OEM_Get_Data_Req_t}
	 /** 
	payload is ::CAPI2_Oem_Payload_t 
	**/
	MSG_MS_OEM_GET_DATA_RSP  = 0x42F5,	///<Payload type {::CAPI2_Oem_Payload_t}
