...
void CAPI2_GetPayloadInfo(CAPI2_ReqRep_t* reqRep, MsgType_t msgId, void** ppBuf, UInt32* pSize)
{
	...
	switch(msgId)
	{
        ...
        case MSG_SATK_SENDDATASERVREQ_RSP:
            GET_PAYLOAD(reqRep->tid, reqRep->clientID, reqRep->msgId, reqRep->result, (void*)&reqRep->req_rep_u.CAPI2_SATKSendDataServReq_Rsp, sizeof(Boolean), handle);
			break;
...
//			break;
		...
		case MSG_PDP_GETUMTSMINQOS_RSP:
			GET_PAYLOAD(reqRep->tid, reqRep->clientID, reqRep->msgId, reqRep->result, (void*) &reqRep->req_rep_u.PDP_GetUMTSMinQoS_Rsp ,sizeof(PCHUMTSQosProfile_t), handle );
			break;
		case MSG_PDP_GETUMTSQOS_RSP:
			GET_PAYLOAD(reqRep->tid, reqRep->clientID, reqRep->msgId, reqRep->result, (void*) &reqRep->req_rep_u.PDP_GetUMTSQoS_Rsp ,sizeof(PCHUMTSQosProfile_t), handle );
			break;
