...
void CAPI2_PDP_GetUMTSMinQoS(UInt32 tid, UInt8 clientID, UInt8 cid)
{
	...
	/* message specific */
	req.req_rep_u.CAPI2_PDP_GetUMTSMinQoS_Req.cid = cid;

	/* serialize */
	CAPI2_SerializeReqRsp(&req, tid, MSG_PDP_GETUMTSMINQOS_REQ, clientID, result, &stream, &len);
...
void CAPI2_PDP_GetUMTSQoS(UInt32 tid, UInt8 clientID, UInt8 cid)
{
	...
	/* message specific */
	req.req_rep_u.CAPI2_PDP_GetUMTSQoS_Req.cid = cid;

	/* serialize */
	CAPI2_SerializeReqRsp(&req, tid, MSG_PDP_GETUMTSQOS_REQ, clientID, result, &stream, &len);
...
/**
	...
	@param		clientID (in) Client ID
	@param		cid (in) Context ID
	@param		params (in) UMTS min qos params
	@return		None
	@note
	The Async SYS response is as follows
	@n@b Responses 
...
void CAPI2_PDP_SetUMTSMinQoS(UInt32 tid, UInt8 clientID, UInt8 cid, PCHUMTSQosProfile_t *pMinQos)
{
	...
	/* message specific */
	req.req_rep_u.CAPI2_PDP_SetUMTSMinQoS_Req.cid = cid;
	req.req_rep_u.CAPI2_PDP_SetUMTSMinQoS_Req.pQos = pMinQos;

	/* serialize */
	CAPI2_SerializeReqRsp(&req, tid, MSG_PDP_SETUMTSMINQOS_REQ, clientID, result, &stream, &len);
...
/**
	...
	@param		clientID (in) Client ID
	@param		cid (in) Context ID
	@param		params (in) UMTS qos params
	@return		None
	@note
	The Async SYS response is as follows
	@n@b Responses 
...
void CAPI2_PDP_SetUMTSQoS(UInt32 tid, UInt8 clientID, UInt8 cid, PCHUMTSQosProfile_t *pQos)
{
	...
	/* message specific */
	req.req_rep_u.CAPI2_PDP_SetUMTSQoS_Req.cid = cid;
	req.req_rep_u.CAPI2_PDP_SetUMTSQoS_Req.pQos = pQos;

	/* serialize */
	CAPI2_SerializeReqRsp(&req, tid, MSG_PDP_SETUMTSQOS_REQ, clientID, result, &stream, &len);
