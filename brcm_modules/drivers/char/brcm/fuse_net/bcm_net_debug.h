...
#ifndef _BCM_NET_DEBUG_H
#define _BCM_NET_DEBUG_H
...
#define BNET_DEBUG(level,fmt,args...) do { if (level & logLevel) printk( "%s:: " fmt, __FUNCTION__, ##args ); } while (0)
//#define KRIL_DEBUG(level,fmt,args...)

static int logLevel = DBG_DEFAULT_LEVEL;

#endif //_BCM_NET_DEBUG_H
