...
// **FIXME** MAG - won't compile under gcc if declared as static
//../modules/../modules/drivers/char/brcm/fuse_rpc/rpc_CIB/arpc/src/rpc_msg.c:46: error: static declaration of 'xdr_RPC_SimpleMsg_t' follows non-static declaration
//../modules/../modules/drivers/char/brcm/fuse_rpc/rpc_CIB/arpc/src/rpc_msg.c:32: error: previous declaration of 'xdr_RPC_SimpleMsg_t' was here

//static bool_t xdr_RPC_SimpleMsg_t(XDR *xdrs, RPC_SimpleMsg_t* msg)
...
static bool_t xdr_RPC_Msg_t(XDR *xdrs, RPC_Msg_t* rpcMsg)
{
			...
			)
	{
		...
		{
			_DBG_(RPC_TRACE("%s[RPC %s] msgid=%d str=%s tid %d cid %d\r\n", 
