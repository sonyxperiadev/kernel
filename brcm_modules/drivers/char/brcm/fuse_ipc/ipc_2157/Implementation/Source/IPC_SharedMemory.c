...
IPC_SmLocalControl_T SmLocalControl_UartLP;
...
{
#ifdef HOST_TEST
	// No separate memory for the 2 CPUs
...
)
{
	...
	{
		extern void IPC_CpPSInitialise(IPC_PowerSavingInfo_T * SmPSAddr, IPC_PlatformSpecificPowerSavingInfo_T * PlatformSpecficPSFuncTablePtr);
	...
	{
		extern void IPC_ApPSInitialise(IPC_PowerSavingInfo_T *, IPC_PlatformSpecificPowerSavingInfo_T *);
