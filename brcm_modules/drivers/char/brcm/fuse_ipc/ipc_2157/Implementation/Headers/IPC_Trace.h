...
extern void IPC_TraceWin (IPC_U32 Channel, char *Function, char * Text, IPC_U32 P1, IPC_U32 P2, IPC_U32 P3, IPC_U32 P4);
#define IPC_DEBUG_TRACE
#ifdef IPC_DEBUG_TRACE

#define IPC_TRACE(Channel, Function, Text, P1, P2, P3, P4)\
	if (TraceChannel [Channel]) IPC_TraceWin (Channel, Function, Text, (IPC_U32) P1, (IPC_U32) P2, (IPC_U32) P3, (IPC_U32) P4);
#else // not IPC_DEBUG
