...
// **FixMe** The offsets defined in Big Island's RDB file don't work,
// so hard-code them here for now. Please clean this up once the RDB
// file is sorted out.
#define BINTC_ISWIR1_CLR_OFFSET 0x34
#define BINTC_ISWIR0_CLR_OFFSET 0x24
