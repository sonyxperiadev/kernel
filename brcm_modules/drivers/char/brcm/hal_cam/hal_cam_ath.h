...
typedef enum
{
    ...
    CAMDRV_IMAGE_BAYER          = (1<<0),          /* Bayer image, extra defines which variant is being used */
    CAMDRV_IMAGE_RGB444         = (1<<1),
// 1    CAMDRV_IMAGE_RGB565         = (1<<2),
    CAMDRV_IMAGE_RGB565         = (1<<4),
   // CAMDRV_IMAGE_RGB888         = (1<<3),
 // 1   CAMDRV_IMAGE_YUV422         = (1<<4), 
