...
#define TASKPRI_AUDDRV_BTWCAPTURE		(TPriority_t)(NORMAL)
...
#define STACKSIZE_ATC                   (STACKSIZE_BASIC + (4096*2)) //MobC00061555, integrated from MobC00061264, CSP204359, Hui Luo, 1/22/09
...
#define STACKSIZE_USBBC                (STACKSIZE_BASIC + 1536)
...
#define HISRSTACKSIZE_CSLCAM        (1024 + RESERVED_STACK_FOR_LISR) //512   // 1024 (ThreadX)
#define HISRSTACKSIZE_VSYNC         (1024 + RESERVED_STACK_FOR_LISR) //512   // 1024 (ThreadX)
