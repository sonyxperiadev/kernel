...
#endif //#if defined(XSCRIPT_INCLUDED)
	MSG_GRP_END 				= 0x7FFF,
...
MSG_MEASURE_REPORT_PARAM_IND	= MSG_GRP_INT_UTIL+0x00,	 ///<Payload type {::MS_RxTestParam_t}
	...
	**/
	...
	/**
	@n@b Payload: MS_T_MN_CB_LANGUAGES
	**/
	...
	**/
	...
	@n@b Payload: MS_T_MN_CB_LANGUAGES
	**/
	MSG_SMS_GETCBLANGUAGE_RSP							= MSG_GRP_CAPI2_SMS+0x2c,	///<Payload type {::MS_T_MN_CB_LANGUAGES}
	/**
	@n@b Payload: None
	**/
	...
	**/
	...
	MSG_SMS_STARTMULTISMSTRANSFER_REQ					= MSG_GRP_CAPI2_SMS+0x35,

	/**
	@n@b Payload: None
	**/
	MSG_SMS_STARTMULTISMSTRANSFER_RSP					= MSG_GRP_CAPI2_SMS+0x36,


	MSG_SMS_STOPMULTISMSTRANSFER_REQ					= MSG_GRP_CAPI2_SMS+0x37,

	/**
	@n@b Payload: None
	**/
	MSG_SMS_STOPMULTISMSTRANSFER_RSP					= MSG_GRP_CAPI2_SMS+0x38,
	...
	**/
	...
	/**
	@n@b Payload: Boolean. TRUE if number is barred; FALSE otherwise.
	**/
	MSG_PBK_ISNUMBARRED_RSP							    = MSG_GRP_CAPI2_PBK+0x06,	///<Payload type {::Boolean}
	...
	**/
	...
	@n@b Payload: Boolean
	**/
	MSG_SATK_SENDTERMINALRSP_RSP						= MSG_GRP_CAPI2_STK+0x0A,	///<Payload type {::Boolean}

	/**
	@n@b Payload: Boolean
	**/
	MSG_SATK_SENDDATASERVREQ_RSP						= MSG_GRP_CAPI2_STK+0x0B,	///<Payload type {::Boolean}
...
//	MSG_CC_MUTECALL_RSP									= MSG_GRP_CAPI2_CC_RESP+0x03,
	...
	**/
    ...
    /**
	@n@b Payload: CAPI2_CCAPI_GetTiFromCallIndex_Rsp_t
	**/
	MSG_CCAPI_GETTIFROMCALLINDEX_RSP					= MSG_GRP_CAPI2_CC_RESP+0x37,	///<Payload type {::CAPI2_CCAPI_GetTiFromCallIndex_Rsp_t}
    MSG_CCAPI_IS_SUPPORTED_BC_RSP				        = MSG_GRP_CAPI2_CC_RESP+0x38,	///<Payload type {::Boolean}
    MSG_CCAPI_GET_BEARERCAP_RSP         				= MSG_GRP_CAPI2_CC_RESP+0x39,	///<Payload type {::CAPI2_CC_GetBearerCap_Rsp_t}
...
//	MSG_CC_SETCALLNUMBER_REQ							= MSG_GRP_CAPI2_CC_REQ+0x22,
    ...
    MSG_CCAPI_ENDCALL_IMMEDIATE_REQ						= MSG_GRP_CAPI2_CC_REQ+0xa6,
    MSG_CCAPI_ENDALLCALLS_IMMEDIATE_REQ				    = MSG_GRP_CAPI2_CC_REQ+0xa7,
    MSG_CCAPI_GETTIFROMCALLINDEX_REQ				    = MSG_GRP_CAPI2_CC_REQ+0xa8,
    MSG_CCAPI_IS_SUPPORTED_BC_REQ	    			    = MSG_GRP_CAPI2_CC_REQ+0xa9,
    MSG_CCAPI_GET_BEARERCAP_REQ      	    			= MSG_GRP_CAPI2_CC_REQ+0xb0,
	...
	MSG_PBK_ISNUMBARRED_REQ					    		= MSG_GRP_CAPI2_INT_PBK+0x0f,
...
//	MSG_SMS_GETTRANSACTIONFROMCLIENTID_REQ				= MSG_GRP_CAPI2_INT_SMS+0x3d,
	...
	MSG_SMS_SEND_COMMAND_PDU_RSP						= MSG_SMS_COMMAND_RSP,
	MSG_SMS_SEND_COMMAND_TXT_RSP						= MSG_SMS_COMMAND_RSP,
	...
	MSG_STK_SEND_BROWSING_STATUS_EVT_REQ                = MSG_GRP_CAPI2_INT_STK+0x0C,
	MSG_STK_SEND_BROWSING_STATUS_EVT_RSP                = MSG_GRP_CAPI2_INT_STK+0x0D,
	MSG_SATK_SEND_CC_SETUP_REQ                          = MSG_GRP_CAPI2_INT_STK+0x0E,
	MSG_SATK_SEND_CC_SS_REQ                             = MSG_GRP_CAPI2_INT_STK+0x0F,
	MSG_SATK_SEND_CC_USSD_REQ                           = MSG_GRP_CAPI2_INT_STK+0x10,
	MSG_SATK_SEND_CC_SMS_REQ                            = MSG_GRP_CAPI2_INT_STK+0x11,
	MSG_SATK_SENDTERMINALRSP_REQ                        = MSG_GRP_CAPI2_INT_STK+0x12,
	MSG_SATK_SENDDATASERVREQ_REQ		    			= MSG_GRP_CAPI2_INT_STK+0x13,
...
#include "capi_gen_mids.i"
#include "sys_gen_mids.i"
...
/** @endcond */
	...
	// end of list
	//-------------------------------------------------
	MSG_INVALID			= 0xFFFF	/* 65535 = 0xFFFF */	// This line must be here in order to generate binary inter-task message logging, Hui Luo, 10/2/07
